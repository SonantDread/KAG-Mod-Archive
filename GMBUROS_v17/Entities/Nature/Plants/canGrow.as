...
bool isNotTouchingOthers(CBlob@ this)
{
	...
	if (this.getOverlapping(@overlapping))
	{
		for (uint i = 0; i < overlapping.length; i++)
		{
			...
			if (blob.getName() == "seed" || blob.getName() == "tree_bushy" || blob.getName() == "tree_pine" || blob.getName() == "grain_plant" || blob.getName() == "flowers" || blob.getName() == "bush" || blob.getName() == "big_bush" || blob.getName() == "tree_large")
			{
				return false;
			}
		}
