...
{
	if(!isLimbMovable(this,LimbSlot::FrontLeg) || !isLimbMovable(this,LimbSlot::BackLeg))return true;
	
	return (!this.hasTag("alive") && !this.hasTag("animated")) && (this.getPlayer() is null);
}
