...
void onTick(CBlob@ this)
{
	...
	if(!isLimbUsable(this,LimbSlot::MainArm) && !isLimbUsable(this,LimbSlot::SubArm)){
		if(!isLimbMovable(this,LimbSlot::MainArm) || !isLimbMovable(this,LimbSlot::SubArm)){
			if(isServer())this.DropCarried();
			return;
		}
	}
	...
	else if (this.isKeyJustPressed(key_pickup))
	{
		...
		if (carryBlob !is null && !carryBlob.hasTag("custom drop") && (!carryBlob.hasTag("temp blob") || carryBlob.getName() == "ladder"))
		{
