...
void onTick(CBlob@ this)
{
	...
	if(equip.MainHand == Equipment::Grapple && isLimbUsable(this,LimbSlot::MainArm))ManageGrapple(this, archer);
	if(equip.SubHand == Equipment::Grapple && isLimbUsable(this,LimbSlot::SubArm))ManageGrapple(this, archer);
	...
	if(can_bow){
		if(equip.MainHand == Equipment::Bow && isLimbUsable(this,LimbSlot::MainArm))
		ManageBow(this, archer, moveVars, this.isKeyPressed(key_action1), this.isKeyPressed(key_action2) && equip.SubHand != Equipment::Bow);
		
		if(equip.SubHand == Equipment::Bow && isLimbUsable(this,LimbSlot::SubArm))
		ManageBow(this, archer, moveVars, this.isKeyPressed(key_action2), this.isKeyPressed(key_action1) && equip.MainHand != Equipment::Bow);
	}
}
