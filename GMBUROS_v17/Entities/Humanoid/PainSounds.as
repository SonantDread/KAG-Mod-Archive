...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	LimbInfo@ limbs;
	if (!this.get("limbInfo", @limbs))return damage;

	if(isLivingFlesh(limbs.Head)){
	...
	if(limbs.Head == BodyType::Zombie){
		if (damage > 0.1f)
		{
			Sound::Play("ZombieGroan1.ogg", this.getPosition(), 1.0f, this.getSexNum() == 0 ? 1.0f : 1.5f);
		}
	}
