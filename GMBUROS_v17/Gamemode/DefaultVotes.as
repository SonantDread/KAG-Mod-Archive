...
const string votenextmap_id = "vote: reload";
...
void onMainMenuCreated(CRules@ this, CContextMenu@ menu)
{
	...
	CContextMenu@ mapmenu = Menu::addContextMenu(votemenu, getTranslatedString("Reload Map"));
	...
	if (getSecurity().checkAccess_Feature(me, "map_vote"))
	{
		...
		else
		{
			...
			Menu::addInfoBox(mapmenu, getTranslatedString("Vote Reload Map"), nextmap_info);
