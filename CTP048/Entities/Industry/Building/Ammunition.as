...
{	 
	...
	{
		ShopItem@ s = addShopItem( this, "Bomber Bombs Factory", "$bombfactory$", "bombfactory", "Bombs made specificaly for the bomber." );
	...
	{
		ShopItem@ s = addShopItem( this, "Bombs Factory", "$bombsfactory$", "bombsfactory", "Bombs for the knight." );
	...
	{
		ShopItem@ s = addShopItem( this, "Machine Gun Factory", "$gunfactory$", "gunfactory", "Gun Machines are manufactured here!" );
