...
{	 
	...
	AddIconToken( "$gliderfactory$", "gliderfactory.png", Vec2f(32,16), 0 );
    AddIconToken( "$bomberfactory$", "bomberfactory.png", Vec2f(32,16), 0 );
	AddIconToken( "$bomberfactory2$", "bomberfactory2.png", Vec2f(32,16), 0 );
	AddIconToken( "$missileshipfactory$", "missileshipfactory.png", Vec2f(32,16), 0 );
	AddIconToken( "$mballoonfactory$", "mballoonfactory.png", Vec2f(32,16), 0 );
	...
	{
		ShopItem@ s = addShopItem( this, "Bomber  Factory", "$bomberfactory2$", "bomberfactory2", "Balloon specified in dropping bombs." );
	...
	{
		ShopItem@ s = addShopItem( this, "Private Balloon", "$mballoonfactory$", "mballoonfactory", "Three Private Balloons. Only one seat and one attachable gun." );
