...
const string[] messages = {
	...
	// -- GAME INFO
	"This server has a discord, get notified about all updates and suggest ur ideas",
...
void onTick( CRules@ this )
{
	...
	{
		client_AddToChat("Welcome Mikill Territory Control Server!", SColor(255, 127, 0, 127));
