...
void onTick(CSprite@ this)
{
	...
	const bool left = cc.isKeyPressed(KEY_LEFT);
	const bool right = cc.isKeyPressed(KEY_RIGHT);
	const bool up = cc.isKeyPressed(KEY_KEY_C);
	const bool down = cc.isKeyPressed(KEY_DOWN);
