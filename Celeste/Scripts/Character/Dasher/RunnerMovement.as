...
void onTick(CMovement@ this)
{
	...
	CControls@ cBlob = blob.getControls();
	...
	const bool left		= cBlob.isKeyPressed(KEY_LEFT);
	const bool right	= cBlob.isKeyPressed(KEY_RIGHT);
	const bool up		= cBlob.isKeyPressed(KEY_KEY_C);
	const bool down		= cBlob.isKeyPressed(KEY_DOWN);
