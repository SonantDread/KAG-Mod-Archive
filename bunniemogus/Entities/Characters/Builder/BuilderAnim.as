...
void onRender(CSprite@ this)
{
	...
	if (blob.isKeyPressed(key_action1) || this.isAnimation("strike") || this.isAnimation("strike_fast") || this.isAnimation("chop") || this.isAnimation("chop_fast") || this.isAnimation("strike_very_fast") || this.isAnimation("chop_very_fast"))
	{
