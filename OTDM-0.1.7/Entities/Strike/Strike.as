...
{	
	...
	Vec2f xpos2 = Vec2f(this.getPosition().x+XORRandom(40), 0);
	Vec2f xpos3 = Vec2f(this.getPosition().x-XORRandom(40), 0);
	...
	{	
		...
		{		
			...
			blob2.SendCommand(blob2.getCommandID("activate"));
	...
	{	
		...
		{		
			...
			blob3.SendCommand(blob3.getCommandID("activate"));
