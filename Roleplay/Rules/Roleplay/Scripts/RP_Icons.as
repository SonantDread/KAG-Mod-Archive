...
void onInit( CRules@ this )
{
	...
	AddIconToken( "$triangle_block$", "Entities/Structures/RP/TriangleBlock/TriangleBlock.png", Vec2f(8, 8), 0 );
	...
	AddIconToken("$mat_mythrilarrows$", "Entities/Materials/Materials.png", Vec2f(16, 16), 122);
	AddIconToken("$mat_adamantarrows$", "Entities/Materials/Materials.png", Vec2f(16, 16), 123);
