...
void onRestart( CRules@ this )
{
	if(getNet().isServer())
	{
		this.set_u8(season_property, XORRandom(Seasons::TOTAL));
...
void LoadSeason( CRules@ this, CMap@ map, u8 season )
{
	...
	{
		// world
		string world_sprite = season == Seasons::SPRING ? "../Mods/Roleplay/Sprites/world-spring.png" :
		                      season == Seasons::AUTUMN ? "../Mods/Roleplay/Sprites/world-autumn.png" :
		                      season == Seasons::WINTER ? "../Mods/Roleplay/Sprites/world-winter.png" :
		                                                  "../Mods/Roleplay/Sprites/world.png";
		...
		// plains
		string background_plains_sprite = season == Seasons::SPRING ? "../Mods/Roleplay/Sprites/Back/BackgroundPlains-summer.png" :
		                                  season == Seasons::AUTUMN ? "../Mods/Roleplay/Sprites/Back/BackgroundPlains-autumn.png" :
		                                  season == Seasons::WINTER ? "../Mods/Roleplay/Sprites/Back/BackgroundPlains-winter.png" :
		                                                              "../Mods/Roleplay/Sprites/Back/BackgroundPlains-summer.png";
		string background_trees_sprite =  season == Seasons::SPRING ? "../Mods/Roleplay/Sprites/Back/BackgroundTrees-summer.png" :
		                                  season == Seasons::AUTUMN ? "../Mods/Roleplay/Sprites/Back/BackgroundTrees-autumn.png" :
		                                  season == Seasons::WINTER ? "../Mods/Roleplay/Sprites/Back/BackgroundTrees-winter.png" :
		                                                              "../Mods/Roleplay/Sprites/Back/BackgroundTrees-summer.png";
		string background_castle_sprite = season == Seasons::SPRING ? "../Mods/Roleplay/Sprites/Back/BackgroundCastle-summer.png" :
		                                  season == Seasons::AUTUMN ? "../Mods/Roleplay/Sprites/Back/BackgroundCastle-autumn.png" :
		                                  season == Seasons::WINTER ? "../Mods/Roleplay/Sprites/Back/BackgroundCastle-winter.png" :
		                                                              "../Mods/Roleplay/Sprites/Back/BackgroundCastle-summer.png";
