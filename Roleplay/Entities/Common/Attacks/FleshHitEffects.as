	...
	if (damage > 0.1f && (hitterBlob !is this || customData == Hitters::crush))  //sound for anything actually painful
	{
		...
		switch (customData)
		{
			...
			case Hitters::mace_power:
				Sound::Play("../Mods/Roleplay/Entities/Classes/Knight/Maceman/MaceKill" + (1 + XORRandom(2)) + ".ogg", this.getPosition());
				break;
			
			case Hitters::axe:
			case Hitters::axe_power:
				Sound::Play("../Mods/Roleplay/Entities/Classes/Knight/Axeman/AxeKill" + (1 + XORRandom(2)) + ".ogg", this.getPosition());
				break;
