...
const string blowjob_path = "../Mods/Roleplay/Entities/Characters/Sprites/Heads_011/";
...
string getSpritePath( CSprite@ this )
{
	...
	if    (blob is null) return "../Mods/Roleplay/Entities/Characters/Sprites/HumanHeads.png";
	
	if (getEquipmentSlotItem(blob, SLOT_ARMOUR) == "dragon_chestplate")
	{
		return "../Mods/Roleplay/Entities/Characters/Sprites/DragonHelmet.png";
	}
	...
	if (!blob.hasTag("head disabled") && player !is null)
	{
		...
		if (frame != -1)
		{
			return blob.getTeamNum() == RACE_DWARVES ?  "../Mods/Roleplay/Entities/Characters/Sprites/CustomDwarfHeads.png" :
				   blob.getTeamNum() == RACE_ELVES   ?  "../Mods/Roleplay/Entities/Characters/Sprites/CustomElfHeads.png" :
				   blob.getTeamNum() == RACE_ORCS    ?  "../Mods/Roleplay/Entities/Characters/Sprites/CustomOrcHeads.png" :
				   blob.getTeamNum() == RACE_UNDEAD  ?  "../Mods/Roleplay/Entities/Characters/Sprites/CustomUndeadHeads.png" :
														"../Mods/Roleplay/Entities/Characters/Sprites/CustomHumanHeads.png";
		}
	...
	return blob.getTeamNum() == RACE_DWARVES ?  "../Mods/Roleplay/Entities/Characters/Sprites/DwarfHeads.png" :
		   blob.getTeamNum() == RACE_ELVES   ?  "../Mods/Roleplay/Entities/Characters/Sprites/ElfHeads.png" :
		   blob.getTeamNum() == RACE_ORCS    ?  "../Mods/Roleplay/Entities/Characters/Sprites/OrcHeads.png" :
		   blob.getTeamNum() == RACE_UNDEAD  ?  "../Mods/Roleplay/Entities/Characters/Sprites/UndeadHeads.png" :
												"../Mods/Roleplay/Entities/Characters/Sprites/HumanHeads.png";
}
...
CSpriteLayer@ LoadHead( CSprite@ this, u8 headIndex )
{
	...
	if    (blob !is null)
	{
		...
		if    (path == "../Mods/Roleplay/Entities/Characters/Sprites/CustomDwarfHeads.png" ||
			   path == "../Mods/Roleplay/Entities/Characters/Sprites/CustomElfHeads.png" ||
			   path == "../Mods/Roleplay/Entities/Characters/Sprites/CustomOrcHeads.png" ||
			   path == "../Mods/Roleplay/Entities/Characters/Sprites/CustomUndeadHeads.png" ||
			   path == "../Mods/Roleplay/Entities/Characters/Sprites/CustomHumanHeads.png")
		{
		    blob.set_s32("head_frame", getCustomHeadFrame(blob));
		}
		else if(path == "../Mods/Roleplay/Entities/Characters/Sprites/HumanHeads.png" || 
				path == "../Mods/Roleplay/Entities/Characters/Sprites/DwarfHeads.png" ||
				path == "../Mods/Roleplay/Entities/Characters/Sprites/ElfHeads.png" || 
				path == "../Mods/Roleplay/Entities/Characters/Sprites/OrcHeads.png" ||
				path == "../Mods/Roleplay/Entities/Characters/Sprites/UndeadHeads.png")
		{
