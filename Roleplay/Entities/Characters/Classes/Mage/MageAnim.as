...
{
    string texname = this.getBlob().getTeamNum() == RACE_UNDEAD ? "../Mods/Roleplay/Entities/Characters/Classes/Mage/Sprites/UndeadMage.png" : 
					 this.getBlob().getTeamNum() == RACE_ORCS ?   "../Mods/Roleplay/Entities/Characters/Classes/Mage/Sprites/OrcMage.png" :
	                                                              "../Mods/Roleplay/Entities/Characters/Classes/Mage/Sprites/HumanMage.png";
...
string getSkinPath( CBlob@ blob, CPlayer@ player, string username )
{
	...
	//	skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Mage/Sprites/Special/NusMage.png";
	//else 
	if (username == "kaggit")
	    skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Mage/Sprites/Special/KaggitMage.png";
