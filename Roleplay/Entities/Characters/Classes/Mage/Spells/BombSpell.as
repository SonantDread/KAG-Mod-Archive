...
namespace BombSpell
{
    ...
    const string particles_path = "../Mods/Roleplay/Entities/Characters/Classes/Mage/Spells/BombSpell.png";
    const string soundeffect_path = "../Mods/Roleplay/Entities/Characters/Classes/Mage/Spells/MagickaBomb.ogg";
