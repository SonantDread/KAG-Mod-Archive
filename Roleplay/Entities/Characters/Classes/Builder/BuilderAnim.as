...
void Reload( CSprite@ this )
{
	...
	if(raceIs(this.getBlob(), RACE_DWARVES))
	    tex = this.getBlob().getSexNum() == 0 ? "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/DwarfBuilderMale.png" :
		                                        "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/DwarfBuilderFemale.png";
	else if(raceIs(this.getBlob(), RACE_ELVES))
	    tex = this.getBlob().getSexNum() == 0 ? "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/ElfBuilderMale.png" :
		                                        "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/ElfBuilderFemale.png";
	else if(raceIs(this.getBlob(), RACE_ORCS))
	    tex = this.getBlob().getSexNum() == 0 ? "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/OrcBuilderMale.png" :
		                                        "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/OrcBuilderFemale.png";
	else if(raceIs(this.getBlob(), RACE_UNDEAD))
	    tex = "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/UndeadBuilder.png";
...
string getSkinPath( CBlob@ blob, CPlayer@ player, string username )
{
	...
	if (username == "Aphelion")
		skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/Nus.png";
	else if (username == "kaggit")
		skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/Dominar.png";
	else if (username == "MadRaccoon")
		skin_path = blob.getTeamNum() == 5 ? "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/ZombieRaccoon.png" :
		                                     "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/Raccoon.png";
	else if (username == "stabborazz")
		skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/Ultimate.png";
	else if(username == "Sohkyo" || username == "Duke_Jordan" || username == "Chukka")
		skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/DukeBackpack.png";
	else if (username == "zhuum")
		skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/ElderlyZhuum.png";
	else if (username == "king-george")
		skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/Gentlesir.png";
	
	// -- SPONSOR
	else if (username == "master-chief" || username == "bbpolkagal")
		skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/Sponsor/Chief.png";
	else if (username == "Jonohargreaves")
		skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/Sponsor/Guy.png";
	else if (username == "Dilandau")
		skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/Sponsor/Fairy.png";
	else if (username == "pmattep99")
		skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/Sponsor/Blob.png";
	else if (username == "King_Chaos")
		skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/Sponsor/Doggie.png";
	else if (isSponsor(player))
	    skin_path = "../Mods/Roleplay/Entities/Characters/Classes/Builder/Sprites/Special/Sponsor/Claus.png";
