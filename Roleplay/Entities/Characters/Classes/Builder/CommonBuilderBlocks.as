...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks)
{
	...
	{
		BuildBlock b( 0, "triangle_block", "$triangle_block$", "Triangle Block" );
	...
	//{
	//	BuildBlock b( 0, "gold_block", "$gold_block$", "Gold Block\nA purely cosmetic block." );
	//	AddRequirement( b.reqs, "blob", "mat_goldbars", "Gold Bar", 1 );
	//	blocks[0].push_back( b );
	//}
	...
	}
	{
		...
		AddRequirement(b.reqs, "blob", "mat_stone", "Wood", 40);
		blocks[3].push_back(b);
	}
	{
