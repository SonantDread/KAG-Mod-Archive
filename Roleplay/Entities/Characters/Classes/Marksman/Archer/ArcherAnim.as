...
void LoadSprites( CSprite@ this )
{
	...
	if(this.getBlob().getTeamNum() == RACE_DWARVES)
	{
		texname = this.getBlob().getSexNum() == 0 ?
				 "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Archer/Sprites/DwarfArcherMale.png" :
				 "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Archer/Sprites/DwarfArcherFemale.png";
	}
	else if(this.getBlob().getTeamNum() == RACE_ELVES)
	{
		texname = this.getBlob().getSexNum() == 0 ?
				 "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Archer/Sprites/ElfArcherMale.png" :
				 "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Archer/Sprites/ElfArcherFemale.png";
	}
	else if(this.getBlob().getTeamNum() == RACE_ORCS)
	{
		texname = this.getBlob().getSexNum() == 0 ?
				 "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Archer/Sprites/OrcArcherMale.png" :
				 "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Archer/Sprites/OrcArcherFemale.png";
	}
	else if(this.getBlob().getTeamNum() == RACE_UNDEAD)
	{
		texname = "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Archer/Sprites/UndeadArcher.png";
	}
