...
void onInit( CBlob@ this )
{
    ...
    this.getSprite().SetEmitSound( "../Mods/Roleplay/Entities/Characters/Classes/Musketman/MusketLoad.ogg" );
...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
    if (cmd == this.getCommandID("shoot musket"))
    {
        ...
        this.getSprite().PlaySound("../Mods/Roleplay/Entities/Characters/Classes/Musketman/MusketFire" + (1 + XORRandom(3)) + ".ogg");
...
void shotParticles(Vec2f pos, float angle)
{
	...
	for(int i = 0; i < 5; i++)
	{
		...
		CParticle@ p = ParticleAnimated( "../Mods/Roleplay/Entities/Characters/Classes/Musketman/muzzle_smoke.png",
												  pos, vel,
