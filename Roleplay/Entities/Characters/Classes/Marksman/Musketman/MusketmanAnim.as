...
void LoadSprites( CSprite@ this )
{
    string texname = this.getBlob().getSexNum() == 0 ?
                    "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Musketman/Sprites/MusketmanMale.png" :
                    "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Musketman/Sprites/MusketmanFemale.png";
	
	if (this.getBlob().getTeamNum() == RACE_UNDEAD)
	{
		texname = "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Musketman/Sprites/UndeadMusketman.png";
	}
