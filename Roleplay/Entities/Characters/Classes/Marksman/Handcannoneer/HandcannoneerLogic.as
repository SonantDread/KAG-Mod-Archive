...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
    if (cmd == this.getCommandID("shoot cannon"))
    {
        ...
        this.getSprite().PlaySound("../Mods/Roleplay/Entities/Characters/Classes/Handcannoneer/HandcannonFire" + (1 + XORRandom(4)) + ".ogg");
...
void shotParticles(Vec2f pos, float angle)
{
	...
	for(int i = 0; i < 5; i++)
	{
		...
		CParticle@ p = ParticleAnimated( "../Mods/Roleplay/Entities/Characters/Classes/Handcannoneer/muzzle_smoke.png",
												  pos, vel,
