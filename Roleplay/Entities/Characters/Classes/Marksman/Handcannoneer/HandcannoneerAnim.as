...
void LoadSprites( CSprite@ this )
{
    string texname = this.getBlob().getSexNum() == 0 ?
                    "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Handcannoneer/Sprites/HumanHandcannoneerMale.png" :
                    "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Handcannoneer/Sprites/HumanHandcannoneerFemale.png";
	...
	if(this.getBlob().getTeamNum() == RACE_DWARVES)
	{
		texname = this.getBlob().getSexNum() == 0 ?
				 "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Handcannoneer/Sprites/DwarfHandcannoneerMale.png" :
				 "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Handcannoneer/Sprites/DwarfHandcannoneerFemale.png";
	}
	else if(this.getBlob().getTeamNum() == RACE_ORCS)
	{
		texname = this.getBlob().getSexNum() == 0 ?
				 "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Handcannoneer/Sprites/OrcHandcannoneerMale.png" :
				 "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Handcannoneer/Sprites/OrcHandcannoneerFemale.png";
	}
	else if(this.getBlob().getTeamNum() == RACE_UNDEAD)
	{
		texname = "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Handcannoneer/Sprites/UndeadHandcannoneer.png";
	}
