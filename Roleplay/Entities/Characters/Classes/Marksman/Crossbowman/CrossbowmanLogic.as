...
void onInit( CBlob@ this )
{
    ...
    this.getSprite().SetEmitSound("../Mods/Roleplay/Entities/Characters/Classes/Crossbowman/CrossbowPull.ogg");
...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("shoot arrow"))
	{
		...
		if(legolas)
		{
            ...
            this.getSprite().PlaySound("../Mods/Roleplay/Entities/Characters/Classes/Crossbowman/CrossbowFire.ogg", 1.5f, 1.0f);
		}
		else
		{
			if (getNet().isServer())
            ...
            this.getSprite().PlaySound("../Mods/Roleplay/Entities/Characters/Classes/Crossbowman/CrossbowFire.ogg", 1.0f, 1.0f);
			this.TakeBlob( arrowTypeNames[ arrowType ], 1 );	
		}
