...
void LoadSprites( CSprite@ this )
{
    string texname = this.getBlob().getSexNum() == 0 ?
                    "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Crossbowman/Sprites/HumanCrossbowmanMale.png" :
                    "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Crossbowman/Sprites/HumanCrossbowmanFemale.png";
	...
	if(this.getBlob().getTeamNum() == RACE_ORCS)
	{
		texname = this.getBlob().getSexNum() == 0 ?
				 "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Crossbowman/Sprites/OrcCrossbowmanMale.png" :
				 "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Crossbowman/Sprites/OrcCrossbowmanFemale.png";
	}
	else if(this.getBlob().getTeamNum() == RACE_UNDEAD)
	{
		texname = "../Mods/Roleplay/Entities/Characters/Classes/Marksman/Crossbowman/Sprites/UndeadCrossbowman.png";
	}
