...
const f32 drop_weapon_probability = 0.5f; //between 0 and 1
const f32 drop_armour_probability = 0.5f; //between 0 and 1
...
{
    {
    	if(isClassTypeKnight(this))
		{
			...
			{   // Gold sword
				Equipment e( false, "gold_sword", "$gold_sword$", "knight", SLOT_WEAPON, "Gold sword\nStab: 1.25 Slash: 2.5 Power: 5 Speed: Fastest", true );
...
float getDamageModifier( CBlob@ this, u8 hitter )
{
	...
	if    (armour == "aura_default")
	    modifier = 0.9f;
	if    (armour == "iron_chestplate" || armour == "gold_chestplate" || armour == "iron_chainmail" || armour == "aura_teleportation")
	    modifier = 0.7f;
