...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem( this, "Gold chestplate", "$gold_chestplate$", "gold_chestplate", "Gold chestplate\n\nCosmetic garment for the Knight\nDefence rating of 30" );
	...
	{
		ShopItem@ s = addShopItem( this, "Gold sword", "$gold_sword$", "gold_sword", "Gold sword\n\nA cosmetic weapon for the Knight\nDamage of 1.25" );
	...
	}
	{
		...
		AddRequirement( s.requirements, "coin", "", "Coins", TRADER_ARROW_MYTHRIL_COST);
		AddRequirement( s.requirements, "tech", "Smithing II", "Smithing II", 1);
	}
	{
