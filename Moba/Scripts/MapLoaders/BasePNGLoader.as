...
class PNGLoader
{
	...
	void handlePixel(SColor pixel, int offset)
	{
		...
		else if(pixel == color_rtwr)
		{
			spawnBlob( map, "tower", offset, 1, false);
			offsets[autotile_offset].push_back( offset );
		}
		else if(pixel == color_btwr)
		{
			spawnBlob( map, "tower", offset, 0, false);
			offsets[autotile_offset].push_back( offset );
		}
		else if(pixel == color_bspw)
		{
			spawnBlob( map, "rebuild", offset, 255, false);
			offsets[autotile_offset].push_back( offset );
		}
		else if(pixel == color_sspw)
		{
			spawnBlob( map, "rebuild3", offset, 255, false);
			offsets[autotile_offset].push_back( offset );
		}
		else if(pixel == color_rspw)
		{
			spawnBlob( map, "rebuild1", offset, 1, false);
			offsets[autotile_offset].push_back( offset );
		}
		else if(pixel == color_gspw)
		{
			spawnBlob( map, "rebuild2", offset, 255, false);
			offsets[autotile_offset].push_back( offset );
		}
