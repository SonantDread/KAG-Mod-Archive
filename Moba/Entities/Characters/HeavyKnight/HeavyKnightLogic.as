...
void onTick(CBlob@ this)
{
	...
	if(this.get_u8("spd") == 1)
		moveVars.walkFactor *= 1.2f;
	else if(this.get_u8("spd") == 2)
		moveVars.walkFactor *= 1.4f;
	else if(this.get_u8("spd") == 3)
		moveVars.walkFactor *= 1.6f;
	else if(this.get_u8("spd") == 4)
		moveVars.walkFactor *= 1.8f;
	else if(this.get_u8("spd") == 5)
		moveVars.walkFactor *= 2.0f;
	if(this.get_u8("jmp") == 1)
		moveVars.jumpFactor *= 1.2f;
	else if(this.get_u8("jmp") == 2)
		moveVars.jumpFactor *= 1.4f;
	else if(this.get_u8("jmp") == 3)
		moveVars.jumpFactor *= 1.6f;
	else if(this.get_u8("jmp") == 4)
		moveVars.jumpFactor *= 1.8f;
	else if(this.get_u8("jmp") == 5)
...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	if(this.get_u8("def") == 1)
		return damage * 0.9f;
	if(this.get_u8("def") == 2)
		return damage * 0.8f;
	if(this.get_u8("def") == 3)
		return damage * 0.7f;
	if(this.get_u8("def") == 4)
		return damage * 0.6f;
...
{
	if (this.get_u8("atk") == 1)
		return damg * 1.1;
	else if (this.get_u8("atk") == 2)
		return damg * 1.2;
	else if (this.get_u8("atk") == 3)
		return damg * 1.3;
	else if (this.get_u8("atk") == 4)
		return damg * 1.4;
	else if (this.get_u8("atk") == 5)
		return damg * 1.5;
	else
		return damg;
}
