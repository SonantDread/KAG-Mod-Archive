...
void onCollision(CBlob@ this, CBlob@ blob, bool solid)
{
	...
	{	
		if (blob.getTeamNum() != this.getTeamNum() && blob.getName() == "arrow" || blob.getName() == "riflebullet" || blob.getName() == "bullet" || blob.getName() == "flame")
		{
			this.Tag("exploding");
