...
TileType server_onTileHit(CMap@ map, f32 damage, u32 index, TileType oldTileType)
{
	if(map.getTile(index).type > 255)
	{
		...
		{	
			...
			case CMap::tile_steelbrick_d7: {OnSteelTileHit(map, index); return oldTileType + 1;}		
			case CMap::tile_steelbrick_d8: { OnSteelTileDestroyed(map, index); return CMap::tile_empty;}	
