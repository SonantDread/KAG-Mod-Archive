...
void MakeTradeMenu(CBlob@ trader)
{
	...
	//utility stuff
	addItemForCoin(trader, "Chicken", cost_sponge, true, "$chicken$", "chicken", "Lets you glide and may save your life.");
	...
	addItemForCoin(trader, "Meteor", cost_boulder, true, "$boulder$", "boulder", "A meteor that fell from the sky.");
