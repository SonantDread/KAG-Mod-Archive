...
{
	const string texname = "Shadow.png"; //These three lines are like coder magic. Don't touch em unless you want it to stop working. Only change the names of the .pngs.
...
void onTick(CSprite@ this)
{
	...
	if (!blob.hasTag(burning_tag)) //Are we burning? If so, lets not screw with the burning animations.
	{
		...
		{
			if(blob.get_s16("stab_cooldown") <= 0 || blob.get_s16("stab_cooldown") > 55)this.SetAnimation("actionanim");
		}
		else if (inair)
		{
			RunnerMoveVars@ moveVars;
