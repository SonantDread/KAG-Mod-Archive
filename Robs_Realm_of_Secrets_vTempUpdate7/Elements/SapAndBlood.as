...
void onTick(CBlob @ this)
{
	...
	if(!this.hasTag("dead") && this.hasTag("flesh") && (this.get_s16("blood") > 0 || this.hasTag("faceless"))){
...
void onCreateInventoryMenu(CBlob@ this, CBlob@ forBlob, CGridMenu @gridmenu)
{
	...
	if(this.hasTag("BloodMenu")){
		...
		if (menu !is null)
		{
			...
			{
				CGridButton@ b = menu.AddButton("$bloodmimic_icon$", "Swap your team to a nearby player's. (currently disabled)", this.getCommandID("bloodmimic"));
