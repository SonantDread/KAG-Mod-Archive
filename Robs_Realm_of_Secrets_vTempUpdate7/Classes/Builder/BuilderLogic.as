...
bool RecdHitCommand(CBlob@ this, CBitStream@ params)
{
	...
	if(blobID == 0)
	{
		...
		if(map !is null)
		{
			...
			{
				this.server_HitMap(tilepos, attackVel, 1.0f*DamageMultiplier(this), Hitters::builder);
			}
		}
	}
	else
	{
		...
		if(blob !is null)
		{
			...
			this.server_Hit(blob, tilepos, attackVel, attack_power*DamageMultiplier(this), Hitters::builder, teamHurt);
		}
	}
