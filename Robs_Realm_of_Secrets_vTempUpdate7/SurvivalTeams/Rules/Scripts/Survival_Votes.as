...
const float required_minutes = 30; //time you have to wait after joining w/o skip_votewait.

s32 g_lastNextmapCounter = 0;
const float required_minutes_nextmap = 120; //global nextmap vote cooldown
