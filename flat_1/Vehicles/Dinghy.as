...
void onInit(CBlob@ this)
{
	...
	// BC add back ladder
	// getMap().server_AddMovingSector(Vec2f(-28.0f, -5.0f), Vec2f(-11.0f, 20.0f), "ladder", this.getNetworkID());
...
bool doesCollideWithBlob(CBlob@ this, CBlob@ blob)
{
	...
	if (blob.getShape().getConsts().platform) // BC Don't collide with platforms
		return false;
	if (!this.isInWater()) // BC Don't collide when on land
		return false;
