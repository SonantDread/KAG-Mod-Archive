...
void onInit(CBlob@ this)
{
	...
	Vec2f pos_off(0, 0);
	this.set_f32("map dmg modifier", 65.0f);
	...
	//back bit
	{
		Vec2f[] shape = { Vec2f(11.0f,  25.5f) - pos_off,
	...
	//rudder
	//{
	//	Vec2f[] shape = { Vec2f( 12.0f,  48.0f ) -pos_off,
	...
	// add back ladder
	getMap().server_AddMovingSector(Vec2f(-55.0f, -5.0f), Vec2f(-5.0f, 20.0f), "ladder", this.getNetworkID());  //BC Increase warboat ladder width
