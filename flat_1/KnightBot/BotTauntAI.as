...
void onInit(CBlob@ this)
{
	...
	//chats
	{
		string[] temp = { "Tree hugger",
"Ye mangy breadcrumb",
"Thou saucy clapper-clawed crab",
"Ye porridge-faced leprechaun",
"Ye small-time dormouse",
"Ye wayward baggage",
"Thou errant malt-worm",
"Thou hasty-witted pigeon-egg",
"Ye weather-bitten bugbear",
"Ye misbegotten pebble",
"Thou brazen-faced rascal"
		                };
		b.taunts = temp;
	}
	{
...
"Caesar’s ghost!"	
	...
	//meta
	b.tauntchance = 0.1f;  //BC decrease chatter

	b.typespeed = 3;
	b.talkchance = 0.15f;  //BC decrease chatter
...
{
	if (this.getPlayer() !is null) //BC enable taunts
	{
		if (this.getPlayer().isBot()) //BC only enable taunts for bots
		{
		UpdateAction(this);
		}
	}
