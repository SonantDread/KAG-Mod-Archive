...
void onTick(CBlob@ this)
{
	...
	if(getGameTime() % 5 == 0)ParticleAnimated("ConvertParticle.png", this.getPosition(), this.getVelocity()/2+Vec2f(XORRandom(3)-1,XORRandom(3)-1)*0.2, XORRandom(360), 1.0f, 3, -0.01, true);
}
