...
void onTick(CBlob@ this)
{
	...
	if(this.isKeyPressed(key_action1))
	{
		...
		if(this.get_s16("stab_cooldown") <= 0){
			if(!this.isFacingLeft())DoAttack(this, 0.5f, 0.0f, 60.0f, Hitters::stab, 1);
			else DoAttack(this, 0.5f, 180.0f, 60.0f, Hitters::stab, 1);
...
void DoAttack(CBlob@ this, f32 damage, f32 aimangle, f32 arcdegrees, u8 type, int deltaInt)
{
	...
	f32 attack_distance = Maths::Min(24 + Maths::Max(0.0f, 1.75f * this.getShape().vellen * (vel * thinghy)), 24);
