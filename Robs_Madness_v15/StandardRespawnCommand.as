...
void InitClasses(CBlob@ this)
{
	...
	//addPlayerClass(this, "Test", "$builder_class_icon$", "skeleton", "testing.");
}
		...
		case SpawnCmd::changeClass:
		{
			if (getNet().isServer())
			{
				...
				if (caller !is null && canChangeClass(this, caller))
				{
					...
					if(getGameTime() < 60*getTicksASecond() && caller.getPlayer().getUsername() != "Pirate-Rob")classconfig = "builder";
