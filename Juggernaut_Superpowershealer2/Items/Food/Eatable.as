...
void onCollision(CBlob@ this, CBlob@ blob, bool solid)
{
	...
	if (getNet().isServer() && !blob.hasTag("dead") && blob.getName() != "juggernaut")
	{
		Heal(this, blob);
	}
}
...
{
	if (getNet().isServer() && attached.getName() != "juggernaut")
	{
		Heal(this, attached);
	}
}
...
{
	if (getNet().isServer() && detached.getName() != "juggernaut")
	{
		Heal(this, detached);
	}
}
