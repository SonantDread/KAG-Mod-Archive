...
void onInit(CInventory@ this)
{
	...
	AddIconToken("$BUILDER_CLEAR$", "GMIcons.png", Vec2f(32, 32), 2);

	for(u8 i = 0; i < Builder::PAGE_COUNT; i++)
	{
		AddIconToken("$"+PAGE_NAME[i]+"$", "GMPageIcons.png", Vec2f(48, 24), i);
	}
...
{
	string dbg = "GMInventory.as: Unknown command ";
