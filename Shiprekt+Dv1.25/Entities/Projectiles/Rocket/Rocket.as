		...
		if (getMap().getHitInfosFromRay( pos, -vel.Angle(), vel.Length(), this, @hitInfos ))
		{
			...
			for (uint i = 0; i < hitInfos.length; i++)
			{
				...
				if (color > 0 || !isBlock)
				{
					...
					{
						if ( blockType == Block::MOTHERSHIP5 || blockType == Block::SECONDARYCORE || Block::isSolid(blockType) || blockType == Block::DOOR ||  ( (b.hasTag( "weapon" ) || b.hasTag( "rocket" )) && !sameTeam ) )
							killed = true;
...
f32 getDamage( CBlob@ hitBlob, int blockType )
{
	...
	if ( (hitBlob.hasTag( "weapon" ) && hitBlob.getName() != "hyperflek") || blockType == Block::PROPELLER )
		return 1.5f;
...
void onHitBlob( CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitBlob, u8 customData )
{
	...
	else	if (Block::isSolid(blockType) || blockType == Block::MOTHERSHIP5 || blockType == Block::SECONDARYCORE ||  blockType == Block::SEAT || blockType == Block::DOOR || hitBlob.hasTag( "weapon" ) )
	{
