...
void BuyBlock( CBlob@ this, CBlob@ caller, string btype )
{
	...
	bool weapon = btype == "cannon" || btype == "machinegun" || btype == "flak" || btype == "hyperflek" || btype == "pointDefense" || btype == "launcher" || btype == "bomb";
	...
	else if ( btype == "hyperflek" )
	{
		type = Block::HYPERFLEK;
		cost = c.hyperflek;
	}
