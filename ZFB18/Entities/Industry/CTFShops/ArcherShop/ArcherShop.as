...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Machine gun bullets paid by coins", "$mat_bullets$", "mat_bullets", "Bullets for the machine gun", true);
		AddRequirement(s.requirements, "coin", "", "Coins", 10 );
	}
	{
		ShopItem@ s = addShopItem(this, "Missile", "$mat_missile$", "mat_missile", "Missiles", true);
		AddRequirement(s.requirements, "coin", "", "Coins", 10 );
	}
	{
