...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$Crate$","crate.png", Vec2f(32,16), 0);
	AddIconToken("$mounted_bow$","MountedBow.png", Vec2f(16,16), 0);
	...
	{
		ShopItem@ s = addShopItem(this, "Crate", "$Crate$", "crate", "a crate to store your stuff or hid yourself.", false);
	...
	{
		ShopItem@ s = addShopItem(this, "Mounted Bow", "$mounted_bow$", "mounted_bow", "Mounted Bow\na stationary mounted bow.", true);
		AddRequirement(s.requirements, "coin", "", "Coins", 200);
	}
}
