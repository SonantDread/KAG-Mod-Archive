...
void onInit(CSprite@ this)
{
	...
	CSpriteLayer@ wood = this.addSpriteLayer("wood", "FactoryMP18.png", 16, 16);
	if (wood !is null)
	{
...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	{
		CButton@ button = caller.CreateGenericButton("$mat_coal$", Vec2f(-4.0f, 0.0f), this, this.getCommandID("add fuel"), getTranslatedString("Add fuel"), params);
		if (button !is null)
		{
...
void spawnOre(CBlob@ this)
{
	...
	server_MakeCrate("jeffery", "Jeffery Armoured Car", 0, this.getTeamNum(), this.getPosition() + Vec2f(-8.0f, 0.0f));
