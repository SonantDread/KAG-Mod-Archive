...
const string ore = "mat_coal";
const string rare_ore = "mat_coal";
...
{
	CSpriteLayer@ belt = this.addSpriteLayer("belt", "KilnAnim.png", 32, 32);
	if (belt !is null)
	{
		//default anim
		{
	...
	CSpriteLayer@ wood = this.addSpriteLayer("wood", "Kiln.png", 16, 16);
	if (wood !is null)
	{
