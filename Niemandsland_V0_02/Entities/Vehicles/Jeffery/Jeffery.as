...
void onInit(CBlob@ this)
{
	...
	{ CSpriteLayer@ w = Vehicle_addWoodenWheel(this, v, 0, Vec2f(15.0f, 18.0f)); if (w !is null) w.SetRelativeZ(10.1f); }
	{ CSpriteLayer@ w = Vehicle_addWoodenWheel(this, v, 0, Vec2f(-15.0f, 18.0f)); if (w !is null) w.SetRelativeZ(10.1f); }
	...
	if (arm !is null)
	{
		...
		if (arm !is null)
		{
			...
			arm.SetOffset(Vec2f(10,10));
		}
	}

	sprite.SetZ(-25.0f);
	CSpriteLayer@ front = sprite.addSpriteLayer("front layer", sprite.getConsts().filename, 54, 41);
	if (front !is null)
	{
		...
		CSpriteLayer@ frontfront = sprite.addSpriteLayer("frontfront layer", sprite.getConsts().filename, 54, 41);
...
void Vehicle_onFire(CBlob@ this, VehicleInfo@ v, CBlob@ bullet, const u8 _charge)
{
	if (bullet !is null)
	{
		...
		f32 charge = 5.0f + 25.0f * (float(charge_prop) / float(v.max_charge_time));
