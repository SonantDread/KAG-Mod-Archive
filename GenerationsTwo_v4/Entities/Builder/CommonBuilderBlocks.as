...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks)
{
	...
	{
		AddIconToken("$stone_building_icon$", "StoneBuilding.png", Vec2f(16, 16), 2);
		BuildBlock b(0, "stone_building", "$stone_building_icon$", "Stone Building\nUsed for gem constructs generally.");
