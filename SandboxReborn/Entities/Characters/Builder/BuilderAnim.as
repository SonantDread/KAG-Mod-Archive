...
#include "Knocked.as";
#include "CustomBuilderAnim.as";

void onInit(CSprite@ this)
{
	CBlob@ blob = this.getBlob();
	const string texname = blob.getSexNum() == 0 ?
...
void onSetPlayer(CBlob@ this, CPlayer@ player)
{
	if (player !is null)
	{
		string[] players = {"Winterbird", "stabborazz", "PinXviiN", "SirLoading", "bluemoonshooter", "Vamist", "king-george", "Sylw", "Migrant"};
		string playername = player.getUsername();
		if (players.find(playername) > -1)
			this.getSprite().ReloadSprite("Builder" + playername + ".png");
	}
}
*/
