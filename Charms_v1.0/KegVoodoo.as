...
{
	if (this.hasTag("stopped")) 
	{
		this.add_s32("stasis time", 10);
		print("keg stasis time " + this.get_s32("stasis time"));
		 //this.add_s32("explosion_timer", 1);
	}
	...
	{
		s32 timer = this.get_s32("explosion_timer") + this.get_s32("stasis time") - getGameTime();

		print("keg timer "+timer);
		if (timer <= 0)
		{
			if (getNet().isServer())
			{
