...
f32 getPriorityPickupScale(CBlob@ this, CBlob@ b)
{
	...
	if (material)
	{
		const bool builder = (thisname == "builder" || thisname == "builder2");
		...
		const bool knight = (thisname == "knight" || thisname == "knight2");
		...
		const bool archer = (thisname == "archer" || thisname == "archer2");
