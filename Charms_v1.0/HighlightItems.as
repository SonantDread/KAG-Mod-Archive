...
//Items to highlight.
const string[] classes = {"builder", "knight", "archer", "builder2", "knight2", "archer2"};
...
/* 3 */	{"mat_stone", "mat_wood", "mat_gold"}, //builder
/* 4 */	{"mat_bombs", "mat_waterbombs", "keg"}, //knight
/* 5 */	{"mat_arrows", "mat_firearrows", "mat_waterarrows", "mat_bombarrows"} //archer
};
