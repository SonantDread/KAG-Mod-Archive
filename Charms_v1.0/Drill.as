...
const string required_class2 = "builder2";
...
void onTick(CBlob@ this)
{
	...
	if (this.isAttached())
	{
		...
		if (holder.getName() == required_class || sv_gamemode == "TDM" || holder.getName() == required_class2)
		{
...
void onRender(CSprite@ this)
{
	...
	if (holderBlob.getName() != required_class && holderBlob.getName() != required_class2 && sv_gamemode != "TDM"){return;}
