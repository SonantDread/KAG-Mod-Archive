...
const u16 STATION_BOOTY = 25;//how much booty is obtained by each player every 
							 //FRQUENCY/30 seconds per station captured
const u32 FREQUENCY = 300;//this is in TICKS not seconds so for ex: 150 ticks = 5secs. 30 ticks per second
							//in general you dont want to make this too small, or it will lagg the server i would say refrain from anything below 30 ticks
void onInit(CRules@ this)
{
	this.set_bool( "whirlpool", false );
	setStartingBooty( this );
	server_resetTotalBooty( this ); 
	print("booty per station: " + STATION_BOOTY + " every " + (FREQUENCY/30.0f) + " seconds");
}
...
void onTick(CRules@ this)
{
	...
	if ( gameTime % FREQUENCY == 0 && !this.get_bool( "whirlpool" ) )
	{
