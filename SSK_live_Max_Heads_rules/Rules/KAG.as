...
void onTick(CRules@ this)
{
	...
	if (need_sky_check)
	{
		...
		bool map_ceiling_has_tiles = false;
		for(int i = 0; i < map.tilemapwidth; i++) {
			if(map.isTileSolid(map.getTile(i)) || map.isTileBackground(map.getTile(i))) {
				map_ceiling_has_tiles = true;
				break;
			}
		}
		map.SetBorderColourTop(SColor(map_ceiling_has_tiles ? 0xff000000 : 0x80000000));
	}
}
