...
namespace map_colors
{
	enum color
	{
		...
		wooden_platform_up            = 0xFFFF9239, // ARGB(255, 255, 146,  57);
		wooden_platform_right         = 0xFFFF9238, // ARGB(255, 255, 146,  56);
		wooden_platform_down          = 0xFFFF9237, // ARGB(255, 255, 146,  55);
		wooden_platform_left          = 0xFFFF9236, // ARGB(255, 255, 146,  54);
		stone_platform_up            = 0xFF9eb297, // ARGB(255, 158, 178,  151);
		stone_platform_right         = 0xFF9eb296, // ARGB(255, 158, 178,  150);
		stone_platform_down          = 0xFF9eb295, // ARGB(255, 158, 178,  149);
		stone_platform_left          = 0xFF9eb294, // ARGB(255, 158, 178,  148);
		bedrock_platform_up            = 0xFF426642, // ARGB(255, 66, 102,  66);
		bedrock_platform_right         = 0xFF426641, // ARGB(255, 66, 102,  65);
		bedrock_platform_down          = 0xFF426640, // ARGB(255, 66, 102,  64);
		bedrock_platform_left          = 0xFF426639, // ARGB(255, 66, 102,  63);
		...
		barrel_spawner		   = 0xFF823C0A, // ARGB(255, 130, 60, 10)
