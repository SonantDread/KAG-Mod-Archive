...
void onInit(CBlob@ this)
{
	...
	this.set_f32("explosive_damage", 30.0f);
...
void onTick(CBlob@ this)
{
	if(getNet().isServer())
	{
		...
		if(this.getVelocity().LengthSquared() < 1.0f && !this.isAttached() && this.hasTag("dropped"))
		{
...
void onDie(CBlob@ this)
{
	if(getNet().isServer() && this.hasTag("exploding"))
	{
		...
		for(u16 i = 0; i < blobs.length; i++)
		{
			...
			{
				FighterHitData fighterHitData(10, 3.0f, 0.08f);
				server_fighterHit(this, target, POSITION, Vec2f_zero, 8.0f, Hitters::mine_special, true, fighterHitData);
			}
		}
	}
}
