...
#include "SSK_PlacementCommon.as";
...
bool RecdHitCommand(CBlob@ this, CBitStream@ params)
{
	...
	else
	{
		...
		if(blob !is null)
		{
			...
			if (getNet().isServer())
			{
				FighterHitData fighterHitData(6, 1.8f, 0.04f);
				server_fighterHit(this, blob, tilepos, attackVel, attack_power, Hitters::builder, teamHurt, fighterHitData);
