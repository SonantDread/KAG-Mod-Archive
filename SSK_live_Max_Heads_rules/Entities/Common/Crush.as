		...
		if (this.getOverlapping(@overlapping))
		{
			for (uint i = 0; i < overlapping.length; i++)
			{
				...
				if (crush > thresh)
				{
					...
					FighterHitData fighterHitData(8, 1.0f, 0.8f, 10);
					server_fighterHit(this, blob, this.getPosition(), this.getVelocity(), crush * 100.0f, Hitters::crush, true, fighterHitData);
				}
			}
		}
	}
