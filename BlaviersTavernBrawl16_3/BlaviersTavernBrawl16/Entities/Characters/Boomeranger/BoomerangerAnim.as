...
{
	addRunnerTextures(this, "boomeranger", "Boomeranger");
...
{
	ensureCorrectRunnerTexture(this, "boomeranger", "Boomeranger");
}
...
void onTick(CSprite@ this)
{
	...
	else if (knight.state == KnightStates::sword_drawn)
	{
		...
		{
			this.SetAnimation("draw_boomerang");
		}
