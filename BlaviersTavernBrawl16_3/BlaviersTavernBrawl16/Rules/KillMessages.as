	...
	void Render()
	{
		...
		for (uint message_step = 0; message_step < count; ++message_step)
		{
			...
			switch (message.hitter)
			{
				...
				case Hitters::rang:     		hitterIcon = "$killfeed_rang$"; break;
				case Hitters::hyper_rang:     	hitterIcon = "$killfeed_hyper_rang$"; break;
...
void onInit(CRules@ this)
{
	...
	AddIconToken("$killfeed_rang$", "GUI/KillfeedIcons.png", Vec2f(32, 16), 19);
	AddIconToken("$killfeed_hyper_rang$", "GUI/KillfeedIcons.png", Vec2f(32, 16), 20);
