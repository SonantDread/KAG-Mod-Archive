...
void onInit(CBlob@ this)
{
	...
	if(this.getName() == "buildershop")
	{
		...
		if(ClassesConfig::builder) addPlayerClass(this, "Builder", "$builder_class_icon$", "builder", "Build ALL the towers.");
		if(ClassesConfig::rockthrower) addPlayerClass(this, "Rock Thrower", "$rockthrower_class_icon$", "rockthrower", "Basic Tactics.");
		if(ClassesConfig::medic) addPlayerClass(this, "Medic", "$medic_class_icon$", "medic", "Medicine of War.");
	}
	...
	else if(this.getName() == "archershop")
	{
		...
		if(ClassesConfig::archer) addPlayerClass(this, "Archer", "$archer_class_icon$", "archer", "The Ranged Advantage.");
		if(ClassesConfig::crossbowman) addPlayerClass(this, "Crossbowman", "$crossbowman_class_icon$", "crossbowman", "Heavy Mechanical Weapon.");
		if(ClassesConfig::musketman) addPlayerClass(this, "Musketman", "$musketman_class_icon$", "musketman", "New Era of War.");
	}
}
