...
void onInit(CBlob@ this)
{
	...
	settings.RELOAD_TIME = (8 + XORRandom(6)); //Time it takes to reload (in ticks)
	...
	settings.B_DAMAGE = 5.400f; //1 is 1 heart
	...
	//Sound
	settings.FIRE_SOUND = "Mauser_Pistol_Shoot.ogg"; //Sound when shooting
	settings.RELOAD_SOUND = "C96_Reload.ogg"; //Sound when reloading
