	...
	if (getNet().isServer())
	{
		...
		if (map.isTileStone(tile))
		{
			if (map.isTileThickStone(tile))
				MakeMat(this, worldPoint, "mat_stone", 24 * damage);
			else
				MakeMat(this, worldPoint, "mat_stone", 16 * damage);
		}
		else if (map.isTileGold(tile))
		{
			MakeMat(this, worldPoint, "mat_gold", 10 * damage);
		}
		...
		if (map.isTileSolid(tile))
		{
			...
			{
				MakeMat(this, worldPoint, "mat_wood", 4 * damage);
			}
		}
	}
}
