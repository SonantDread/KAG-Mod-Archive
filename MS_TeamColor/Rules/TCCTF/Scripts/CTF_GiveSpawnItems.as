...
void onInit(CRules@ this)
{
	// printf("------------------------------");
	// CBitStream bs;
	// bs.write_Vec2f(Vec2f(666, 777));
	// this.set_CBitStream( "bitstream", bs );
	// CBitStream readbs;
	// this.get_CBitStream( "bitstream", readbs );
	// Vec2f v = readbs.read_Vec2f();
	// printf("v " + v.x + " " + v.y );

	// this.set_bool("bool", true );
	// this.set_bool("bool2", false );
	// printf("b " + this.get_bool("bool") + " b2 " + this.get_bool("bool2") );
	Reset(this);
}
...
void onTick(CRules@ this)
{
	...
	// CBlob@ blob = getBlobByName("builder");
	// if (blob !is null){
	// 	CBlob@ rock = server_CreateBlob( "cata_rock", 0, blob.getPosition() );
	// 	server_CreateBlob( "cata_rock", 1, blob.getPosition() );
	// 	server_CreateBlob( "cata_rock", 0, blob.getPosition() );
	// 	server_CreateBlob( "cata_rock", 1, blob.getPosition() );
	// 	server_CreateBlob( "cata_rock", 1, blob.getPosition() );
	// 	server_CreateBlob( "cata_rock", 1, blob.getPosition() );
	// 	server_CreateBlob( "cata_rock", 0, blob.getPosition() );
