...
void BalanceAll(CRules@ this, RulesCore@ core, BalanceInfo[]@ infos, int type = SCRAMBLE)
{
	...
	for (u32 i = 0; i < len; i++)
	{
		...
		if (p.getTeamNum() != this.getSpectatorTeamNum())
		{
			...
			getNet().server_SendMsg("balanceall() team " + tempteam); //criado

			int redteamcount = getTeamSize(core.teams, 1); //criado
			int greenteamcount = getTeamSize(core.teams, 2); //criado
			if( tempteam == 0 && greenteamcount > redteamcount ){ tempteam = 1;} //criado
			else if( tempteam == 0 && greenteamcount < redteamcount ){ tempteam = 2;}	 //criado
			else if ( tempteam == 0 ) { tempteam = 2; } //criado
...
void onNewPlayerJoin(CRules@ this, CPlayer@ player)
{
	...
	{
		getNet().server_SendMsg("onNewPlayerJoin() team " + getSmallestTeam(core.teams));//alterado
...
void onPlayerRequestTeamChange(CRules@ this, CPlayer@ player, u8 newTeam)
{
	...
	getNet().server_SendMsg("onPlayerRequestTeamChange() team " + newTeam);//alterado
...
void onPlayerRequestSpawn(CRules@ this, CPlayer@ player)
{
	...
	getNet().server_SendMsg("onPlayerRequestSpawn() team " + newTeam);//alterado
	core.ChangePlayerTeam(player, newTeam);
