...
void Pierce(CBlob @this, CBlob@ blob = null)
{
	...
	{
		BoomerangHitMap(this, end, this.getOldVelocity(), 0.5f, Hitters::arrow);
	}
}
...
void BoomerangHitMap(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, u8 customData)
{
	if (velocity.Length() > boomerangFastSpeed)
	{
		this.getSprite().PlaySound("hit_wood.ogg");
