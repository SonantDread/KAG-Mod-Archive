...
void Pierce(CBlob @this, CBlob@ blob = null)
{
	...
	{
		MeatHitMap(this, end, this.getOldVelocity(), 1.0f, Hitters::bite);
	}
}
...
f32 MeatHitBlob(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitBlob, u8 customData)
{
	if (hitBlob !is null)
	{
		...
		if (!hitShield)
		{
			if (velocity.Length() > meatFastSpeed)
			{
...
void MeatHitMap(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, u8 customData)
{
	if (velocity.Length() > meatFastSpeed)
	{
		this.getSprite().PlaySound("BodyGibFall2.ogg");
