			...
			for (uint i = 0; i < hitInfos.length; i++)
			{
				...
				if (b !is null && (!dontHitMore)) // blob
				{
					...
					if (!canHit(this, b))
					{
						...
						{
							dontHitMore = true;
							continue;// if you found second best hittable, you'll hit by after command
						}
					}
					else // can hit!
					{
						...
						else if ((!foundSecondBest) && (b.hasTag("vehicle") || (b.hasTag("flesh") && !b.hasTag("dead")) || b.getName() == "mine"))// found better hittable
						{
