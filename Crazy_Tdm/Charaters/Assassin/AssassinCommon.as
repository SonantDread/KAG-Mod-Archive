//Assassin Include
const f32 assassin_grapple_length = 82.0f;
const f32 assassin_grapple_slack = 16.0f;
const f32 assassin_grapple_throw_speed = 24.0f;

const f32 assassin_grapple_force = 2.1f;
const f32 assassin_grapple_accel_limit = 1.6f;
