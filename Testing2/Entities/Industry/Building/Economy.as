...
//	AddIconToken( "$building$", "building.png", Vec2f(32,16), 0 );
	...
	{
		ShopItem@ s = addShopItem( this, "Warehouse", "$storage$", "storage", Descriptions::storage );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 150 );
	}	
	
	{
		ShopItem@ s = addShopItem( this, "Wood Refinery", "$logfactory$", "logfactory", "Factory that recycles wood" );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 1250 );
        AddRequirement( s.requirements, "no more", "logfactory", "Wood Refinement Factory", 12 );
	}
	{
		ShopItem@ s = addShopItem( this, "Stone Refinement Factory", "$stonefactory$", "stonefactory", "Factory that refines stone" );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 2500 );
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 125 );
		AddRequirement( s.requirements, "no more", "stonefactory", "Stone Refinement Factory", 12 );

	}
	{
		ShopItem@ s = addShopItem( this, "Gold Refinement Factory", "$goldfactory$", "goldfactory", "Factory that refines gold" );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 2500 );
		AddRequirement( s.requirements, "blob", "mat_gold", "Gold", 250 );
		AddRequirement( s.requirements, "no more", "goldfactory", "Gold Refinement Factory", 6 );
	}
	{
