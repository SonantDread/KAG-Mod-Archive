...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if (kek == 0)
	{
		caller.CreateGenericButton( 11, Vec2f_zero, this, this.getCommandID("spaladin"), "Specifically for good kids.", params );
	}
}

void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("spaladin"))
	{
        ...
        if (getNet().isServer() )
        {
            ...
            {
				warn("chealler:");
                string classconfig = "Paladin";//params.read_string();
