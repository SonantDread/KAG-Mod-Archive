...
void DrawSpellBar(CBlob@ this)
{
	...
	for (uint i = 0; i < 15; i++)	//only 15 total spells held inside primary hotbar
	{
		...
		s8 currSpellCooldown = playerPrefsInfo.spell_cooldowns[Maths::Min(primarySpellID, cooldownsLength)];
	...
	s8 currSecSpellCooldown = playerPrefsInfo.spell_cooldowns[Maths::Min(secondarySpellID, cooldownsLength)];
	...
	s8 currAux1SpellCooldown = playerPrefsInfo.spell_cooldowns[Maths::Min(aux1SpellID, cooldownsLength)];
	...
	s8 currAux2SpellCooldown = playerPrefsInfo.spell_cooldowns[Maths::Min(aux2SpellID, cooldownsLength)];
