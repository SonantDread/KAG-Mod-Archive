...
const u8 heat_max = 100;

const string last_drill_prop = "drill last active";

const u8 heat_add = 4;
const u8 heat_add_constructed = 6;
const u8 heat_add_blob = 20;
						...
						for (uint i = 0; i < hitInfos.length; i++)
						{
							...
							if (hi.blob !is null) // blob
							{
								...
								string name = hi.blob.getName();
									if (name == "mat_wood" || name == "mat_stone" || name == "mat_gold" || name == "heart")
										{
										continue;
										}
										if (hi.blob.hasTag("flesh") || hi.blob.getName() == "wooden_door" || hi.blob.getName() == "stone_door")
										{
										hitblob = true;
										hitsomething = true;
										}
