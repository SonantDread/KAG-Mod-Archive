...
{
	string texname = "WraithKnight.png";
...
void onTick(CSprite@ this)
{
	...
	string modpath = "../Mods/Robs_Realm_of_Secrets/Classes/WraithKnight/";
	
	if("WraithKnight_"+name != this.getFilename()){
		this.ReloadSprite(modpath+"WraithKnight_"+name);
		if(this.getSpriteLayer("chop") !is null)
		this.getSpriteLayer("chop").ReloadSprite(modpath+"WraithKnight_"+name,32,32,this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
	}
