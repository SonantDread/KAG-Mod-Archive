...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	if(this.isOverlapping(caller)){
		...
		CButton@ button = caller.CreateGenericButton(12, Vec2f(0,-8), this, this.getCommandID("blacksmith"), "Upgrade to blacksmith.", params);
	}
}
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	...
	if (cmd == this.getCommandID("blacksmith"))
	{
		server_CreateBlob("blacksmith",this.getTeamNum(), this.getPosition());
