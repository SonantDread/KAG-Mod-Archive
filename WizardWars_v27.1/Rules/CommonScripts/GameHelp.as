...
const string textInfo = 
		...
		"  *Eliminate all members of the enemy team to win.\n"+
                "  *Are you a map maker? send in your maps and i will add them to the game!.\n"+
                "  *Got any ideas? Feel free to message vamist.\n"+
		"\n- WIZARD WARS FAQ:\n\n"+
		...
		"You must use the hotbar customization panel. See the next question for how it's used.\n\n"+
		" * I'm clicking spells in the "+inv_key+" menu but my spell won't change!!1 Game is broken!!\n"+
		"The '"+inv_key+"' menu is called the hotbar customization panel, and it's not for choosing what spell you want to use. It's for rearranging the spells in the hotbar in the bottom left corner. To do this, select a spell from the '"+inv_key+"' menu, then click on any one of the spell icons in the hotbar to change it to what you have selected, all while holding down the menu key. This same process works for the secondary and auxiliary spell slots as well.\n\n"+
		" * How do I figure out what these spells do?\n"+
		"You can read spell descriptions by hovering your mouse pointer over spells in the '"+inv_key+"' menu.\n\n"+
...
void onTick( CRules@ this )
{
	...
	if ( !initialized || isGUINull() )		//this little trick is so that the GUI shows up on local host 
	{
		...
		@helpWindow = @Window(Vec2f(150,-530),Vec2f(800,530));
		...
		introText.setText(introText.textWrap("Welcome to Wizard Wars, a mod created by Chrispin, Press F1 to close this. Hosted by Vamist"));
...
void onRender( CRules@ this )
{
	...
	if (showHelp && helpWindow.position.y < 80) //controls opening and closing the gui
	{
