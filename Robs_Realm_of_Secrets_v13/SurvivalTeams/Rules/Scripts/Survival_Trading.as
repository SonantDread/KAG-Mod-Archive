...
void MakeTradeMenu(CBlob@ trader)
{
	...
	addItemForCoin(trader, "Working Mine", 20, true, "$mine$", "faultymine", "A completely unsafe and working mine.");
...
void onPlayerDie(CRules@ this, CPlayer@ victim, CPlayer@ killer, u8 customData)
{
	if (victim !is null)
	{
		if (killer !is null)
		{
			...
			{
				if(!victim.hasTag("coin cheater"))killer.server_setCoins(killer.getCoins() + coinsOnKillAdd);
			}
		}
