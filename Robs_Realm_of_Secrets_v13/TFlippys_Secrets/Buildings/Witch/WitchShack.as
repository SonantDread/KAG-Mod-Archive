...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Sell Wisp(60)", "$COIN$", "coins-60+cage", "M're fuel f'r mine pot!", true);
		AddRequirement(s.requirements, "blob", "caged_wisp", "Caged Wisp", 1);
		s.spawnNothing = true;
	}
	
	{
		ShopItem@ s = addShopItem(this, "Sell Slime(40)", "$COIN$", "coins-40+cage", "Ooze f'r brew thicken'ring!", true);
		AddRequirement(s.requirements, "blob", "caged_slime", "Caged Slime", 1);
		s.spawnNothing = true;
	}
	
	{
		ShopItem@ s = addShopItem(this, "Sell Chicken(30)", "$COIN$", "coins-30+cage", "Chicken talons art useful f'r scratching!", true);
		AddRequirement(s.requirements, "blob", "caged_chicken", "Caged Chicken", 1);
		s.spawnNothing = true;
	}
	
	{
		ShopItem@ s = addShopItem(this, "Sell Fishy(20)", "$COIN$", "coins-20", "Fishy!", true);
