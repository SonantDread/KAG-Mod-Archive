...
{
	string texname = "DarkKnightMale.png";
...
void onTick(CSprite@ this)
{
	...
	if(!blob.hasTag("dead"))if(blob.isKeyPressed(key_action2))this.getSpriteLayer("pull").SetVisible(true);
	this.getSpriteLayer("pull").RotateBy(-10, Vec2f(0,0));
