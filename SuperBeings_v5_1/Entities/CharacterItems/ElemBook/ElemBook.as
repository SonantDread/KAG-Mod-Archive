...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	CButton@ button = caller.CreateGenericButton(11, Vec2f_zero, this, this.getCommandID("usebook"), "Gain control the elements.", params);
		...
		if (caller !is null)
		{
			...
			if (player !is null)
			{
				if(player.get_s16("book_level") >= 5){
					CBlob @newBlob = server_CreateBlob("waterman", caller.getTeamNum(), this.getPosition());
					if (newBlob !is null)
					{
