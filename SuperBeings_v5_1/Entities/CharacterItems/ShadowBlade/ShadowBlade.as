...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	CButton@ button = caller.CreateGenericButton(11, Vec2f_zero, this, this.getCommandID("usebook"), "Become a servant of the dark one.", params);
...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("usebook"))
	{
		...
		if (caller !is null)
		{
            CBlob @newBlob = server_CreateBlob("darkfollower", 9, this.getPosition());
			if (newBlob !is null)
			{
