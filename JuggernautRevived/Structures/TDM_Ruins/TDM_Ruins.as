...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$crossbowman_class_icon$", "GUI/MenuItems.png", Vec2f(32, 32), 16);
	//TDM classes
	addPlayerClass(this, "Knight", "$knight_class_icon$", "knight", "Hack and Slash.");
	addPlayerClass(this, "Crossbowman", "$crossbowman_class_icon$", "crossbowman", "The Ranged Advantage.");
...
{
	if (canChangeClass(this, caller) && caller.getTeamNum() != 1)
	{
