...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "upgrade", "$RESEARCH$", "upgradedatm", "Upgrade ATM to buy/sell more new items!", true);
		AddRequirement(s.requirements, "coin", "", "Coins", 100);
		AddRequirement(s.requirements, "blob", "mat_mixedgold", "Mixed Gold", 30);
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	if (cmd == this.getCommandID("shop made item"))
	{
		...
		string name = params.read_string();
		{
			...
			if(name == "mat_wood" || name == "mat_stone" || name == "mat_gold" || name == "mat_bluegold")
			{
				CBlob@ callerBlob = getBlobByNetworkID(caller);
