...
{		
    ...
    if (this.getHealth() <= gibHealth)
    {
		...
		if (getNet().isServer())
		{
			...
			if (XORRandom(2)+1 >= 2) MakeMat(this, worldPoint, "mat_wood", XORRandom(20)+5);
			else if (XORRandom(2)+1 >= 2) MakeMat(this, worldPoint, "mat_stone", XORRandom(20)+5);
			if (XORRandom(2)+1 == 3) MakeMat(this, worldPoint, "mat_gold", XORRandom(20)+5);
			MakeMat(this, worldPoint, "mat_rflesh", XORRandom(20)+5);
		}
        this.server_Die();
    }
