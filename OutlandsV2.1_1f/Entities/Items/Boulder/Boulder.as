...
void Slam(CBlob @this, f32 angle, Vec2f vel, f32 vellen)
{
	...
	bool goldenblocks = (tile.type > 255 && tile.type < 261) || (tile.type > 266 && tile.type < 277);
	bool magic = (tile.type > 287 && tile.type < 292);
	if (map.isTileBackgroundNonEmpty(tile) && !goldenblocks && !magic)
	{
