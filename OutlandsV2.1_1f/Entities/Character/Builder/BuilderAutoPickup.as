...
void Take(CBlob@ this, CBlob@ blob)
{
	...
	if (blobName == "mat_gold" || blobName == "mat_stone" ||
	        blobName == "mat_wood" || blobName == "mat_bluegold" || blobName == "mat_mixedgold" || blobName == "mat_masterstone" || blobName == "mat_puremagic" 
			|| blobName == "mat_fflesh" || blobName == "mat_rflesh"/*|| blobName == "grain"*/)
	{
