...
void LoadSprites(CSprite@ this)
{
	...
	//float sex = this.getBlob().getSexNum();
	//print("sex: "+this.getBlob().getSexNum());
	string tex = this.getBlob().getSexNum() == 0 ?
					"../Mods/"+mod_name+"/Entities/Character/Builder/BuilderMale.png" :
					"../Mods/"+mod_name+"/Entities/Character/Builder/BuilderFemale.png";
	if (team >= 8 && team <= 15)
		tex = this.getBlob().getSexNum() == 0 ?
				"../Mods/"+mod_name+"/Entities/Character/Builder/BuilderMaleB.png" :
				"../Mods/"+mod_name+"/Entities/Character/Builder/BuilderFemaleB.png";
	else if (team >= 16 && team <= 23)
		tex = this.getBlob().getSexNum() == 0 ?
				"../Mods/"+mod_name+"/Entities/Character/Builder/BuilderMaleS.png" :
				"../Mods/"+mod_name+"/Entities/Character/Builder/BuilderFemaleS.png";
	else if (team >= 24 && team <= 31)
		tex = this.getBlob().getSexNum() == 0 ?
				"../Mods/"+mod_name+"/Entities/Character/Builder/BuilderMaleW.png" :
				"../Mods/"+mod_name+"/Entities/Character/Builder/BuilderFemaleW.png";
