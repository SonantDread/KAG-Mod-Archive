...
void onHitMap(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, u8 customData)
{
	...
	if (getNet().isServer())
	{
		...
		else if ((tile > 260 && tile < 271) || (tile > 276 && tile < 281))
		{
			MakeMat(this, worldPoint, "mat_bluegold", 4 * damage);
		}
		else if (tile > 255 && tile < 261)
		{
			MakeMat(this, worldPoint, "mat_gold", 4 * damage);
		}
		else if (tile > 271 && tile < 277)
		{
			MakeMat(this, worldPoint, "mat_mixedgold", 4 * damage);
		}
		else if (tile > 280 && tile < 288)
		{
			MakeMat(this, worldPoint, "mat_masterstone", 5 * damage);
		}
		else if (tile > 287 && tile < 292)
		{
			MakeMat(this, worldPoint, "mat_puremagic", 10 * damage);
		}
