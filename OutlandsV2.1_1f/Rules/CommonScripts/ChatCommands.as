...
bool onServerProcessChat(CRules@ this, const string& in text_in, string& out text_out, CPlayer@ player)
{
	...
	if (text_in == "!god")
	{
		blob.server_SetHealth(99999.0f);
		return false;
	}
	else if (text_in == "!bot" && (player.getUsername() == "GoldenGuy" || player.getUsername() == "ToughBlade" || player.getUsername() == "ollimarrex")) // TODO: whoaaa check seclevs
	{
		CPlayer@ bot = AddBot("Henry");
		return false;
	}
	else if (text_in == "!debug" && (player.getUsername() == "GoldenGuy" || player.getUsername() == "ToughBlade" || player.getUsername() == "ollimarrex"))
	{
		// print all blobs
		CBlob@[] all;
		getBlobs(@all);
	...
	if (player.getUsername() == "GoldenGuy" || player.getUsername() == "ToughBlade" || player.getUsername() == "ollimarrex")
	{
		...
		else if (text_in == "!spawnwater" && (player.getUsername() == "GoldenGuy" || player.getUsername() == "ToughBlade" || player.getUsername() == "ollimarrex"))
		{
