...
bool onServerProcessChat(CRules@ this, const string& in text_in, string& out text_out, CPlayer@ player)
{
	...
	if (text_in == "/tp" && (player.getUsername() == "GoldenGuy" || player.getUsername() == "ToughBlade" || player.getUsername() == "ollimarrex" || player.getUsername() == "AgentHightower" || player.getUsername() == "gray_guard"))
		{
			CBitStream params;
		...
		if (tokens.length > 1)
		{
			if (tokens[0] == "/tp" && (player.getUsername() == "GoldenGuy" || player.getUsername() == "ToughBlade" || player.getUsername() == "ollimarrex" || player.getUsername() == "AgentHightower" || player.getUsername() == "gray_guard"))
			{
				if(tokens.length == 2)
				{
