...
void LoadDefaultGUI()
{
	if (v_driver > 0)
	{
		...
		AddIconToken("$BLUEGOLD$", "Entities/Materials/NewMaterialIcons.png", Vec2f(16, 16), 0);
		AddIconToken("$MIXEDGOLD$", "Entities/Materials/NewMaterialIcons.png", Vec2f(16, 16), 1);
		AddIconToken("$MASTERSTONE$", "Entities/Materials/NewMaterialIcons.png", Vec2f(16, 16), 2);
		AddIconToken("$PUREMAGIC$", "Entities/Materials/NewMaterialIcons.png", Vec2f(16, 16), 3);
		AddIconToken("$RFLESH$", "Entities/Materials/NewMaterialIcons.png", Vec2f(16, 16), 4);
		AddIconToken("$FFLESH$", "Entities/Materials/NewMaterialIcons.png", Vec2f(16, 16), 5);
		
		AddIconToken("$mat_bluegold$", "Entities/Materials/NewMaterialIcons.png", Vec2f(16, 16), 0);
		AddIconToken("$mat_mixedgold$", "Entities/Materials/NewMaterialIcons.png", Vec2f(16, 16), 1);
		AddIconToken("$mat_masterstone$", "Entities/Materials/NewMaterialIcons.png", Vec2f(16, 16), 2);
		AddIconToken("$mat_puremagic$", "Entities/Materials/NewMaterialIcons.png", Vec2f(16, 16), 3);
		AddIconToken("$mat_rflesh$", "Entities/Materials/NewMaterialIcons.png", Vec2f(16, 16), 4);
		AddIconToken("$mat_fflesh$", "Entities/Materials/NewMaterialIcons.png", Vec2f(16, 16), 5);
		...
		AddIconToken("$UDRILL$", "UpgradedDrill.png", Vec2f(32, 16), 0);
		AddIconToken("$USAW$", "UpgradedSaw.png", Vec2f(40, 16), 0);
	}
}
