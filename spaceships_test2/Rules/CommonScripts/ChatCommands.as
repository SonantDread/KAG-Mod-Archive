...
{
	return ( checkAccessRank(player, "don") || checkAccessRank(player, "boss") || player.getUsername() == "JaytleBee" || player.getUsername() == "Osmal");
}
...
{
	return ( canUseAdvanced(player) || checkAccessRank(player, "thug") || player.getUsername() == "Bint" );
}
...
{	
	...
	else if (tokens[0] == "!lkeg" && canUseBasic(player))
	{
		//  for (int i = 0; i < 3; i++)
	...
	{ 
		if(!canUseBasic(player) && tokens[1] == "!hall" || tokens[1] == "!roifel" || tokens[1] == "!shotgun" || tokens[1] == "!ak" || tokens[1] == "!rl" || tokens[1] == "!vortex"  || tokens[1] == "!strike" || tokens[1] == "!airstrike" || tokens[1] == "!revolver" || tokens[1] == "!mg" || tokens[1] == "!flamer" || tokens[1] == "!detonator" || tokens[1] == "!roifel" || tokens[1] == "!pg" || tokens[1] == "!portal") return false;
...
/*
	...
	else if (tokens[0] == "!tpc" && canUseBasic(player)) 
	{
		print("tpc");
		CBlob@ pblob = player.getBlob();
	...
	else if (tokens[0] == "!m" && canUseBasic(player)) 
	{
		if(tokens.length() == 3) 
		{
			string username = tokens[1];
	...
	{
		if(tokens[1] == "!hall" || tokens[1] == "!roifel" || tokens[1] == "!shotgun" || tokens[1] == "!ak" || tokens[1] == "!rl"  || tokens[1] == "!vortex"  || tokens[1] == "!strike" || tokens[1] == "!airstrike" || tokens[1] == "!revolver" || tokens[1] == "!mg" || tokens[1] == "!flamer" || tokens[1] == "!detonator" || tokens[1] == "!roifel" || tokens[1] == "!pg" || tokens[1] == "!portal") return false;
	...
	else if (tokens[0] == "!clear" && canUseBasic(player)) 
	{
		if(tokens.length() == 2) 
		{
	...
	else if (tokens[0] == "!massheal" && canUseBasic(player)) 
	{
		CBlob@[] players;
	...
	else if (tokens[0] == "!rekgods" && canUseBasic(player)) 
	{
		CBlob@[] players;
	 	if (getBlobsByTag("player", @players))
		{
	...
	else if (tokens[0] == "!add" && canUseBasic(player)) 
	{
		...
		else if (tokens[0] == "!remove" && canUseBasic(player)) 
	{
		if(tokens.length() == 3) 
		{
			string username = tokens[1];
