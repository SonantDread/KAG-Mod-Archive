...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$altar$", "Altar.png", Vec2f(40, 24), 0);
	AddIconToken("$library$", "Library.png", Vec2f(40, 24), 0);
	...
	{
		ShopItem@ s = addShopItem(this, "Altar", "$altar$", "altarunused", "Sacrificing gold for the greater good.");
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 150);
	}
	{
		ShopItem@ s = addShopItem(this, "Library", "$library$", "library", "For the study of... everything and more.");
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 50);
