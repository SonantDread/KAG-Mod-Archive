...
void LoadSprites(CSprite@ this)
{
	...
	this.ReloadSprite(texname, this.getConsts().frameWidth, this.getConsts().frameHeight,
	                  Maths::FMod(this.getBlob().getTeamNum(),8), this.getBlob().getSkinNum());
	this.RemoveSpriteLayer("frontarm");
	CSpriteLayer@ frontarm = this.addSpriteLayer("frontarm", texname , 32, 16, Maths::FMod(this.getBlob().getTeamNum(),8), this.getBlob().getSkinNum());
	...
	CSpriteLayer@ backarm = this.addSpriteLayer("backarm", texname , 32, 16, Maths::FMod(this.getBlob().getTeamNum(),8), this.getBlob().getSkinNum());
	...
	CSpriteLayer@ quiver = this.addSpriteLayer("quiver", texname , 16, 16, Maths::FMod(this.getBlob().getTeamNum(),8), this.getBlob().getSkinNum());
