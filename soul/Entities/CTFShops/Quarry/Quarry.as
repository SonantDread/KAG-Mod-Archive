...
const int initial_output = 10;			// output amount in ore
const int min_output = 10;				// minimal possible output in ore
...
const int rare_chance = 25;				// one-in
const int rare_output = 10;				// output for rare ore
const int conversion_frequency = 1;	    // how often to convert, in seconds

const int min_input = Maths::Ceil(input/initial_output);

//fuel levels for animation
const int max_fuel = 2000;
const int mid_fuel = 1000;
