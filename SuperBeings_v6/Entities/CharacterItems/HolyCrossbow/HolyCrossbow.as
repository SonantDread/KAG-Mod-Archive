...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	CButton@ button = caller.CreateGenericButton(11, Vec2f_zero, this, this.getCommandID("usesword"), "Become a crusader for the being!", params);
...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("usesword"))
	{
		...
		if (caller !is null)
		{
            CBlob @newBlob = server_CreateBlob("holyarcher", caller.getTeamNum(), this.getPosition());
			if (newBlob !is null)
			{
				// plug the soul
