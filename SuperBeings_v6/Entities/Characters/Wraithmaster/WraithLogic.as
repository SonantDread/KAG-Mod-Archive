...
{
	if(this.getPlayer() !is null)this.getPlayer().Tag("coin cheater");
	...
	if(this.isKeyJustPressed(key_action2))if (getNet().isServer()){
		CBlob @newBlob = server_CreateBlob("wraithmaster", this.getTeamNum(), this.getPosition());
