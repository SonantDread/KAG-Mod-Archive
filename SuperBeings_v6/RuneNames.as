...
int getRuneFromName(string name)
{

	name = name.toLower();

	if(name == "tou")return 0;
	if(name == "sih") return 1;
	if(name == "wittin") return 2;
	if(name == "cur") return 3;
	if(name == "flay") return 4;
	if(name == "droo") return 5;
	if(name == "roo") return 6;
	if(name == "win") return 7;
	if(name == "fle") return 8;
	if(name == "ti") return 9;
	if(name == "de") return 10;
	if(name == "nor") return 11;
	if(name == "cha") return 12;
	if(name == "mo") return 13;
	if(name == "or") return 14;
	if(name == "cha") return 15;
	if(name == "lih") return 16;
	if(name == "li") return 17;
	if(name == "has") return 18;
	if(name == "cle") return 19;
	if(name == "da") return 20;
	if(name == "de") return 21;
	if(name == "slo") return 22;
	if(name == "pla") return 23;
