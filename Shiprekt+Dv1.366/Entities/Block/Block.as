...
void onCollision( CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point1 )
{
	...
	if (color > 0 && other_color > 0 && color != other_color) // block vs block
	{
		...
		if (getNet().isServer() && !(blockType == Block::STATION || other_blockType == Block::STATION) && !(blockType == Block::MINISTATION || other_blockType == Block::MINISTATION) )
		{
			...
			else
			{
				...
				{
					if ( other_blockType == Block::MOTHERSHIP5 || other_blockType == Block::SECONDARYCORE )
					{
