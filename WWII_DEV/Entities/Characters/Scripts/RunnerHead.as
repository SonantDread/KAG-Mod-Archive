...
void onPlayerInfoChanged(CSprite@ this)
{
	...
	if (ply !is null)
	{
		if (ply.getUsername() == "Turtlecake")
		{
			blob.Tag("mithrios");
		
			blob.set_u8("override head", 0);
		}
		if (ply.getUsername() == "AgentHightower")
		{
			blob.Tag("mithrios");
		
			blob.set_u8("override head", 5);
		}
		if (ply.getUsername() == "Paranomius")
		{
			blob.Tag("mithrios");
		
			blob.set_u8("override head", 4);
		}
		if (ply.getUsername() == "destroyer212")
		{
			blob.Tag("mithrios");
		
			blob.set_u8("override head", 2);
		}
		if (ply.getUsername() == "digga")
		{
			blob.Tag("mithrios");
		
			blob.set_u8("override head", 3);
		}
		if (blob.hasTag("gasmask"))
		{		
			blob.set_u8("override head", 1);
		}
