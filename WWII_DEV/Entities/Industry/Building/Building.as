...
void onInit(CBlob@ this)
{
	...
	//ICONS
    AddIconToken( "$hangar$", "Hangar.png", Vec2f(40,24), 0 );
    AddIconToken( "$miscshop$", "MiscShop.png", Vec2f(40,24), 0 );
    AddIconToken( "$bombshop$", "BombShop.png", Vec2f(40,24), 0 );
    AddIconToken( "$barracks$", "KnightShop.png", Vec2f(40,24), 0 );
	...
	{
		ShopItem@ s = addShopItem(this, "Barracks", "$barracks$", "knightshop", "A Shop where Infantry can buy its necessary equipment.");
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 50);
	}
	{
		ShopItem@ s = addShopItem(this, "Hangar", "$hangar$", "hangar", "A Shop where you can buy heavy machinery such as planes, vehicles and mounted guns.");
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 50);
	}
	{
		ShopItem@ s = addShopItem(this, "Bomb Shop", "$bombshop$", "bombshop", "A Shop where you can buy everything related to explosives.");
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 50);
	}
	{
		ShopItem@ s = addShopItem(this, "Misc Shop", "$miscshop$", "miscshop", "A Shop where you can buy miscelleanous items.");
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 50);
	}
}
