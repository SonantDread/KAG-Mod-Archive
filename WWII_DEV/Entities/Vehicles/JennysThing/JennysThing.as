...
void Shoot(CBlob@ this)
{
	...
	if (getNet().isServer())
	{
		...
		if (mapHit)
		{
			...
			this.set_f32("map_damage_radius", 120.0f);
			this.set_f32("map_damage_ratio", 6.50f);
			ExplodeV(this, 20.0f, 14.0f, hitPos);
