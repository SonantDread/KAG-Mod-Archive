...
const Vec2f arm_offset = Vec2f(-5,-5);

const Vec2f bullet_offset = Vec2f(10,-5);
...
void onInit( CBlob@ this )
{
    ...
    Vehicle_SetupWeapon( this, v,
                         ...
                         Vec2f(0.0f, 2.0f), // fire position offset
                         "mat_bullets4", // bullet ammo config name
                         "lightaashot", // bullet config name
                         "AA", // fire sound
                         "EmptyFire" // empty fire sound
                       );
    v.charge = 0;
    CSprite@ sprite = this.getSprite();
    CSpriteLayer@ arm = sprite.addSpriteLayer( "arm", sprite.getConsts().filename, 64, 16 );
    ...
    CSpriteLayer@ cage = sprite.addSpriteLayer( "cage", sprite.getConsts().filename, 32, 32 );
	...
	this.set_string("autograb blob", "mat_bullets4");
	...
	if (getNet().isServer())
	{
		CBlob@ ammo = server_CreateBlob( "mat_bullets4" );
		if (ammo !is null)	{
