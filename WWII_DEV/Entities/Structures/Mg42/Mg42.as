...
const Vec2f arm_offset = Vec2f(-2,-5);
...
void onInit( CBlob@ this )
{
    ...
    Vehicle_SetupWeapon( this, v,
                         ...
                         "mat_bullets3", // bullet ammo config name
                         "mg42bullet", // bullet config name
                         "mg42", // fire sound
	...
	this.set_string("autograb blob", "mat_bullets3");
	...
	if (getNet().isServer())
	{
		CBlob@ ammo = server_CreateBlob( "mat_bullets3" );
		if (ammo !is null)	{
