...
const uint8 FIRE_INTERVAL = 80; //40;
const float BULLET_DAMAGE = 5.5; //2.5
const uint8 PROJECTILE_SPEED = 35; 
const float TIME_TILL_DIE = 2;

const uint8 CLIP = 5; //True to the weapon ;)
const uint8 TOTAL = 40;
const uint8 RELOAD_TIME = 95; //40;
