...
AddIconToken("$vehicleshop_upgrademg$", "Bullet.png", Vec2f(32, 16), 1);
	...
	{
		ShopItem@ s = addShopItem(this, "MG Upgrade", "$vehicleshop_upgrademg$", "upgradeMG", "-50% reloading time and twice more bullets", false);
		s.spawnNothing = true;
		s.customButton = true;
		s.buttonwidth = 2;
		s.buttonheight = 1;
	...
	
	{
		...
		s.buttonwidth = 2;
		s.buttonheight = 1;
		AddRequirement(s.requirements, "blob", "mat_gold", "Gold", 400);
