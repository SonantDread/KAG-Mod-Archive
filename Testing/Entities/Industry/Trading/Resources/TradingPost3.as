...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Wood", "$mat_wood$", "mat_wood", "Receive 250 wood for 10 gold", true);
	...
	{
		ShopItem@ s = addShopItem(this, "Stone", "$mat_stone$", "mat_stone", "Receive 250 stone for 50 gold", true);
	...
	{
		ShopItem@ s = addShopItem(this, "Gold", "$mat_gold$", "mat_gold", "Receive 50 gold for 1000 wood", true);
