...
void MakeTradeMenu(CBlob@ trader)
{
	...
	s32 cost_bombs = cfg.read_s32("cost_bombs", 40);
	s32 cost_waterbombs = cfg.read_s32("cost_waterbombs", 80);
	s32 cost_keg = cfg.read_s32("cost_keg", 160);
	s32 cost_mine = cfg.read_s32("cost_mine", 100);

	s32 cost_arrows = cfg.read_s32("cost_arrows", 20);
	s32 cost_waterarrows = cfg.read_s32("cost_waterarrows", 80);
	s32 cost_firearrows = cfg.read_s32("cost_firearrows", 60);
	s32 cost_bombarrows = cfg.read_s32("cost_bombarrows", 70);

	s32 cost_boulder = cfg.read_s32("cost_boulder", 25);
	s32 cost_sponge = cfg.read_s32("cost_sponge", 10);

	s32 cost_mountedbow = cfg.read_s32("cost_mountedbow", 1000);
	s32 cost_drill = cfg.read_s32("cost_drill", -1);
	s32 cost_catapult = cfg.read_s32("cost_catapult", 1000);
	s32 cost_ballista = cfg.read_s32("cost_ballista", 1500);
