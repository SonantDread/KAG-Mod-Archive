...
string getPowerTip(u8 pow) {
    switch(pow) {
        ...
        case Powers::FORCE: return "To use The Force, aim your mouse at something and hold E.";
        case Powers::GHOST: return "The Ghost power allows you to move through objects.";
        case Powers::TELEPORT: return "Teleport allows you to teleport with your taunt keybind!";
    }
    return "";
}
