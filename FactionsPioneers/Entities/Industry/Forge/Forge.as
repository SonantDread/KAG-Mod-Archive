...
void onInit(CBlob@ this)
{
	...
	// Other
	AddIconToken( "$divinghelmet_$", "DivingHelmetIcon.png", Vec2f(16,16), 0);
	...
	{
		ShopItem@ s = addShopItem(this, "Diving Helmet", "$divinghelmet_$", "divinghelmet", "A helmet that allows you to breath longer underwater.", false);
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 500);
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 50);
	}
}/*
