// Brutality Isle modded to cut sparkwood logs
// Saw logic
...
void Blend(CBlob@ this, CBlob@ tobeblended)
{
	...
	if (tobeblended.getName() == "log" || tobeblended.getName() == "sparkwoodlog")
	{
        string woodname = tobeblended.getName() == "log" ? "mat_wood" : "mat_sparkwood";
		CBlob @wood = server_CreateBlob(woodname, this.getTeamNum(), this.getPosition() + Vec2f(0, 12));
		if (wood !is null)
		{
