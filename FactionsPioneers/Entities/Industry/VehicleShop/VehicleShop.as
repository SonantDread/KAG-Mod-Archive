...
void onInit(CBlob@ this)
{
	...
	}
	{
		...
		AddRequirement(s.requirements, "blob", "mat_sparkwood", "Sparkwood", 125);
	}
	{
		ShopItem@ s = addShopItem(this, "Ballista Ammo", "$mat_bolts$", "mat_bolts", "$mat_bolts$\n\n\n" + descriptions[15], false, false);
		s.crate_icon = 5;
		AddRequirement(s.requirements, "blob", "mat_sparkwood", "Sparkwood", 100);
	}
	{
	...
	}
	{
		...
		s.crate_icon = 0;
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 950);
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 750);
		AddRequirement(s.requirements, "blob", "mat_sparkwood", "Sparkwood", 1500);
	}
}
