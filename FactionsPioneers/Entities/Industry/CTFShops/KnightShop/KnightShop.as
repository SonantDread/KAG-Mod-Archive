...
void onInit(CBlob@ this)
{
...

	{
		...
		AddRequirement(s.requirements, "blob", "mat_sparkwood", "Sparkwood", 50);
	}
	{
		ShopItem@ s = addShopItem(this, "Water Bomb", "$waterbomb$", "mat_waterbombs", descriptions[52], true);
		AddRequirement(s.requirements, "blob", "mat_sparkwood", "Sparkwood", 80);
	}
	{
	...
	}
	{
		...
		AddRequirement(s.requirements, "blob", "mat_sparkwood", "Sparkwood", 300);
	}
}
