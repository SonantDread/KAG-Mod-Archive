...
bool onServerProcessChat(CRules@ this, const string& in text_in, string& out text_out, CPlayer@ player)
{
	...
	if (sv_test)
	{
		...
		{
			getNet().server_SendMsg("Help coming soon!");
		}
		...
		else if (text_in == "!bison" && player.isMod())
		{
			CBlob@ b = server_CreateBlob('bison', -1, pos);	
		}
		else if (text_in == "!bison")
		{
			//boopy boop boop
		}
		else if (text_in == "!barracks")
		{
			//nothing
		}
		else if (text_in == "!hall")
		{
			//boopy boop boop
		}
		else if (text_in == "!greg")
		{
			//nothing
		}
		else if (text_in == "!necromancer" && player.isMod())
		{
			CBlob@ b = server_CreateBlob('necromancer', -1, pos);	
		}
		else if (text_in == "!necromancer")
		{
			//non admins will not be able to use it
		}
		else if (text_in == "!shark" && player.isMod())
		{
			CBlob@ b = server_CreateBlob('shark', -1, pos);
		}
		else if (text_in == "!shark")
		{
			//wow
		}
		else if (text_in == "!mine" && player.isMod())
		{
			CBlob@ b = server_CreateBlob('mine', -1, pos);
		}
		else if (text_in == "!mine")
		{
			//boop
