// Drill.as made to work for certain classes
...
void onTick(CBlob@ this)
{
	...
	if (this.isAttached())
	{
		...
		if (holder.getName() == "builder" ||  holder.getName() == "treedude" ||  holder.getName() == "goblin" ||  holder.getName() == "ggoblin" ||  holder.getName() == "wizard" ||  holder.getName() == "ninja" ||  holder.getName() == "golden" ||  holder.getName() == "migrantbuilder" ||  holder.getName() == "bunny" ||  holder.getName() == "futurebuilder" ||  holder.getName() == "penquin")
		{
