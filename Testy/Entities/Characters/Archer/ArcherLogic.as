...
void ClientFire(CBlob@ this, const s8 charge_time, const bool hasarrow, const u8 arrow_type, const bool legolas)
{
	...
	if (hasarrow && canSend(this))  // client-logic
	{
		...
		if (charge_time < ArcherParams::ready_time / 0.5 + ArcherParams::shoot_period_1)
		{
			arrowspeed = ArcherParams::shoot_max_vel * (1.0f / 3.0f);
		}
		else if (charge_time < ArcherParams::ready_time / 0.5 + ArcherParams::shoot_period_2)
		{
...
{
	CBlob@ arrow = server_CreateBlobNoInit("balld");
	if (arrow !is null)
	{
		// fire arrow?
