...
void onTick(CBlob@ this)
{
	...
	if(this.get_s16("timer") > 30*60)this.server_Die();
	...
	if (this.getMap().getBlobsInRadius(this.getPosition(), 64.0f, @blobsInRadius)) 
	{
		for (uint i = 0; i < blobsInRadius.length; i++)
		{
			...
			if(b.getName() == "necro" || b.getName() == "necromancer" || b.getName() == "darkknight" || b.getName() == "darkbeing")
			{
				this.set_s16("timer",0);
			}
			if(b.getName() == "ruins" || b.getName() == "flag_base")
			{
				this.server_Die();
			}
		}
