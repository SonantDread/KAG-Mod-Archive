...
{
	return blob.hasTag("player") && (blob.getName() != "goldenbeing");
}

void onCollision( CBlob@ this, CBlob@ blob, bool solid, Vec2f normal)
{
	if(blob !is null && blob.hasTag("player") && (blob.getName() != "goldenbeing"))
	{
		if(blob.getName() != "darkbeing")blob.server_Die();
		else {
			blob.set_s16("power",blob.get_s16("power")-50);
			this.server_Die();
		}
	}
