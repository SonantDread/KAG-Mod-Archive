...
void onTick(CBlob@ this)
{
	...
	if(this.get_s16("power") > 1000)this.set_s16("power",1000);
...
void onCreateInventoryMenu(CBlob@ this, CBlob@ forBlob, CGridMenu @gridmenu)
{
	...
	AddIconToken("$necrostaff$", "NecroStaff.png", Vec2f(16, 16), 0);
	...
	if (menu !is null)
	{
		...
		{
			CGridButton@ b = menu.AddButton("$necrostaff$", "Give a mortal control over life and death. Costs 500 death.", this.getCommandID("makenecro"));
