...
void onInit( CBlob@ this )
{
	...
	//const u8 boltType = this.get_u8("bolt type");
	//if (boltType == BoltType::bomb)			 // bomb arrow
}
    ...
    if ( map.getHitInfosFromArc( tailpos, -angle, 10, vellen + 12.0f, this, false, @hitInfos ) )
    {
		for (uint i = 0; i < hitInfos.length; i++)
        {
            ...
            if (hi.blob !is null) // blob
            {
                ...
                BallistaHitBlob( this, hi.hitpos, initVelocity, dmg, hi.blob, Hitters::ballista );
                this.server_Hit( hi.blob, hi.hitpos, initVelocity, dmg, Hitters::ballista);
