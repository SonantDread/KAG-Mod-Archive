...
const SColor color_cheapwood(255, 255, 166, 0);
const SColor color_plane(255, 125, 130, 75);
const SColor color_bed(255, 30, 35, 100);
const SColor color_window(255, 255, 160, 200);
const SColor color_chair(255, 30, 35, 120);
const SColor color_table(255, 30, 35, 140);
...
class PNGLoader
{
	...
	void handlePixel(SColor pixel, int offset)
	{
		...
		if(alpha < 255)
		{
			...
			{
				spawnBlob(map, "knight", getTeamFromChannel(alpha), position, getAngleFromChannel(alpha), true);
				offsets[autotile_offset].push_back(offset);
			}
			...
			else if(rgb == cheapwood)
			{
				spawnBlob(map, "cheapwood", getTeamFromChannel(alpha), position, getAngleFromChannel(alpha), true);
				offsets[autotile_offset].push_back(offset);
			}*/
			// MARKERS
			else if(rgb == spawn)
		...
		else if (pixel == color_cheapwood)
		{
			spawnBlob( map, "cheapwood", offset, -1);
			offsets[autotile_offset].push_back( offset );
		}				
		else if (pixel == color_bed)
		{
			spawnBlob( map, "bed", offset, -1);
			offsets[autotile_offset].push_back( offset );
		}							
		else if (pixel == color_chair)
		{
			spawnBlob( map, "chair", offset, -1);
			offsets[autotile_offset].push_back( offset );
		}					
		else if (pixel == color_table)
		{
			spawnBlob( map, "table", offset, -1);
			offsets[autotile_offset].push_back( offset );
		}			
		else if (pixel == color_window)
		{
			spawnBlob( map, "window", offset, -1);
			offsets[autotile_offset].push_back( offset );
		}		
		else if (pixel == color_plane)
		{
			spawnBlob( map, "plane", offset, -1);
			offsets[autotile_offset].push_back( offset );
		}
