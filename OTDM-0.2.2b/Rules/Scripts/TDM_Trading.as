...
void onBlobCreated(CRules@ this, CBlob@ blob)
{
	if (blob.getName() == "tradingpost")
	{
   	...
   	AddIconToken("$airstrike$", "Airstrike.png", Vec2f(8, 8), 0);
   	AddIconToken("$detonator$", "Detonator.png", Vec2f(8, 8), 0);
   	AddIconToken("$bumper$", "Bumper.png", Vec2f(48, 48), 0);
   	AddIconToken("$jp$", "JumpPack.png", Vec2f(32, 32), 0);
   	AddIconToken("$rl$", "RocketLauncher.png", Vec2f(32, 32), 0);
   	AddIconToken("$plane$", "Plane.png", Vec2f(64, 32), 0);
   	...
   	AddIconToken("$summoner$", "Summoner.png", Vec2f(8, 8), 0);
   	AddIconToken("$summoner2$", "Summoner2.png", Vec2f(8, 8), 0);
   	AddIconToken("$eshield$", "EShield.png", Vec2f(8, 8), 0);
   	AddIconToken("$flamer$", "Flamer.png", Vec2f(32, 32), 0);
   	AddIconToken("$fl$", "Flashlight.png", Vec2f(16, 16), 0);
}
...
void MakeTradeMenu(CBlob@ trader)
{
	...
	// build menu
	CreateTradeMenu(trader, Vec2f(8, 8), "Buy weapons");
	...
	if (cost_bombs > 0)
		...
		addItemForCoin(trader, "Flamer", 150, true, "$flamer$", "flamer", "Flamer");
		...
		addItemForCoin(trader, "Detonator", 5, true, "$detonator$", "detonator", "Detonator\nSpace to use\nDetonates your mines");
		...
		addItemForCoin(trader, "Summoner Tier I", 35, true, "$summoner$", "summoner", "Summoner Tier I\nSpace to use\nSword-wielding reinforcements");
		addItemForCoin(trader, "Summoner Tier II", 100, true, "$summoner2$", "summoner2", "Summoner Tier II\nSpace to use\nGun-wielding reinforcements");
		...
		addItemForCoin(trader, "Healer", 60, true, "$healer$", "healer", "Healer");
		addItemForCoin(trader, "Flashlight", 5, true, "$fl$", "fl", "Flashlight");
	if (cost_keg > 0)
