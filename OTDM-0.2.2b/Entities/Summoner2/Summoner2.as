...
void onTick(CBlob@ this)
{
	...
	{		
		...
		CBlob@ ak = server_CreateBlob("ak", this.getTeamNum(), Vec2f(pos));
		if (ak !is null)
		{			ak.server_SetTimeToDie(19);
			ak.SetDamageOwnerPlayer(holder.getPlayer());
		}
		...
		CBlob@ ak2 = server_CreateBlob("ak", this.getTeamNum(), Vec2f(pos2));
		if (ak2 !is null)
		{			ak2.server_SetTimeToDie(19);
			ak2.SetDamageOwnerPlayer(holder.getPlayer());
		}
		...
		CBlob@ ak3 = server_CreateBlob("ak", this.getTeamNum(), Vec2f(pos3));
		if (ak3 !is null)
		{			ak3.server_SetTimeToDie(19);
			ak3.SetDamageOwnerPlayer(holder.getPlayer());
		}
