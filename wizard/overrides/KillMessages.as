// OVERRIDE MOD
// changes: added orb and wizexplosion
    ...
    void Render()
    {
        ...
        for (uint message_step = 0; message_step < count; ++message_step)
        {
            ...
            switch (message.hitter)
            {
                ...
                case Hitters::orb:              hitterIcon = "$killfeed_orb"+message.attackerteam+"$"; break;

                case Hitters::wizexplosion: hitterIcon = "$killfeed_bomb$"; break;
            ...
            if (hitterIcon != "")
            {
                ...
                if(message.hitter == Hitters::orb){
                    ul.Set(dim.x + 24, ((message_step + 1) * 16) + 2);
                } else {
                    ul.Set(dim.x, ((message_step + 1) * 16) - 8);
                }
...
void onInit(CRules@ this)
{
    ...
    AddIconToken( "$killfeed_orb0$", "MagicOrb.png", Vec2f(8,8), 1 , 0);
    AddIconToken( "$killfeed_orb1$", "MagicOrb.png", Vec2f(8,8), 1 , 1);
}
