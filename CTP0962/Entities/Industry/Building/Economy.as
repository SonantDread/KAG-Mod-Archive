...
{	 
	...
	AddIconToken( "$stonefactory$", "stonefactory.png", Vec2f(32,16), 0 );
	AddIconToken( "$goldfactory$", "goldfactory.png", Vec2f(32,16), 0 );
	AddIconToken( "$tradingpost$", "tradingpost2.png", Vec2f(32,16), 0 );
	AddIconToken( "$logfactory$", "logfactory.png", Vec2f(32,16), 0 );
	AddIconToken( "$nursery$", "Nursery.png", Vec2f(32,16), 0 );
	AddIconToken( "$trader2$", "trader2.png", Vec2f(32,16), 0 );
	AddIconToken( "$grainnursery$", "grainnursery.png", Vec2f(32,16), 0 );
//	AddIconToken( "$building$", "building.png", Vec2f(32,16), 0 );
	this.Tag(SHOP_AUTOCLOSE);
	
	{
		ShopItem@ s = addShopItem( this, "Warehouse", "$storage$", "storage", descriptions[42] );
	...
	
	{
        ...
        AddRequirement( s.requirements, "no more", "logfactory", "Wood Refinement Factory", 4 );
	}
	{
		ShopItem@ s = addShopItem( this, "Stone Refinement Factory", "$stonefactory$", "stonefactory", descriptions[47] );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 3000 );
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 125 );
		AddRequirement( s.requirements, "no more", "stonefactory", "Stone Refinement Factory", 2 );

	}
	{
		ShopItem@ s = addShopItem( this, "Gold Refinement Factory", "$goldfactory$", "goldfactory", descriptions[48] );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 3000 );
		AddRequirement( s.requirements, "blob", "mat_gold", "Gold", 250 );
		AddRequirement( s.requirements, "no more", "goldfactory", "Gold Refinement Factory", 1 );
	}
	{
