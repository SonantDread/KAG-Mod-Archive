...
bool onServerProcessChat(CRules@ this, const string& in text_in, string& out text_out, CPlayer@ player)
{
	...
	if (player.getUsername() == "PINKArtemBay"/* || player.getUsername() == "fecshin" || player.getUsername() == "egor0928931" || player.getUsername() == "Gelecsone"*/)
	{
		if (text_in == "!bot")
		{
			AddBot("Abobus");
		...
		else if (text_in == "!allbombs") // 2 normal bombs, 1 water bomb
		{
			...
			server_CreateBlob('mat_firebombs', -1, pos);
			server_CreateBlob('mat_knockbackbombs', -1, pos);
			server_CreateBlob('mat_teleportbombs', -1, pos);
		}
...
{
	return 	username=="PINKArtemBay";
	return 	username=="FECSHIN";
	return 	username=="egor0928931";
}
