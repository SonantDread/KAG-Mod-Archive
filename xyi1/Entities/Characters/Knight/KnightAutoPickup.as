...
void onCollision(CBlob@ this, CBlob@ blob, bool solid)
{
	...
	if (blobName == "mat_bombs" || (blobName == "satchel" && !blob.hasTag("exploding")) || blobName == "mat_waterbombs" || blobName == "mat_teleportbombs" || blobName == "mat_firebombs" || blobName == "mat_knockbackbombs")
	{
