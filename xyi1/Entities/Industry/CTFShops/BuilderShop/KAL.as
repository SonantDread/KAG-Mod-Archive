...
void onInit(CBlob@ this)
{
	...
	if(ClassesConfig::builder || ClassesConfig::rockthrower || ClassesConfig::warcrafter || ClassesConfig::demolitionist || ClassesConfig::chopper)
	{
		ShopItem@ s = addShopItem(this, "Drill", "$drill$", "drill", Descriptions::drill + "\n\nRock Thrower, War Crafter, Demolitionist and Chopper can use this too.", false);
