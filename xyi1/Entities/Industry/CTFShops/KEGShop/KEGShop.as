...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$FireBombIconnn$", "FireBombIcon.png",Vec2f(16, 32), 0);
    AddIconToken("$KnockbackBombIconnn$", "KnockbackBombIcon.png",Vec2f(16, 32), 0);
	AddIconToken("$TeleportBombIconnn$", "TeleportBombIcon.png",Vec2f(16, 32), 0);
	...
	{
		ShopItem@ s = addShopItem(this, "Exploding Tick", "$exploding_tick$", "tick", "A mine on legs. Runs into enemies and explodes, dealing 4 hearts of damage.", false);
