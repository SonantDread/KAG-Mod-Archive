...
void onInit(CBlob@ this)
{
	...
	/*{
	 	ShopItem@ s = addShopItem(this, "Rocket Arrows", "$mat_rocketarrows$", "mat_rocketarrows", "Shoots a barrage of inaccurate weak explosive arrows", true);
	 	AddRequirement(s.requirements, "coin", "", "Coins", 60);
	}
	{
	 	ShopItem@ s = addShopItem(this, "Homing Arrows", "$mat_homingarrows$", "mat_homingarrows", "Fucking shit of homeck", true);
	 	AddRequirement(s.requirements, "coin", "", "Coins", 60);
	}*/
}
