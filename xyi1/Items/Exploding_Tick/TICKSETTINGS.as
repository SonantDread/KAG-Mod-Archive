...
void onInit(CBlob@ this)
{
	AnimalVars vars;
	//walking vars
	vars.walkForce = Vec2f(350.0f, -100.0f) * (this.getMass() / 500.0f);
	vars.runForce = Vec2f(150.0f, -50.0f) * (this.getMass() / 500.0f);
	vars.slowForce = Vec2f(50.0f, 0.0f) * (this.getMass() / 500.0f);
	vars.jumpForce = Vec2f(0.0f, -900.0f) * (this.getMass() / 500.0f);
