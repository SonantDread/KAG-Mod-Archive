...
const string burner_blob_id = "burn starter blob";
const string burner_player_id = "burn starter player";

const u8 burn_array_size = 4;
const string player_burn_array = "player_burn_array";
const string burn_array_i = "player_burn_array_i";
