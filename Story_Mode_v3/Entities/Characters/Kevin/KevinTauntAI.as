...
void onInit(CBlob@ this)
{
	...
	//chats
	{
		string[] temp = { "Who's the best, oh yes, it's me!",
		                  "Ahaha, get wrecked!",
		                  "What a chump.",
		                  "YES, I simply am the best don't ya know?",
		                  "I pity you, I really do... not, HAAHAH.",
		                  "You think you can take me?",
		                  "I fought through hundreds before you!",
						  "I. AM. INVINCIBLE."
		                };
		b.taunts = temp;
	}
	{
		string[] temp = { "Oh, please.",
		                  "Didn't even hurt.",
		                  "Not a scratch see?",
		                  "Woah, not as good as me though!",
		                  "Ow! That actually, er, DIDN'T hurt!",
		                  "Hrmph.",
		                  "Easy there, you might cut someone!",
		                  "You missed!",
		                  "What are you even doing here?",
		                  "*pants*",
		                  "Well, my sword is a lot bigger than your pathetic thing.",
		                  "Death shall be visiting m... er, you tonight!"
		                };
		b.whines = temp;
	}
