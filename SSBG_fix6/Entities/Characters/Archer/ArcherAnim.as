...
void LoadSprites( CSprite@ this )
{
    ...
    if (looseRope !is null)
    {
		...
		array<int> frames = {32, 33, 34, 35, 36, 37, 38, 37, 36, 35, 34, 33};
		anim.AddFrames( frames );
        looseRope.SetRelativeZ(999.0f);
...
void doRopeUpdate(CSprite@ this, CBlob@ blob, ArcherInfo@ archer)
{
	...
	if (!this.getBlob().isKeyPressed(key_action2) || !(archer.grapple_id == 0xffff) || archer.grapple_id == 0)
	{
	...
	looseRope.RotateBy( -off.Angle() , Vec2f());
