...
void DoThrow( CBlob@ this, CBlob@ carried, Vec2f pos, Vec2f vector, Vec2f selfVelocity )
{
    ...
    if (carried !is null)
    {
		...
		{
			f32 currentHealth = this.getCarriedBlob().getHealth();
			f32 initialHealth = this.getCarriedBlob().getInitialHealth();
			f32 fractionHealth = (initialHealth - currentHealth)/initialHealth;
			vel *= fractionHealth*50.0f;
			this.getCarriedBlob().set_u8("knocked", fractionHealth*500 );
		}
