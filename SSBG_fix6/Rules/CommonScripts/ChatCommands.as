...
bool onServerProcessChat( CRules@ this, const string& in text_in, string& out text_out, CPlayer@ player )
{
	...
	{	
		client_AddToChat( "player: " + player.getUsername(), SColor(255, 255, 0,0));
...
{
	return player is null ? false : admins.find(player.getUsername()) < admins.size();
