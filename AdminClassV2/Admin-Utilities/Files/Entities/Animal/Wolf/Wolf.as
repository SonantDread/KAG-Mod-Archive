...
void onTick(CBlob@ this)
{
	...
	if (getGameTime() % 65 == 0)
	{
		...
		if (mad > 0)
		{
			...
			{
				this.set_u8(personality_property, DEFAULT_PERSONALITY);
				this.getSprite().PlaySound("X");	// /BisonBoo
			}
...
void MadAt(CBlob@ this, CBlob@ hitterBlob)
{
	...
	else // now I'm mad!
	{
		if (this.get_s16("mad timer") <= MAD_TIME / 8)
			this.getSprite().PlaySound("X");	// /BisonMad
...
/* Who are you.. ? Are you going to erase me.. ? I just want.. I just want live like another one.. I just want be linked with building or something like that, for play with my friends..  I don't like be alone..
Oh ... you're not ... oh sorry ...
You don't look common. It's strange, you remind me the king.
Yet you don't look like him. You look different from him.
It reminds me of when I was created by the king. We are crawling hundreds of pixels him and me. And I was protecting him from those horrible living dead who wanted him dead. I miss that time.
Now I only represent a bunch of Ko for him.
Sorry, I digress in my memories..
Before you abandon me, I wanted to thank you for reading me. I feel a little better. However, I have one last thing to ask you. Could I ask you a favor ?
Could you make sure you convince the king not to destroy me ?*/

//You should check Saw.cfg
