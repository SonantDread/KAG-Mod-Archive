...
{		
	Vehicle_Setup( this,
				   1000.0f, // move speed default is 30.0
				   5.31f,  // turn speed default is 0.31
	...
	Vehicle_addWheel( this, v, "StoneWheels.png", 16, 16, 1, Vec2f(-22.0f,4.0f) );
	Vehicle_addWheel( this, v, "StoneWheels.png", 16, 16, 0, Vec2f(-15.0f,10.0f) );
	Vehicle_addWheel( this, v, "StoneWheels.png", 16, 16, 0, Vec2f(-5.0f,10.0f) );
	Vehicle_addWheel( this, v, "StoneWheels.png", 16, 16, 0, Vec2f(5.0f,10.0f) );
	Vehicle_addWheel( this, v, "StoneWheels.png", 16, 16, 0, Vec2f(15.0f,10.0f) );
	Vehicle_addWheel( this, v, "StoneWheels.png", 16, 16, 1, Vec2f(22.0f,4.0f) );
	...
	this.set_f32("map dmg modifier", 0.50f); //2.0
...
void onHealthChange( CBlob@ this, f32 oldHealth )
{
	...
	{	
		...
		makeGibParticle( "StoneWheels.png", 
