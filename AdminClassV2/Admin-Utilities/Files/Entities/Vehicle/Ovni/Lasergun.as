...
void onInit(CBlob@ this)
{
	...
	Vehicle_AddAmmo(this, v,
	                    ...
	                    1, // fire cost
	                    "crystal_ammo", // bullet ammo config name
						"Crystal Ammo", // name for ammo selection
	                    "crystal_a", // bullet config name
	                    "FireLasergun", // fire sound
	...
	string[] autograb_blobs = {"crystal_ammo"};
	...
	if (getNet().isServer())
	{
		CBlob@ ammo = server_CreateBlob("crystal_ammo");
		if (ammo !is null)
		{
