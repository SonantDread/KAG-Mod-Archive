...
{
	return Vehicle_addWheel(this, v, "Entities/Vehicule/Common/RubberWheel.png", 16, 16, frame, offset);
}

CSpriteLayer@ Vehicle_addMetalWheel(CBlob@ this, VehicleInfo@ v, int frame, Vec2f offset)
{
	return Vehicle_addWheel(this, v, "Entities/Vehicule/Common/MetalWheel.png", 16, 16, frame, offset);
}
