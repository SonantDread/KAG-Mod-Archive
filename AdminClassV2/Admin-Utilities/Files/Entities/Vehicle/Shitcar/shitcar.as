...
void onInit(CBlob@ this)
{
	...
	{ CSpriteLayer@ w = Vehicle_addRubberWheel(this, v, 0, Vec2f(12.0f, 18.0f)); if (w !is null) w.SetRelativeZ(10.1f); }
	{ CSpriteLayer@ w = Vehicle_addRubberWheel(this, v, 0, Vec2f(-15.0f, 18.0f)); if (w !is null) w.SetRelativeZ(9.9f); }
...
void onTick(CBlob@ this)
{
	if (this.hasAttached() || this.getTickSinceCreated() < 30)
	{
		...
		if (arm !is null)
		{
			...
			arm.SetOffset(Vec2f(-12.0f, -13.0f));
