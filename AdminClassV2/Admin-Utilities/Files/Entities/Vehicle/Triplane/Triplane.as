...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	{
		string fuel_name = carried.getName();
		bool isValid = fuel_name == "mat_coal" || fuel_name == "mat_wood" || fuel_name == "mat_gaz";
...
void onRender(CSprite@ this)
{
	...
	if (fuel <= 0 && mouseOnBlob)
	{
		...
		GUI::DrawTextCentered("(Coal, Wood, gaz)", Vec2f(pos.x, pos.y + 105 + Maths::Sin(getGameTime() / 5.0f) * 5.0f), SColor(255, 255, 55, 55));
	}
}
