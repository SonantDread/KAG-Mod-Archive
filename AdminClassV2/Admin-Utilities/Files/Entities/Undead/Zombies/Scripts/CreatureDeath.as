...
void onTick( CBlob@ this )
{
	...
	if (this.get_u32( "death time" ) + VANISH_BODY_SECS * getTicksASecond() < getGameTime() )
	{
		...
		else if(this.getName() == "hayrock")
			server_CreateBlob("hayrock", -1, this.getPosition());
			
		else if(this.getName() == "minotaur")
			server_CreateBlob("minotaur", -1, this.getPosition());
			
		else if(this.getName() == "BossRabidDog")
			server_CreateBlob("BossRabidDog", -1, this.getPosition());
			
		else if(this.getName() == "BossGreenTroll")
			server_CreateBlob("BossGreenTroll", -1, this.getPosition());
			
		else if(this.getName() == "BossRedDragon")
			server_CreateBlob("BossRedDragon", -1, this.getPosition());
