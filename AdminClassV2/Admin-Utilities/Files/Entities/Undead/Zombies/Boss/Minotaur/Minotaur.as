...
void onInit(CBlob@ this)
{
	...
	this.set_f32(target_searchrad_property, 912.0f);
...
void onTick(CBlob@ this)
{
	...
	{
		this.getSprite().PlaySound("/minotaur_growl");
	}
	...
	if (getNet().isServer() && getGameTime() % 10 == 0)
	{
		...
		if (target !is null && this.getDistanceTo(target) < 40.0f)
		{
			this.Tag(chomp_tag);
		}
		else
