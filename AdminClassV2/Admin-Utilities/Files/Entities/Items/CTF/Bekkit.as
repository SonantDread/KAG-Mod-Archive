...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	if (getNet().isServer())
	{
		...
		if (cmd == this.getCommandID("sv_insert"))
		{
			...
			bool isTrackValid = carried !is null && carried.getName() == "Vinyl" && carried.get_u8("trackID") >= 0 && carried.get_u8("trackID") < DiscNum + 1;
		...
		else if (cmd == this.getCommandID("sv_eject"))
		{
			...
			CBlob@ disc = server_CreateBlob("Vinyl", 0, this.getPosition() + Vec2f(0, -4));
