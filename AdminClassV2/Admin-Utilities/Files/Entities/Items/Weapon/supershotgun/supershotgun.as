...
const uint8 CLIP        = 16; //Used
const uint8 TOTAL       = 110; //Used
const uint8 RELOAD_TIME = 10; //Used, reload timer (in ticks)
const uint8 BUL_PER_SHOT= 8; //Shots per bullet | CHANGE B_SPREAD, otherwise both bullets will come out together
...
const int   G_RECOIL = -45; //0 is default, adds recoil aiming up
...
const string FIRE_SOUND    = "shotgun_dbl_fire7.ogg"; //Used
