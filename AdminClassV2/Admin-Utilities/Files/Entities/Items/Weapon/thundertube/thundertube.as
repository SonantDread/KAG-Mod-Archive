...
const uint8 FIRE_INTERVAL = 0.7;
const uint8 CLIP        = 45; //Used
const uint8 TOTAL       = 150; //Used
const uint8 RELOAD_TIME = 55; //Used, reload timer (in ticks)
...
const Vec2f B_GRAV   = Vec2f(0,0.055); //Bullet gravity drop \|/
...
const float B_DAMAGE = 0.35; //1 heart
