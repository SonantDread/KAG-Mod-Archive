...
const uint8 CLIP        = 50; //Used
const uint8 TOTAL       = 200; //Used
const uint8 RELOAD_TIME = 45; //Used, reload timer (in ticks)
const uint8 BUL_PER_SHOT= 2; //Shots per bullet | CHANGE B_SPREAD, otherwise both bullets will come out together
