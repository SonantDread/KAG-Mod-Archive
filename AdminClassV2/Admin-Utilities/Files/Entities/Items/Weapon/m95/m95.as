...
const uint8 FIRE_INTERVAL = 65; //Used 
const uint8 CLIP        = 4; //Used
...
const Vec2f B_GRAV   = Vec2f(0,0.005); //Bullet gravity drop \|/
...
const float B_DAMAGE = 7.5; //1 heart
...
const int   G_RECOIL= -15; //0 is default, adds recoil aiming up
const bool  G_RANDOMX= false;//Should we randomly move x
...
const string FIRE_SOUND    = "sniper.ogg"; //Used
const string RELOAD_SOUND  = "Reload.ogg"; //Used

const Vec2f RECOIL = Vec2f(-10.0f,0.0); //Unused probably
