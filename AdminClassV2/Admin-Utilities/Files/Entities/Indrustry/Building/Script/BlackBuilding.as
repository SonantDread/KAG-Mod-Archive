...
{	 
	...
	{
		ShopItem@ s = addShopItem( this, "Necromancer Shop", "$necromancershop$", "necromancershop", "The most terrible shop." );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 500 );
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 500 );
		AddRequirement( s.requirements, "blob", "blackpage", "Corrupts Crystals Shards", 3 );
