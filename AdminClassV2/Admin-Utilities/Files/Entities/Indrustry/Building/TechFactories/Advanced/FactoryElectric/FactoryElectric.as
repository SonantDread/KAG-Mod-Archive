...
const string fuel = "material_powder_crystal";
const string ore = "mat_elec";
const string rare_ore = "mat_elec";
...
const int rare_output = 50;				//output for rare ore
...
const int max_fuel = 450;
const int mid_fuel = 200;
...
{
	CSpriteLayer@ belt = this.addSpriteLayer("belt", "SteamEngine.png", 32, 32);
	if (belt !is null)
	{
		//default anim
		{
	...
	CSpriteLayer@ wood = this.addSpriteLayer("wood", "FactoryAdvancedBergman.png", 16, 16);
	if (wood !is null)
	{
...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	{
		CButton@ button = caller.CreateGenericButton("$material_powder_crystal$", Vec2f(-4.0f, 0.0f), this, this.getCommandID("add fuel"), getTranslatedString("Add fuel"), params);
		if (button !is null)
		{
