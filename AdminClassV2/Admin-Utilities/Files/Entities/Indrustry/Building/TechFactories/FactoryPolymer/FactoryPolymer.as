...
const string fuel = "mat_stone";
const string ore = "mat_polymer";
const string rare_ore = "mat_polymer";

//balance
const int input = 200;					//input cost in fuel
...
void onInit(CSprite@ this)
{
	...
	CSpriteLayer@ wood = this.addSpriteLayer("wood", "FactoryShitcar.png", 16, 16);
	if (wood !is null)
	{
...
void onInit(CBlob@ this)
{
	...
	//commands
	this.addCommandID("add ressource");
}
...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	{
		CButton@ button = caller.CreateGenericButton("$mat_stone$", Vec2f(-4.0f, 0.0f), this, this.getCommandID("add resource"), getTranslatedString("Add resource"), params);
		if (button !is null)
		{
...
{
	if (cmd == this.getCommandID("add resource"))
	{
