...
const string fuel = "mat_steel";
const string ore = "stergun";
const string rare_ore = "stergun";
...
const int max_fuel = 250;
const int mid_fuel = 95;
const int low_fuel = 20;
...
void onInit(CSprite@ this)
{
	...
	CSpriteLayer@ wood = this.addSpriteLayer("wood", "FactorySter.png", 16, 16);
	if (wood !is null)
	{
...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	{
		CButton@ button = caller.CreateGenericButton("$mat_steel$", Vec2f(-4.0f, 0.0f), this, this.getCommandID("add fuel"), getTranslatedString("Add fuel"), params);
		if (button !is null)
		{
