...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Crystalplace", "$crystalplace$", "crystalplace", Descriptions::lantern, false);
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", CTFCosts::crystalplace_stone);
	}
	{
		ShopItem@ s = addShopItem(this, "Bluetorch", "$bluetorch$", "bluetorch", Descriptions::bucket, false);
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", CTFCosts::bluetorch_stone);
	}
	{
