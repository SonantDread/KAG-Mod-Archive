...
{
	AddIconToken("$builder_class_icon$", "GUI/jclass.png", Vec2f(16, 16), 0);
	AddIconToken("$knight_class_icon$", "GUI/jclass.png", Vec2f(16, 16), 1);
	AddIconToken("$archer_class_icon$", "GUI/jclass.png", Vec2f(16, 16), 2);
	AddIconToken("$priest_class_icon$", "GUI/jclass.png", Vec2f(16, 16), 3);
	AddIconToken("$Dragoon_class_icon$", "GUI/jclass.png", Vec2f(16, 16), 9);
	//AddIconToken("$Crossbow_class_icon$", "GUI/jclass.png", Vec2f(16, 16), 6);
	AddIconToken("$Assassin_class_icon$", "GUI/jclass.png", Vec2f(16, 16), 8);
	...
	addPlayerClass(this, "Priest", "$priest_class_icon$", "glkjsglksdjglksdjglsdjgzeoijfsdcjslkfgjsdigojo", "Mr. Magic Man.");
	addPlayerClass(this, "Dragoon", "$Dragoon_class_icon$", "sdkjfdsklfjklsdfj", "Fly Boy, Fly.");
	//addPlayerClass(this, "Crossbow", "$Crossbow_class_icon$", "jzeklghefjzelmifghezlfihzemazehldklhfjklhgjklhzcfjklshfkghklmhiolluh", "Shoot'em up.");
	addPlayerClass(this, "Assassin", "$Assassin_class_icon$", "efzjklejfklzejfvchjizerlgfhzeuklfhzkfhhjghjkghjkghjkgkjhgefzjklejfklzejfvchjizerlgfhzeuklfhzkfhhjghjkghjkghjkgkjhg", "Discretion and Efficiency are two words in the dictionary..");
