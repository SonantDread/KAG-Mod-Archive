...
void AddGameMusic(CBlob@ this, CMixer@ mixer)
{
	...
	mixer.AddTrack("Sounds/Music/ambient_cavern.ogg", world_ambient_underground);
	mixer.AddTrack("Sounds/Music/ambient_cavern_creatures1.ogg", world_ambient_underground);
	mixer.AddTrack("Sounds/Music/ambient_cavern_creatures2.ogg", world_ambient_underground);
	mixer.AddTrack("Sounds/Music/ambient_cavern_creatures3.ogg", world_ambient_underground);
	mixer.AddTrack("Sounds/Music/ambient_cavern_creatures4.ogg", world_ambient_underground);
	mixer.AddTrack("Sounds/Music/KAGWorldIntroShortA.ogg", world_intro);
	/*mixer.AddTrack("Mods/AdminClassV2/Admin-Utilities/Files/Entities/GUI/Pack/KAGWorld1-1a.ogg", world_home);
	mixer.AddTrack("Mods/AdminClassV2/Admin-Utilities/Files/Entities/GUI/Pack/KAGWorld1-2a.ogg", world_home);
	mixer.AddTrack("Mods/AdminClassV2/Admin-Utilities/Files/Entities/GUI/Pack/KAGWorld1-3a.ogg", world_home);*/
	...
	//mixer.AddTrack("Mods/AdminClassV2/Admin-Utilities/Files/Entities/GUI/Pack/KAGWorld1-11a.ogg", world_battle);
