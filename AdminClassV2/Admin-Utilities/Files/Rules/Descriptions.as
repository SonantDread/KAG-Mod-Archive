...
namespace Descriptions
{
	...
	tank					   = getTranslatedString("If you dream of driving while having an ally who can shoot, then this vehicle is for you."),
	car                        = getTranslatedString("Not customizable, but rolls relatively quickly to cross a map."),
	batterimram                = getTranslatedString("Formerly withdrawn from a design project, this all-terrain armored vehicle will delight you."),
	...
	chainsaw                   = getTranslatedString("A toothed chain that turns as fast as a circular saw. Set yourself the goal of deforesting an entire area for the good of the industry."),
	...
	uboot					   = getTranslatedString("Unterseeboot is an imposing submarine. If you destroy it, think about the tons of fuel that will pollute the water."),
	caravel					   = getTranslatedString("An imposing vessel of the seas, can carry 3 shooters and a canon (The canon is not included in the offer)"),
	tunnel                     = getTranslatedString("A tunnel for quick transportation."),
	
	bomber              	  = getTranslatedString("Fly through the sky with the power of hot air."),
	basecraft                 = getTranslatedString("Thanks to this hot air balloon you will no longer suffer from a sedentary lifestyle! Build your base before opening the box."),
	airship                   = getTranslatedString("Formerly a boat it was reworked to be able to fly."),
	glider                    = getTranslatedString("The fastest of flying vehicles. Its only flaw is that there is none."),
	zeppelin				  = getTranslatedString("Three seats, a ball as big as a car and two weapons on board. What more can be said ?"),
	...
	aircraftshop               = getTranslatedString("If you hate ground this so this shop is for you"),
	...
	crystalshop          	   = getTranslatedString("An specific workshop to make specific objet"),
	mushroom_block             = getTranslatedString("Jump on it !"),
	electricsponge             = getTranslatedString("Dry water around you. Need power to work"),
	crystalplace          	   = getTranslatedString("	An strange crystal that emits blue light"),
