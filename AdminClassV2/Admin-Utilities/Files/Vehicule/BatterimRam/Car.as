...
{		
	Vehicle_Setup( this,
				   300.0f, // move speed default is 30.0 (1500)
				   0.31f,  // turn speed default is 0.31 (5)
	...
	this.set_f32("map dmg modifier", 0.01f); // Damage default 2.0
...
{
	const f32 threshold = this.getInitialHealth() * 0.25f;	// Initial Healt 0.25
