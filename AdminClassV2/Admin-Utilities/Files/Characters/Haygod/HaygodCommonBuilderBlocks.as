...
AddIconToken("$stone$", "World.png", Vec2f(8, 8), CMap::tile_thickstone);
AddIconToken("$ground_back$", "World.png", Vec2f(8, 8), CMap::tile_ground_back);
AddIconToken("$dirt_block$", "World.png", Vec2f(8, 8), CMap::tile_ground);
AddIconToken("$grass_block$", "World.png", Vec2f(8, 8), CMap::tile_grass + map_random.NextRanged(3));
	...
	}
{
	...
	}
	{
		...
		AddRequirement(b.reqs, "blob", "mat_steel", "Steel",  0);
		blocks[0].push_back(b);
	}
	{
	...
	{
		BuildBlock b(CMap::tile_mossy_wood, "mossy_wood", "$mossy_wood$", "Mossy Wood Block\nMossy Wood Block");
		AddRequirement(b.reqs, "blob", "mat_wood", "Wood",  0);
		blocks[0].push_back(b);
	}
	{
	...
	{
		BuildBlock b(0, "Only_For_Admin_So_Stop_Search_In_File_Like_An_Geek", "$Only_For_Admin_So_Stop_Search_In_File_Like_An_Geek$", "Admin Block\nUndestructible");
		AddRequirement(b.reqs, "blob", "mat_wood", "Wood",  0);
		blocks[0].push_back(b);
	}
	{
	...
	{
		AddIconToken("$sandewel$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_sandewel);
		BuildBlock b( CMap::tile_sandewel, "sandewel", "$sandewel$", "Custom sand" );
		AddRequirement( b.reqs, "blob", "mat_stone", "Stone", 0 );
		blocks[0].push_back( b );
	}
	...
	else if (SBX)
	{
		...
		{
			BuildBlock b(0, "undeadbuilding", "$building$", "Undead Workshop\nStand in an open space\nand tap this button.");
			AddRequirement(b.reqs, "blob", "mat_stone", "Stone", 50);
			b.buildOnGround = true;
			b.size.Set(40, 24);
			blocks[1].push_back(b);
		...
		{
			BuildBlock b(0, "techmain", "$techmain$", "Technologie Shop\nDon't be afraid is just an NORMAL shop.");
			AddRequirement(b.reqs, "blob", "mat_stone", "Stone", 500);
			//AddRequirement(b.reqs, "blob", "blackpage", "Corrupted Crystal", 15);
		...
		{
			BuildBlock b(0, "castle_obstructor", "$castle_obstructor$", "Stone Obstructor");
			AddRequirement(b.reqs, "blob", "mat_stone", "Stone", 0);
			AddRequirement(b.reqs, "blob", "mat_gold", "Gold", 0);
			AddRequirement(b.reqs, "blob", "whitepage", "Crystal Shard", 1);
			blocks[2].push_back(b);
		}
		{
		...
		{
			BuildBlock b(CMap::tile_ground, "dirt_block", "$dirt_block$", "Ground\nGround");
			AddRequirement(b.reqs, "blob", "mat_stone", "Stone",  0);
			blocks[3].push_back(b);
		}
		{
			BuildBlock b(CMap::tile_ground_back, "ground_back", "$ground_back$", "Ground Back\nGround back");
			AddRequirement(b.reqs, "blob", "mat_stone", "Stone",  0);
			blocks[3].push_back(b);
		}
		{
			BuildBlock b(CMap::tile_stone, "stone", "$stone$", "stone\nstone");
			AddRequirement(b.reqs, "blob", "mat_stone", "Stone",  0);
			blocks[3].push_back(b);
		}
		{
			BuildBlock b(CMap::tile_thickstone, "tile_thickstone", "$tile_thickstone$", 	"tile_thickstone\ntile_thickstone");
			AddRequirement(b.reqs, "blob", "mat_stone", "Stone",  0);
			blocks[3].push_back(b);
		}
		{
			BuildBlock b(CMap::tile_gold, "tile_gold", "$tile_gold$", "tile_gold\ntile_gold");
			AddRequirement(b.reqs, "blob", "mat_stone", "Stone",  0);
			blocks[3].push_back(b);
		}
		{
			...
			{
			BuildBlock b(CMap::tile_grass + map_random.NextRanged(3), "grass_block", "$grass_block$", "Grass\nEcology");
			AddRequirement(b.reqs, "blob", "mat_stone", "Stone",  0);
			blocks[3].push_back(b);
		}
		{
