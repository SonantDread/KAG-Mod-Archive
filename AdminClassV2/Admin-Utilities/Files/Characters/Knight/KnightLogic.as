...
void onInit(CBlob@ this)
{
	...
	this.push("names to activate", "orcbomb");
	this.push("names to activate", "oct");
...
{
	moveVars.jumpFactor *= 0.5f; //default is 0.5f
	moveVars.walkFactor *= 1.2f; //default is 0.9f
}
...
class NormalState : KnightState
{
	...
	bool TickState(CBlob@ this, KnightInfo@ knight, RunnerMoveVars@ moveVars)
	{
		...
		{
			print("I need help I dont want to sleep all night help - Shulky");
