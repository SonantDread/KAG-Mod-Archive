			...
			if (taunttimer == 0)
			{
				...
				if (blob.getSexNum() == 0) //male
				{
					switch (XORRandom(3))
					{
						...
						case 2: this.PlaySound("snes_coin.ogg"); break;
					}				
				}
				else // female
				{
					this.PlaySound("Kiss.ogg");
					CParticle@ Heart = ParticleAnimated("HeartParticle.png", pos+Vec2f(0, -5), getRandomVelocity(headangle, -2*facedir , 10), 0, 1, 3, -0.03, true);
