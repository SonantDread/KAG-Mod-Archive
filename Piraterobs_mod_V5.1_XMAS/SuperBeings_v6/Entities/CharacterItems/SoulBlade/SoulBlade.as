...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	CButton@ button = caller.CreateGenericButton(11, Vec2f_zero, this, this.getCommandID("usesword"), "Succumb to the blades call...", params);
...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("usesword"))
	{
		...
		if (caller !is null)
		{
            CBlob @newBlob = server_CreateBlob("darkknight", 9, this.getPosition());
			if (newBlob !is null)
			{
				this.getSprite().PlaySound("/SuddenGib", 1.4f, 0.70f); // TFlippy
