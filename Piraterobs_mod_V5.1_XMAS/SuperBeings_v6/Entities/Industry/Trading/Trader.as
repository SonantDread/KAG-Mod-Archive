...
//blacklist any players that hit us!
...
//		if (player !is null)
//		{
//			getWantedList().addPlayer(player);
//		}
//	}
//	return damage;
//}
...
//{
//	if (this.hasTag("shoot wanted"))
//	{
//		if (getGameTime() - this.get_u32("target time") == 10)
//		{
//			CBlob@ b = this.getBrain().getTarget();
//			if (b !is null && !b.hasTag("dead"))
//			{
//				Vec2f bpos = b.getPosition();
//				
//				CMap@ map = this.getMap();
//				if (!map.rayCastSolid(this.getPosition(), bpos))
//				{
//					this.getSprite().PlaySound("TraderCannon.ogg");
//					this.server_Hit( b, bpos, Vec2f(), 10.0f, Hitters::explosion, true);
//				}
//			}
//		}
//	}
