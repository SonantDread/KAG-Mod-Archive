...
void onInit(CBlob@ this)
{
	...
	{
		// Name, Icon, blob
		ShopItem@ s = addShopItem(this, "Shotgun Shop", "$shotgunshop$", "shotgunshop", "Build this, for the ability to purchase shotguns!");
		AddRequirement(s.requirements, "coin", "", "Coins", 150); // 0 for test purposes.
	}
}
