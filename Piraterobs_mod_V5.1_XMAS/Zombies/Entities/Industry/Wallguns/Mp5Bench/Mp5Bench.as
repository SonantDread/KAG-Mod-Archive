...
void InitWorkshop( CBlob@ this )
{
	...
	{	 
		ShopItem@ s = addShopItem( this, "Lantern", "$lantern$", "lantern", "Buy a lantern for a dollar!", false );
		AddRequirement( s.requirements, "coin", "", "Coins", cost_lantern );
	}
		{
			ShopItem@ s = addShopItem(this, "Mp5", "$Mp5$", "Mp5", "The Mp5, a rapid fire Sub Machine gun, old faithful in Call Of Duty and generally an all round solid gun.", true);
