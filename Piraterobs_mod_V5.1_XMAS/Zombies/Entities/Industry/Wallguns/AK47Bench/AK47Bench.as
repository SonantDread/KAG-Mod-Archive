...
void InitWorkshop( CBlob@ this )
{
	...
	{	 
		...
		{
			ShopItem@ s = addShopItem(this, "ak47", "$ak47$", "ak47", "An AK47! AK47 for EVERYBODY!!!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_mysterybox);
		}
}
