...
void InitWorkshop( CBlob@ this )
{
	...
	{	 
		...
		{
			ShopItem@ s = addShopItem(this, "coltcobra", "$coltcobra$", "coltcobra", "6 Shot Revolver", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_cobra);
		}
		
		{
			ShopItem@ s = addShopItem(this, "coltanaconda", "$coltanaconda$", "coltanaconda", "6 Shot Revolver", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_anaconda);
		}
		
		{
			ShopItem@ s = addShopItem(this, "charterarmsbulldog", "$charterarmsbulldog$", "charterarmsbulldog", "6 Shot Revolver", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_bulldog);
		}
		
		{
			ShopItem@ s = addShopItem(this, "britishbulldogrevolver", "$britishbulldogrevolver$", "britishbulldogrevolver", "6 Shot Revolver", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_britishbulldog);
		}
		
		{
			ShopItem@ s = addShopItem(this, "glock18", "$glock18$", "glock18", "20 shot, rapid firing pistol yo! Get yo gangsta lean on.", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_glock18);
		}
		
		{
			ShopItem@ s = addShopItem(this, "enfieldno2", "$enfieldno2$", "enfieldno2", "6 Shot Revolver", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_enfieldno2);
		}
		
		{
			ShopItem@ s = addShopItem(this, "uspsilenced", "$uspsilenced$", "uspsilenced", "uspsilenced", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_usp);
		}
		
		{
			ShopItem@ s = addShopItem(this, "ragingbull", "$ragingbull$", "ragingbull", "ragingbull", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_ragingbull);
		}
		
		{
			ShopItem@ s = addShopItem(this, "fiveseven", "$fiveseven$", "fiveseven", "fiveseven", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_fiveseven);
		}
		
		{
			ShopItem@ s = addShopItem(this, "goldengun", "$goldengun$", "goldengun", "goldengun", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_goldengun);
		}
		
		{
			ShopItem@ s = addShopItem(this, "ak47", "$ak47$", "ak47", "ak47 for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_ak47);
		}
		
		{
			ShopItem@ s = addShopItem(this, "m16", "$m16$", "m16", "m16 for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_m16);
		}
		
		{
			ShopItem@ s = addShopItem(this, "chicom", "$chicom$", "chicom", "chicom for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_chicom);
		}
		
		{
			ShopItem@ s = addShopItem(this, "mp5", "$mp5$", "mp5", "mp5 for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_mp5);
		}
		
		{
			ShopItem@ s = addShopItem(this, "deagle", "$deagle$", "deagle", "deagle for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_deagle);
		}
		
		{
			ShopItem@ s = addShopItem(this, "cz75auto", "$cz75auto$", "cz75auto", "cz75auto for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_cz);
		}
		
		{
			ShopItem@ s = addShopItem(this, "colt1911", "$colt1911$", "colt1911", "colt1911 for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_colt1911);
		}
		
		{
			ShopItem@ s = addShopItem(this, "m1", "$m1$", "m1", "m1 for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_m1);
		}
		
		{
			ShopItem@ s = addShopItem(this, "gl", "$gl$", "gl", "gl for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_gl);
		}
		
		{
			ShopItem@ s = addShopItem(this, "rpg", "$rpg$", "rpg", "rpg for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_rpg);
		}
		
		{
			ShopItem@ s = addShopItem(this, "m79", "$m79$", "m79", "m79 for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_m79);
		}
		
		{
			ShopItem@ s = addShopItem(this, "plasma", "$plasma$", "plasma", "plasma for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_plasma);
		}
		
		{
			ShopItem@ s = addShopItem(this, "sawnoffshotgun", "$sawnoffshotgun$", "sawnoffshotgun", "sawnoffshotgun for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_sawnoffshotgun);
		}
		
		{
			ShopItem@ s = addShopItem(this, "ithaca37", "$ithaca37$", "ithaca37", "ithaca37 for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_itachishotgun);
		}
		
		{
			ShopItem@ s = addShopItem(this, "aa12", "$aa12$", "aa12", "aa12 for everyone!", true);
			AddRequirement(s.requirements, "coin", "", "Coins", cost_AA12);
		}
		
		{
			ShopItem@ s = addShopItem(this, "sniper", "$sniper$", "sniper", "sniper for everyone!", true);
