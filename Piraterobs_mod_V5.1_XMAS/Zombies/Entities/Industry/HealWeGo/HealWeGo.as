...
{
	CSpriteLayer@ bed = this.addSpriteLayer("bed", "HealWeGo.png", 32, 16);
	if (bed !is null)
	{
		{
	...
	CSpriteLayer@ zzz = this.addSpriteLayer("zzz", "HealWeGo.png", 8, 8);
	if (zzz !is null)
	{
		{
	...
	CSpriteLayer@ backpack = this.addSpriteLayer("backpack", "HealWeGo.png", 16, 16);
	if (backpack !is null)
	{
		{
...
void onInit(CBlob@ this)
{
	...
	// ICONS
	AddIconToken("$quarters_beer$", "HealWeGo.png", Vec2f(24, 24), 7);
	AddIconToken("$quarters_meal$", "HealWeGo.png", Vec2f(48, 24), 2);
	AddIconToken("$quarters_egg$", "HealWeGo.png", Vec2f(24, 24), 8);
	AddIconToken("$quarters_burger$", "HealWeGo.png", Vec2f(24, 24), 9);
