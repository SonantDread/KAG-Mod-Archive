...
void LoadDefaultGUI()
{
	if (v_driver > 0)
	{
		...
		AddIconToken("$mat_molotov$", "../Mods/"+modname+"/Base/Entities/Items/Molotov/Molotov.png", Vec2f(16, 16), 0);
		AddIconToken("$srune$", "../Mods/"+modname+"/Base/Entities/Items/Runes/Runes.png", Vec2f(8, 8), 0);
		AddIconToken("$irune$", "../Mods/"+modname+"/Base/Entities/Items/Runes/Runes.png", Vec2f(8, 8), 1);
		...
		AddIconToken("$tunnel$", "WarTunnel.png", Vec2f(24, 24), 0);
		AddIconToken("$tile_goldblock$", "Sprites/World.png", Vec2f(8, 8), 272);
