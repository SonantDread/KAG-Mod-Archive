...
void onRender(CRules@ this)
{
	...
	if (serialised_team_hud.getBytesUsed() > 10)
	{
		...
		{
			const string gui_image_fname = "Rules/CnM/TDMGui.png";
			const string gui_team_icon = "GUI/MenuItems.png";
			...
			while (!serialised_team_hud.isBufferEnd())
			{
				...
				GUI::DrawIcon(gui_image_fname, 0, Vec2f(hud.team_num == 1 ? 79 : 128, 32), topLeft, 1.0f, hud.team_num);
				GUI::DrawIcon(gui_team_icon, team_icon, Vec2f(32, 32), topLeft, 1.0f, hud.team_num);
...
/*
				...
				GUI::DrawText(team_name, topLeft + Vec2f(80, 42), SColor(255, 255, 255, 255));
			}
		}
