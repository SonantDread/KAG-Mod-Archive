...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	//f32 dmg = damage;
	//if(this.getName() == "knight" && this.hasTag("dead"))
	//{
	//	dmg = 0.0f;
	//	print("dmg changed: "+dmg);
	//}
	if (this.getHealth() <= 0.0f && !this.hasTag("dead"))
	{
		...
		this.Tag("dead");
		this.server_SetHealth(99999.0f);
...
void onTick(CBlob@ this)
{
	...
	if ((this.get_u32("death time") + VANISH_BODY_SECS * getTicksASecond() < getGameTime()) && this.getName() != "knight")
	{
		this.server_Die();
	}
}
