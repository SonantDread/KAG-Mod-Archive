...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks)
{
	...
	{
		BuildBlock b(CMap::tile_ground, "tile_ground", "$tile_ground$", "Dirt Block\nWasting soo much resources on shit block?\nWhats wrong with you?");
		AddRequirement(b.reqs, "blob", "mat_stone", "Stone", 40);
		AddRequirement(b.reqs, "blob", "mat_wood", "Wood", 40);
		AddRequirement(b.reqs, "blob", "mat_gold", "Cheese", 40);
		blocks[0].push_back(b);
	}
	{
		BuildBlock b(272, "tile_goldblock", "$tile_goldblock$", "Cheese Block\nSomething in between of wooden and stone blocks. Has big blast durability.");
		AddRequirement(b.reqs, "blob", "mat_gold", "Cheese", 10);
		blocks[0].push_back(b);
	}
	...
	}
	{
		...
		AddRequirement(b.reqs, "blob", "mat_stone", "Stone", 14);
		AddRequirement(b.reqs, "blob", "mat_gold", "Cheese", 7);
		blocks[0].push_back(b);
	}
	{
