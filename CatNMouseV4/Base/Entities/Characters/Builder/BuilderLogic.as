...
void onInit(CBlob@ this)
{
	...
	this.addCommandID("activate bomb");
...
void onTick(CBlob@ this)
{
	...
	if(ismyplayer)
	{
		...
		if (c.isKeyJustPressed(160))
		{
			...
			//	return;
			//}
			bool holding = carried !is null && !carried.hasTag("temp blob");// && carried.hasTag("exploding");
