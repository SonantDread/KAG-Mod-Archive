...
{
	if (XORRandom(3) == 0) {
		makeSmokeParticle(this.getPosition()+Vec2f(-16,-25), -0.05f);
		makeSmokeParticle(this.getPosition()+Vec2f(16,-25), -0.05f);

		this.getSprite().SetEmitSoundPaused(false);
	} else {
		makeFireParticle(this.getPosition()+Vec2f(-16,-25) + getRandomVelocity(90.0f, 3.0f, 360.0f));
		makeFireParticle(this.getPosition()+Vec2f(16,-25) + getRandomVelocity(90.0f, 3.0f, 360.0f));
	}
}
