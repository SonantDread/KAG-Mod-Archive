...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Zeppelin", "$warboat$", "zeppelin", "Zeppelin", false, true);
		AddRequirement(s.requirements, "coin", "", "Coins", cost_zeppelin);
		s.crate_icon = 2;
	}
}
