...
void onInit( CBlob@ this )
{
	...
	}
	{
		...
		addFoodItem( this, "Cake", 5, "A cake made of a builder corpse.", 30, 1, @requirements );
	}
	{
		CBitStream requirements;
		AddRequirement( requirements, "blob", "grain", "Grain", 1 );
	...
	//SetHelp( this, "help use", "builder", "Use kitchen to make food. Food restores health.\n\nPut in ingredients if you have them. \n\n         $KEY_E$", "Builder can make food to restore health here." ); 
