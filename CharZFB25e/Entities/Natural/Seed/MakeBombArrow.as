	...
	const string &in  description, u16 timeToMakeSecs, const u16 quantityLimit, CBitStream@ requirements = null )
{
	...
	ShopItem@ item = addProductionItem( this, seedName, newIcon, "mat_bombarrows", description, timeToMakeSecs, false, quantityLimit, requirements );
	return item;
}
