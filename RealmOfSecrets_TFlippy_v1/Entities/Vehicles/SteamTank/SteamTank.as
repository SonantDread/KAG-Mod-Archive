...
void onInit(CBlob@ this)
{
	...
	Vehicle_SetupWeapon(this, v,
	                    ...
	                    "mat_ironingot", // bullet ammo config name
	...
	this.set_f32("map dmg modifier", 4.0f);
	...
	this.set_string("autograb blob", "mat_ironingot");

	// auto-load on creation
	if (getNet().isServer())
	{
		CBlob@ ammo = server_CreateBlob("mat_ironingot");
		if (ammo !is null)
		{
...
void Vehicle_onFire(CBlob@ this, VehicleInfo@ v, CBlob@ bullet, const u8 _unused)
{
	if (bullet !is null)
	{
		...
		bullet.server_SetTimeToDie(10.0f);
	}
}
