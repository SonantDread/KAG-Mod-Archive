...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$powerfactoricon$", "PowerFactor.png", Vec2f(16, 16), 0);
	...
	{
		ShopItem@ s = addShopItem(this, "PowerFactor", "$powerfactoricon$", "powerfactor", "I'll shpin th'sh inta a pow'rful art'fact.", true);
		AddRequirement(s.requirements, "blob", "caged_wisp", "Caged Wisp", 1);
