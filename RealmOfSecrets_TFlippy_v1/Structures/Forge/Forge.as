...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Copper Ingot", "$mat_copperingot$", "mat_copperingot-1", "A soft conductive metal.", true);
		AddRequirement(s.requirements, "blob", "mat_copper", "Copper Ore", 10);
		s.spawnNothing = true;
	}
	
	{
		ShopItem@ s = addShopItem(this, "Iron Ingot", "$mat_ironingot$", "mat_ironingot-1", "A fairly strong metal used to make tools, equipment and such.", true);
		AddRequirement(s.requirements, "blob", "mat_iron", "Iron Ore", 10);
		s.spawnNothing = true;
	}
	
	{
		ShopItem@ s = addShopItem(this, "Steel Ingot", "$mat_steelingot$", "mat_steelingot-4", "Much stronger than iron, but also more expensive.", true);
	...
	{
		ShopItem@ s = addShopItem(this, "Gold Ingot", "$mat_goldingot$", "mat_goldingot-4", "A fancy metal - traders' favourite.", true);
