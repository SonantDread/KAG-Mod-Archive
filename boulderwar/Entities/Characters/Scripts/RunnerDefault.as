...
void onTick(CBlob@ this)
{
	...
	if(this.isKeyPressed(key_action3)) this.server_DetachFromAll();
...
bool canBePickedUp(CBlob@ this, CBlob@ byBlob)
{
	...
	bool left_right = this.isKeyPressed(key_action1) && this.isKeyPressed(key_action2);
	return left_right || this.hasTag("dead");
}
