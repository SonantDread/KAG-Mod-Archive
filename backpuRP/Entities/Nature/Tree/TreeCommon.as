...
bool CollapseToGround(CBlob@ this, f32 angle)
{
	...
	string fileName = "TreeFallSmall"+(XORRandom(3)+1);
	CParticle@ particleDrop = ParticleAnimated(fileName+".png", Vec2f(this.getPosition().x,this.getPosition().y+this.getHeight()), Vec2f(0,0), 1.0f, 1.0f, 1,0.0f, true);
	if(particleDrop !is null)
	{
		particleDrop.Z = 10;
	}
