...
void Pickaxe(CBlob@ this)
{
    ...
    // bool strikeAnim = (sprite.isAnimation("strike") || sprite.isAnimation("strike_fast"));
    ...
    int the_hit_frame = hit_frame;
    // int the_hit_frame = (!getRules().isWarmup()) ? hit_frame : (hit_frame-1);
    bool justCheck = !sprite.isFrameIndex(the_hit_frame);
    bool adjusttime = sprite.getFrameIndex() < the_hit_frame - 1;
    ...
    f32 pickaxe_distance = this.get_f32("pickaxe_distance");
    if (getRules().isWarmup()) { pickaxe_distance *= 2.f; }
