...
void onInit(CBlob@ this)
{
  ...
  {
		ShopItem@ s = addShopItem(this, "Fireplace", "$fireplace$", "fireplace", "An expanse of light", false);
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 50);
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 100);
	}
  {
		ShopItem@ s = addShopItem(this, "Mounted Bow", "$mounted_bow$", "mounted_bow", "A turret of sorts", false);
