...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	{
		if(this.hasTag("minebody"))
		{
			if (getNet().isServer())
			{
				for(int i = 0; i < 4; i++)
				{
					CBlob@ mine = server_CreateBlob('mine',this.getTeamNum(),this.getPosition());
					if(mine !is null)
					{
						mine.setVelocity(Vec2f(XORRandom(20) + XORRandom(-20), XORRandom(20) + XORRandom(-20)));
					}
				}
			}
		}
