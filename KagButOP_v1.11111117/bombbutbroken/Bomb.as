...
void onTick(CSprite@ this)
{
	...
	const u8 hitter = blob.get_u8("custom_hitter");
...
void onCollision(CBlob@ this, CBlob@ blob, bool solid)
{
	...
	Vec2f bombVelocity = this.getOldVelocity();
	...
	if (!isExplosionHitter(hitter) && !this.isAttached())
	{
		...
		if (!this.hasTag("_hit_water") && blob !is null) //smack that mofo
		{
			...
			blob.setVelocity(Vec2f(bombVelocity.x * 4, bombVelocity.y * 4));
		}
	}
}
