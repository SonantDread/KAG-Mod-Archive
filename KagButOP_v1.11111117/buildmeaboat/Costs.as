...
void InitCosts()
{
	...
	//ArcherShop.as
	CTFCosts::arrows =                      ReadCost(cfg, "cost_arrows"             , 5);
	CTFCosts::waterarrows =                 ReadCost(cfg, "cost_waterarrows"        , 15);
	CTFCosts::firearrows =                  ReadCost(cfg, "cost_firearrows"         , 25);
	CTFCosts::bombarrows =                  ReadCost(cfg, "cost_bombarrows"         , 35);

	//KnightShop.as
	CTFCosts::bomb =                        ReadCost(cfg, "cost_bomb"               , 15);
	CTFCosts::waterbomb =                   ReadCost(cfg, "cost_waterbomb"          , 25);
	CTFCosts::mine =                        ReadCost(cfg, "cost_mine"               , 30);
	...
	CTFCosts::trampoline_wood =             ReadCost(cfg, "cost_trampoline_wood"    , 50);
	CTFCosts::saw_wood =                    ReadCost(cfg, "cost_saw_wood"           , 50);
	CTFCosts::saw_stone =                   ReadCost(cfg, "cost_saw_stone"          , 50);
	CTFCosts::drill_stone =                 ReadCost(cfg, "cost_drill_stone"        , 50);
	CTFCosts::drill =                       ReadCost(cfg, "cost_drill"              , 25);

	//BoatShop.as
	CTFCosts::dinghy =                      ReadCost(cfg, "cost_dinghy"             , 25);
	CTFCosts::dinghy_wood =                 ReadCost(cfg, "cost_dinghy_wood"        , 50);
	CTFCosts::longboat =                    ReadCost(cfg, "cost_longboat"           , 50);
	CTFCosts::longboat_wood =               ReadCost(cfg, "cost_longboat_wood"      , 50);
	CTFCosts::warboat =                     ReadCost(cfg, "cost_warboat"            , 50);

	//VehicleShop.as
	CTFCosts::catapult =                    ReadCost(cfg, "cost_catapult"                   , 100);
