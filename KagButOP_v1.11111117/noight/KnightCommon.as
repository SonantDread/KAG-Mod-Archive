...
{
	const ::s32 resheath_time = 0;

	const ::s32 slash_charge = 15;
	const ::s32 slash_charge_level2 = 25;
	const ::s32 slash_charge_limit = slash_charge_level2 + slash_charge + 1000;
	const ::s32 slash_move_time = 4;
	const ::s32 slash_time = 13;
	const ::s32 double_slash_time = 50;

	const ::f32 slash_move_max_speed = 5.5f;

	const u32 glide_down_time = 400;
}
...
const f32 DEFAULT_ATTACK_DISTANCE = 10.0f;
const f32 MAX_ATTACK_DISTANCE = 20.0f;
const f32 SHIELD_KNOCK_VELOCITY = 800.0f;
