...
void onInit(CMovement@ this)
{
	...
	//walking vars
	moveVars.walkSpeed = 2.6f*0.75f*1.4f;
	moveVars.walkSpeedInAir = 2.5f*0.75f*1.225f;
	moveVars.walkFactor = 0.75f;
	moveVars.walkLadderSpeed.Set(0.15f, 0.6f);
	//jumping vars
	moveVars.jumpMaxVel = 2.9f * 1.1f;
	moveVars.jumpStart = 1.0f * 1.1f;
	moveVars.jumpMid = 0.55f * 1.1f;
	moveVars.jumpEnd = 0.4f * 1.1f;
