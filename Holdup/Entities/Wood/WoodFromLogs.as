...
void onHitBlob(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitBlob, u8 customData)
{
	...
	if (damage > 0.0f && customData == Hitters::saw)
	{
		...
		if (wood > 0)
		{
			MakeMat(this, worldPoint, "mat_wood", wood*damage);
		}
		if (stone > 0)
		{
			MakeMat(this, worldPoint, "mat_stone", stone*damage);
		}
	}
}
