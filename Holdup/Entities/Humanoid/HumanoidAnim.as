...
void onInit(CSprite@ this)
{
	...
	//Sticks
	{
		...
		CSpriteLayer@ layer = this.addSpriteLayer("main_pole", "character_stick.png" , 29, 8, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
		if (layer!is null)
		{
	...
	}
	{
		...
		CSpriteLayer@ layer = this.addSpriteLayer("sub_pole", "character_stick.png" , 29, 8, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
		if (layer!is null)
		{
			Animation@ anim = layer.addAnimation("default", 0, false);
			anim.AddFrame(0);
	...
	
	{
		...
		CSpriteLayer@ layer = this.addSpriteLayer("mainpick", "character_pick.png" , 32, 32, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
		if (layer!is null)
		{
			Animation@ anim = layer.addAnimation("default", 0, false);
			anim.AddFrame(0);
	...
	
	{
		...
		CSpriteLayer@ layer = this.addSpriteLayer("subpick", "character_pick.png" , 32, 32, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
		if (layer!is null)
		{
			Animation@ anim = layer.addAnimation("default", 0, false);
			anim.AddFrame(0);
	...
	
	{
		...
		CSpriteLayer@ layer = this.addSpriteLayer("mainaxe", "character_axe.png" , 32, 32, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
		if (layer!is null)
		{
			Animation@ anim = layer.addAnimation("default", 0, false);
			anim.AddFrame(0);
	...
	
	{
		...
		CSpriteLayer@ layer = this.addSpriteLayer("subaxe", "character_axe.png" , 32, 32, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
		if (layer!is null)
		{
			Animation@ anim = layer.addAnimation("default", 0, false);
			anim.AddFrame(0);
	...
	{
		this.RemoveSpriteLayer("main_stab");
		CSpriteLayer@ layer = this.addSpriteLayer("main_stab", "character_crude_knife.png" , 24, 16, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
		if (layer!is null)
		{
			Animation@ anim = layer.addAnimation("default", 0, false);
			anim.AddFrame(0);
	...
	{
		this.RemoveSpriteLayer("sub_stab");
		CSpriteLayer@ layer = this.addSpriteLayer("sub_stab", "character_crude_knife.png" , 24, 16, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
		if (layer!is null)
		{
			Animation@ anim = layer.addAnimation("default", 0, false);
			anim.AddFrame(0);
	...
	{
		this.RemoveSpriteLayer("mainsword");
		CSpriteLayer@ layer = this.addSpriteLayer("mainsword", "character_metal_sword.png" , 32, 32, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
		if (layer!is null)
		{
			Animation@ anim = layer.addAnimation("default", 0, false);
			anim.AddFrame(0);
	...
	{
		this.RemoveSpriteLayer("subsword");
		CSpriteLayer@ layer = this.addSpriteLayer("subsword", "character_metal_sword.png" , 32, 32, this.getBlob().getTeamNum(), this.getBlob().getSkinNum());
		if (layer!is null)
		{
			Animation@ anim = layer.addAnimation("default", 0, false);
			anim.AddFrame(0);
...
void onTick(CSprite@ this)
{
	...
	if(this.getSpriteLayer("back") !is null)this.getSpriteLayer("back").SetVisible(Visible);
	
	if(this.getSpriteLayer("head") !is null)
	if(Bed){
		this.getSpriteLayer("head").SetVisible(true);
	} else {
		this.getSpriteLayer("head").SetVisible(Visible);
	}
	...
	bool mainstab = blob.hasTag("main_stabing");
	bool substab = blob.hasTag("sub_stabing");
	
	bool mainsword = blob.hasTag("main_slashing");
	bool subsword = blob.hasTag("sub_slashing");
	bool mainswordstabbing = !blob.hasTag("main_slash_mode");
	bool subswordstabbing = !blob.hasTag("sub_slash_mode");
	...
	this.getSpriteLayer("frontleg").SetVisible((!(blob.get_s8("front_leg_type") < 0)) && Visible);
	this.getSpriteLayer("backleg").SetVisible((!(blob.get_s8("back_leg_type") < 0)) && Visible);
	...
	if(canUseArms){
		...
		if(mainsword){
			if(!mainswordstabbing){
				f32 draw_back = main_drawback;
				...
				setAimValues(this,this.getSpriteLayer("mainsword"), true, angle-70*inverse+draw_back*inverse*10, Vec2f(0, 0), "default");
				this.getSpriteLayer("mainsword").SetOffset(MainArmOffset);
			}
		} else setAimValues(this,this.getSpriteLayer("mainsword"), false, 0, Vec2f(0, 0), "default");
		
		if(subsword){
			if(!subswordstabbing){
				f32 draw_back = sub_drawback;
				if(draw_back > 15)draw_back = 15+(draw_back-15)*0.2f;
				setAimValues(this,this.getSpriteLayer("backarm"), subarmvisible, angle-70*inverse+draw_back*inverse*10, Vec2f(0, 0), "stretch");
				setAimValues(this,this.getSpriteLayer("subsword"), true, angle-70*inverse+draw_back*inverse*10, Vec2f(0, 0), "default");
				this.getSpriteLayer("subsword").SetOffset(SubArmOffset);
			}
		} else setAimValues(this,this.getSpriteLayer("subsword"), false, 0, Vec2f(0, 0), "default");
		
		if(mainaxe){
			setAimValues(this,this.getSpriteLayer("frontarm"), mainarmvisible, angle-70*inverse+main_drawback*inverse*10, Vec2f(0, 0), "stretch");
			setAimValues(this,this.getSpriteLayer("mainaxe"), true, angle-70*inverse+main_drawback*inverse*10, Vec2f(0, 0), "default");
		...
		if(subaxe){
			setAimValues(this,this.getSpriteLayer("backarm"), subarmvisible, angle-70*inverse+sub_drawback*inverse*10, Vec2f(0, 0), "stretch");
			setAimValues(this,this.getSpriteLayer("subaxe"), true, angle-70*inverse+sub_drawback*inverse*10, Vec2f(0, 0), "default");
		...
		if(mainpickaxing){
			setAimValues(this,this.getSpriteLayer("frontarm"), mainarmvisible, angle-70.0f*inverse+main_drawback*inverse*5.0f, Vec2f(0, 0), "stretch");
			setAimValues(this,this.getSpriteLayer("mainpick"), true, angle-70.0f*inverse+main_drawback*inverse*5.0f, Vec2f(0, 0), "default");
		...
		if(subpickaxing){
			setAimValues(this,this.getSpriteLayer("backarm"), subarmvisible, angle-70.0f*inverse+sub_drawback*inverse*5.0f, Vec2f(0, 0), "stretch");
			setAimValues(this,this.getSpriteLayer("subpick"), true, angle-70.0f*inverse+sub_drawback*inverse*5.0f, Vec2f(0, 0), "default");
		...
		if(mainfist){
			if(main_drawback < 0)setAimValues(this,this.getSpriteLayer("frontarm"), mainarmvisible, angle, Vec2f(0, 0), "punch");
		...
		if(subfist){
			if(sub_drawback < 0)setAimValues(this,this.getSpriteLayer("backarm"), subarmvisible, angle, Vec2f(0, 0), "punch");
		...
		if(mainpole){
			...
			this.getSpriteLayer("main_pole").SetOffset(MainArmOffset+Vec2f(0,5.5f)+Vec2f(Maths::Cos(RadAngle)*main_drawback*-0.2*test,Maths::Sin(RadAngle)*main_drawback*-0.2));

			setAimValues(this,this.getSpriteLayer("main_pole"), true, angle, Vec2f(0, 0), "default");
			
			setAimValues(this,this.getSpriteLayer("frontarm"), mainarmvisible, Down-main_drawback*test, Vec2f(0, 0), "default");
		} else {
		...
		if(subpole){
			...
			this.getSpriteLayer("sub_pole").SetOffset(SubArmOffset+Vec2f(5.0f,3.5f)+Vec2f(Maths::Cos(RadAngle)*sub_drawback*-0.2*test,Maths::Sin(RadAngle)*sub_drawback*-0.2));

			setAimValues(this,this.getSpriteLayer("sub_pole"), true, angle, Vec2f(0, 0), "default");
			
			setAimValues(this,this.getSpriteLayer("backarm"), subarmvisible, Down-sub_drawback*test, Vec2f(0, 0), "default");
		} else {
		...
		if(mainstab){
			...
			this.getSpriteLayer("main_stab").SetOffset(MainArmOffset+Vec2f(3.0f,4.0f)+Vec2f(Maths::Cos(RadAngle)*main_drawback*-0.2*test,Maths::Sin(RadAngle)*main_drawback*-0.2));

			setAimValues(this,this.getSpriteLayer("main_stab"), true, angle, Vec2f(0, 0), "default");
			
			setAimValues(this,this.getSpriteLayer("frontarm"), mainarmvisible, Down-main_drawback*test, Vec2f(0, 0), "default");
		} else {
			setAimValues(this,this.getSpriteLayer("main_stab"), false, angle, Vec2f(0, 0), "default");
		}
		...
		if(substab){
			...
			this.getSpriteLayer("sub_stab").SetOffset(SubArmOffset+Vec2f(2.0f,4.0f)+Vec2f(Maths::Cos(RadAngle)*sub_drawback*-0.2*test,Maths::Sin(RadAngle)*sub_drawback*-0.2));

			setAimValues(this,this.getSpriteLayer("sub_stab"), true, angle, Vec2f(0, 0), "default");
			
			setAimValues(this,this.getSpriteLayer("backarm"), subarmvisible, Down-sub_drawback*test, Vec2f(0, 0), "default");
		} else {
			setAimValues(this,this.getSpriteLayer("sub_stab"), false, angle, Vec2f(0, 0), "default");
		}
