...
const Vec2f pos_off = Vec2f(-8, 5);
const Vec2f hitbox_ur			= Vec2f(14.0f, -24.0f) + pos_off;
const Vec2f hitbox_ur_crouching	= Vec2f(14.0f, -18.0f) + pos_off;
...
const Vec2f[] hitbox_default= {
	...
	Vec2f(hitbox_dl.x, hitbox_dl.y) + Vec2f(8, -1),// down middle
...
const Vec2f[] hitbox_crouching= {
	...
	Vec2f(hitbox_dl.x, hitbox_dl.y)						+ Vec2f(8, 0),// down middle
...
void onTick(CBlob@ this)
{
	...
	{
	//	shape.SetOffset(crouching? Vec2f(2, -2) : Vec2f(2, 4));
