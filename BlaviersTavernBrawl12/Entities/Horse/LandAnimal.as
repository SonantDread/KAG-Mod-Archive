...
void onInit(CBlob@ this)
{
	AnimalVars vars;
	//walking vars
	vars.walkForce.Set(220.0f, -100.0f);
	vars.runForce.Set(150.0f, -50.0f);
	vars.slowForce.Set(40.0f, 0.0f);
	vars.jumpForce.Set(0.0f, -700.0f);
	vars.maxVelocity = 2.3f;
	this.set("vars", vars);
...
void onTick(CMovement@ this)
{
	...
	if (left)
	{
		blob.AddForce(Vec2f(-1.4f * vars.walkForce.x, vars.walkForce.y));
	}
	if (right)
	{
		blob.AddForce(Vec2f(1.4f * vars.walkForce.x, vars.walkForce.y));
