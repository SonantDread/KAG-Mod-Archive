...
void MakeTradeMenu(CBlob@ trader)
{
	...
	if (cost_bombs > 0)
		...
		addItemForCoin(trader, "Shotgun", 70, true, "$shotgun$", "shotgun", "Shotgun\nKnockback\nMid range\n40 Shots)");
		...
		addItemForCoin(trader, "Flamer", 120, true, "$flamer$", "flamer", "Flamer");
		...
		addItemForCoin(trader, "Summoner", 50, true, "$summoner$", "summoner", "Detonator\nSpace to use\nDetonates your mines");
		addItemForCoin(trader, "Energy Shield", 50, true, "$eshield$", "eshield", "Energy Shield\nSpace to use\nGenerates a shield that reflects enemies projectiles");
