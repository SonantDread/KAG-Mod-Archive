...
//Kaizokuroof additions
const SColor color_pistolstore(255, 1, 0, 0);
const SColor color_automaticriflestore(255, 2, 0, 0);
const SColor color_submachinegunstore(255, 3, 0, 0);
const SColor color_shotgunstore(255, 4, 0, 0);
const SColor color_riflestore(255, 5, 0, 0);

const SColor color_healwego(255, 15, 0, 0);
const SColor color_packapunch(255, 16, 0, 0);
...
class PNGLoader
{
	...
	if (pixel == color_tile_ground) {
		...
		//Kaizokuroof additions
		else if (pixel == color_pistolstore)
		{
			spawnBlob( map, "pistolstore", offset, -1, true);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_automaticriflestore)
		{
			spawnBlob( map, "automaticriflestore", offset, -1, true);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_submachinegunstore)
		{
			spawnBlob( map, "submachinegunstore", offset, -1, true);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_riflestore)
		{
			spawnBlob( map, "riflestore", offset, -1, true);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_shotgunstore)
		{
			spawnBlob( map, "shotgunstore", offset, -1, true);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_healwego)
		{
			spawnBlob( map, "healwegostore", offset, -1, true);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_packapunch)
		{
			spawnBlob( map, "powerupgunstore", offset, -1, true);
			offsets[autotile_offset].push_back( offset );
		}
