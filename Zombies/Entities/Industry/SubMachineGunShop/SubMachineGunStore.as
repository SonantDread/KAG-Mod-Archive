...
void onInit(CBlob@ this)
{
	...
	{
		// Name, Icon, blob
		ShopItem@ s = addShopItem(this, "SubMachineGun Shop", "$submachinegunshop$", "submachinegunshop", "Build this, for the ability to purchase small, rapid firing weapons.");
		AddRequirement(s.requirements, "coin", "", "Coins", 75); // 0 for test purposes.
	}
}
