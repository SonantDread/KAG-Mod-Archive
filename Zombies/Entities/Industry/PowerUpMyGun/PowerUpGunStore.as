...
void onInit(CBlob@ this)
{
	...
	{
		// Name, Icon, blob
		ShopItem@ s = addShopItem(this, "Pack a Punch!", "$powerupgunshop$", "powerupgunshop", "Build this, for the ability to purchase shotguns!");
		AddRequirement(s.requirements, "coin", "", "Coins", 300); // 0 for test purposes.
	}
}
