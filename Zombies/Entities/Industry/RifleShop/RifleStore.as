...
void onInit(CBlob@ this)
{
	...
	{
		// Name, Icon, blob
		ShopItem@ s = addShopItem(this, "Rifle Shop", "$rifleshop$", "rifleshop", "Build this, for the ability to purchase large rifles.");
		AddRequirement(s.requirements, "coin", "", "Coins", 120); //Test is 0
	}
}
