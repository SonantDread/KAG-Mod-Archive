...
void onInit(CBlob@ this)
{
	...
	{
		// Name, Icon, blob
		ShopItem@ s = addShopItem(this, "Automatic Rifle Shop", "$automaticrifleshop$", "automaticrifleshop", "Build this, for the ability to purchase large automatic rifles.");
		AddRequirement(s.requirements, "coin", "", "Coins", 200); //Test is 0
	}
}
