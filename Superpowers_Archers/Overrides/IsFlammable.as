...
{
    if (hasPower(this, Powers::FIRE_LORD))
        return damage;
...
void onTick(CBlob@ this)
{
    ...
    bool fireLord = hasPower(this, Powers::FIRE_LORD);
	s16 burn_time = this.get_s16(burn_timer);
	//check if we should be getting set on fire or put out
	if (fireLord ||
            burn_time < (burn_thresh / fire_wait_ticks) && this.isInFlames())
	{
		server_setFireOn(this);
	...
	if (!fireLord && (burn_time == 0 || this.isInWater()))
	{
		server_setFireOff(this);
