...
void onInit(CBlob@ this)
{
	...
	this.set_f32("explosive_radius", 294.0f);
	this.set_f32("explosive_damage", 52.2130f);
	this.set_string("custom_explosion_sound", "Entities/Items/Explosives/KegExplosion.ogg");
	this.set_f32("map_damage_radius", 369.0f);
	this.set_f32("map_damage_ratio", 10.764f);
	this.set_bool("map_damage_raycast", true);
	this.set_f32("keg_time", 600.0f);
