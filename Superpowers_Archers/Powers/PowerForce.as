...
const float FORCE_RADIUS = 40.0;
const float FORCE_FORCE = 5.0;
const float MASS_FACTOR = 0.4;
const float LOW_FORCE_DISTANCE = 18.0;
const float LOW_FORCE_FACTOR = 0.2;
const int PARTICLE_FREQ = 10;

const float FORCE_ENERGY_MAX = 1000;
const float FORCE_USE_PT = 5;
const float FORCE_REGEN_PT = 0.1;
