	...
	if (cmd == this.getCommandID("shop made item"))
	{
		...
		string name = params.read_string();
		{
			...
			else if (name == "ballista")
			{
				...
				if (box !is null)
				{
					box.set_s32("gold building amount", CTFCosts::ballista_gold);

					// Harder to unpack
					box.set_Vec2f("required space", Vec2f(7, 7));
					// box.set_Vec2f("required space", Vec2f(5, 4)); // This is the default size
				}
			}
		}
	}
