...
void Blend(CBlob@ this, CBlob@ tobeblended)
{
	...
	// on sawing too many team bombs - disable the saw
	if (tobeblended.getName() == "bomb"
		&& tobeblended.getTeamNum() == this.getTeamNum())
	{
		this.add_u8("bomb_count", 1);
		if (this.get_u8("bomb_count") == bombs_to_disable)
		{
			CBitStream params;
