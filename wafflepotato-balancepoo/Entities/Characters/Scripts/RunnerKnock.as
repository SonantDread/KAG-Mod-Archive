...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	if (customData == Hitters::water_stun || customData == Hitters::water_stun_force)
	{
		...
		bool defended = not force // not a direct hit
						&& blockAttack(this, velocity, damage) // shield blocks it
						&& (hitterBlob.getDamageOwnerPlayer() !is this.getPlayer()); // not my own
		...
		{
			this.getSprite().PlaySound("/Stun", 1.0f, this.getSexNum() == 0 ? 1.0f : 1.5f);
			setKnocked(this, 5, true);
			setDazzled(this, Maths::Min(Maths::Max(time - 5, 5), 60), true);
		}
	}
