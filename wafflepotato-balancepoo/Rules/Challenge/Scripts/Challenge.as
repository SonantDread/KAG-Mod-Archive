...
void MakeTradeMenu(CBlob@ trader)
{
	...
	addItemForCoin(trader, "Splash Bomb", 10, true, "$mat_waterbombs$", "mat_waterbombs", Descriptions::waterbomb);
	...
	addItemForCoin(trader, "Splash Arrows", 10, true, "$mat_waterarrows$", "mat_waterarrows", Descriptions::waterarrows);
