...
const Vec2f arm_offset = Vec2f(-12,-5);
...
void onInit( CBlob@ this )
{
    ...
    Vehicle_SetupWeapon( this, v,
                         ...
                         "mat_bullets2", // bullet ammo config name
                         "hmgbullet", // bullet config name
                         "HGunFire", // fire sound
                         "EmptyFire" // empty fire sound
                       );
    v.charge = 0;
    CSprite@ sprite = this.getSprite();
    CSpriteLayer@ arm = sprite.addSpriteLayer( "arm", sprite.getConsts().filename, 32, 16 );
	...
	this.set_string("autograb blob", "mat_bullets2");
	...
	if (getNet().isServer())
	{
		CBlob@ ammo = server_CreateBlob( "mat_bullets2" );
		if (ammo !is null)	{
