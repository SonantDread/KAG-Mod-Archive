...
AddIconToken( "$pa$", "PA.png", Vec2f(32,16), 0 );
	...
	}
	{
		...
		AddRequirement( s.requirements, "no more", "boulderfactory", "Boulder Factory", 6 );
	}
	{
		...
		AddRequirement( s.requirements, "no more", "sawfactory", "Saw Factory", 6 );
	}
	{
		...
		AddRequirement( s.requirements, "no more", "lanternfactory", "Lantern Factory", 6 );
	}
	{
		ShopItem@ s = addShopItem( this, "Flag Factory", "$flagfactory$", "flagfactory", "Factory for decorative flags." );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 150 );
		AddRequirement( s.requirements, "no more", "flagfactory", "Flag Factory", 6 );
	}
	{
