...
s32 biomeR = getRules().get_s8("biome");
...
class PNGLoader
{
	...
	void handlePixel(SColor pixel, int offset)
	{
		...
		if(alpha < 255)
		{
			...
			{
				spawnBlob(map, "ZombiePortal", getTeamFromChannel(alpha), position, getAngleFromChannel(alpha), true);
				offsets[autotile_offset].push_back(offset);
			}
		...
		else if(pixel == color_tile_grass)
		{
			...
			print("normal grass 1");
		}
		/* else if(pixel == color_tile_grassSa && biomeR == 2 || biomeR == 3)
		{
			map.SetTile(offset, CMap::tile_grassSa + map_random.NextRanged(3));
			print("Sa grass 1");
		}
		else if(pixel == color_tile_grassF && biomeR == 4 || biomeR == 5)
		{
			map.SetTile(offset, CMap::tile_grassF + map_random.NextRanged(3));
			print("F grass 1");
		}
		else if(pixel == color_tile_grassSn && biomeR == 6 || biomeR == 7)
		{
			map.SetTile(offset, CMap::tile_grassSn + map_random.NextRanged(3));
			print("Sn grass 1");
		}
		else if(pixel == color_tile_grassR && biomeR == 8 || biomeR == 9)
		{
			map.SetTile(offset, CMap::tile_grassR + map_random.NextRanged(3));
			print("R grass 1");
		}
		else if(pixel == color_tile_grassB && biomeR == 10 || biomeR == 11)
		{
			map.SetTile(offset, CMap::tile_grassB + map_random.NextRanged(3));
			print("Ba grass 1");
		} */
	...
	void handleOffset(int type, int offset, int position, int count)
	{
		...
		else if(type == tree_offset)
		{
		 ...
		 //s32 biomeR = getRules().get_s32("biome");
		/* if(biomeR == 0 || biomeR <= 1 )
		{
			map.SetTile(offset, CMap::tile_grass + map_random.NextRanged(3));
			print(" grass 2");
		}
	...
	void SetupMap(int width, int height)
	{
		...
		if(biomeR == 2 || biomeR == 3)
		{
			map.CreateTileMap(width, height, 8.0f, "Sprites/world2.png");
			print("Sa grass 3");
		}
		if(biomeR == 4 || biomeR == 5)
		{
			map.CreateTileMap(width, height, 8.0f, "Sprites/world3.png");
			print("F grass 3");
		}
		if(biomeR == 6 || biomeR == 7)
		{
			map.CreateTileMap(width, height, 8.0f, "Sprites/world4.png");
			print("Sm grass 3");
		}
		if(biomeR == 8 || biomeR == 9)
		{
			map.CreateTileMap(width, height, 8.0f, "Sprites/world5.png");
			print("R grass 3");
		}
		if(biomeR == 10 || biomeR == 11)
		{
			map.CreateTileMap(width, height, 8.0f, "Sprites/world6.png");
			print("B grass 3");
		}  
	}
...
color_tile_grassR,                                          // |   8 |
color_tile_grassR,                                            // |   9 |
color_tile_grassR,                                         // |  10 |
color_tile_grassR,                                           // |  11 |
unused,                                           // |  12 |
unused,                                           // |  13 |
unused,                                           // |  14 |
unused,                                           // |  15 |
...
color_tile_grassF,                                           // |  42 |
color_tile_grassF,                                               // |  43 |
color_tile_grassF,                                                // |  44 |
color_tile_grassF,                                                // |  45 |
color_tile_grassF,                                                // |  46 |
color_tile_grassF,                                                // |  47 |
...
color_tile_grassSn,                                                // | 232 |
color_tile_grassSn,                                                // | 233 |
color_tile_grassSn,                                                // | 234 |
color_tile_grassSn,                                                // | 235 |
color_tile_grassSn,                                                // | 236 |
color_tile_grassSn,                                                // | 237 |
unused,                                           // | 238 |
unused,                                           // | 239 |
unused,                                           // | 240 |
unused,                                           // | 241 |
...
unused,                                           // | 243 |
unused,                                           // | 244 |
color_tile_grassSa,                                                // | 245 |
color_tile_grassSa,                                               // | 246 |
color_tile_grassSa,                                                // | 247 |
color_tile_grassSa,                                                // | 248 |
color_tile_grassSa,                                                // | 249 |
color_tile_grassSa,                                                // | 250 |
unused,                                           // | 251 |
unused,                                           // | 252 |
unused,                                           // | 253 |
unused,                                           // | 254 |
