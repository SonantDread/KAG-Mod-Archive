...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks)
{
	...
	AddIconToken("$ironchest$", "IronChest.png", Vec2f(16, 16), 0);
	...
	AddIconToken("$iron_door$", "1x1IronDoor.png", Vec2f(8, 8), 0);
	...
	}
	{
		...
		AddRequirement(b.reqs, "blob", "mat_gear", "Gear", 2);
		blocks[0].push_back(b);
	}
	{
	...
	}
	{
		...
		AddRequirement(b.reqs, "blob", "mat_gear", "Gear", 4);
		b.buildOnGround = true;
		b.size.Set(16, 16);
		blocks[1].push_back(b);
	}
	...
	}
	{
		...
		BuildBlock b(0, "library", "$library$", "Library");
		AddRequirement(b.reqs, "blob", "mat_wood", "Wood", 150);
		AddRequirement(b.reqs, "blob", "mat_stone", "Stone", 90);
		b.buildOnGround = true;
		b.size.Set(40, 24);
		blocks[1].push_back(b);
	}
