...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$icon_bomber$", "Icon_Bomber.png", Vec2f(44, 64), 0);
	...
	{
		ShopItem@ s = addShopItem(this, "Steam Tank", "$icon_steamtank$", "steamtank", "$icon_steamtank$\n\n\n" + "An armored land vehicle. Comes with a powerful cannon and a durable ram.", false, false);
		AddRequirement(s.requirements, "blob", "mat_ironplate", "Iron Plate", 20);
		AddRequirement(s.requirements, "blob", "mat_steelingot", "Steel Ingot", 10);
		AddRequirement(s.requirements, "blob", "mat_pipe", "Copper Pipe", 8);
		AddRequirement(s.requirements, "blob", "mat_gear", "Gear", 10);
		AddRequirement(s.requirements, "blob", "mat_gyromat", "Accelerated Gyromat", 4);
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 300);
		AddRequirement(s.requirements, "blob", "mat_wheel", "Wheel", 6);
	}
	{
		ShopItem@ s = addShopItem(this, "Balloon", "$icon_bomber$", "bomber", "$icon_bomber$\n\n\n" + "A large aerial vehicle used for safe transport and bombing those peasants below.", false, false);
		AddRequirement(s.requirements, "blob", "mat_hemp", "Hemp", 80);
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 100);
	}
