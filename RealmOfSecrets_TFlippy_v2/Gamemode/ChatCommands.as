...
bool onServerProcessChat(CRules@ this, const string& in text_in, string& out text_out, CPlayer@ player)
{
	...
	else if (text_in == "In Okinawa, all Miyagi know two things: fish and karate.")
	{
		CBlob@ carried = player.getBlob().getCarriedBlob();
	
		if (carried !is null && player.getBlob().getCarriedBlob().getName() == "staff")
		{
			print("ninja soon");
		}
	}
