...
void onInit(CBlob@ this)
{
	...
	else if (name == "mat_copperingot" || name == "mat_ironingot" || name == "mat_steelingot" || name == "mat_goldingot" || name == "mat_mithrilingot" || name == "mat_lifesteelingot" || name == "mat_wilmetingot")
	{
		max = 64;
		set = true;
	}
	else if (name == "mat_ironplate")
	{
		max = 16;
		set = true;
	}
	else if (name == "mat_gear" || name == "mat_copperwire" || name == "mat_pipe")
	{
		max = 8;
		set = true;
	}
	else if (name == "mat_tankshell" || name == "mat_wheel" || name == "mat_gyromat")
	{
		max = 4;
		set = true;
	}
