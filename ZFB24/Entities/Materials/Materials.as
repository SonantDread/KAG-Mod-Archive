...
void onInit( CBlob@ this )
{
    ...
    if (name == "mat_arrows")
    {
		...
		else if (name == "mat_bullets" && this.get_bool("MG ammo") == false)
	{			
	max = 30;
	set = true;
	}
		else if (name == "mat_bullets" && this.get_bool("MG ammo") == true)
	{			
	max = 60;
	set = true;
	//print("Heavy Bomb 2 Active");
	}
	...
	set = true;
		...
		else if (name == "mat_heavybomb" && this.get_bool("drop bomb ammo") == false)
	{			
	max = 1;
	set = true;
	}
		else if (name == "mat_heavybomb" && this.get_bool("drop bomb ammo") == true)
	{			
	max = 2;
	set = true;
	//print("Heavy Bomb 2 Active");
	...
	set = true;
   	...
   	else if (name == "mat_missile" && this.get_bool("Bazooka ammo") == false)
	{			
	max = 1;
	set = true;
	}
		else if (name == "mat_missile" && this.get_bool("Bazooka ammo") == true)
	{			
	max = 2;
	set = true;
	//print("Heavy Bomb 2 Active");
