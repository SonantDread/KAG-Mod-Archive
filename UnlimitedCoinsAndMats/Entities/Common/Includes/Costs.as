...
void InitCosts()
{
	...
	CTFCosts::boatshop_gold =               ReadCost(cfg, "cost_boatshop_gold"      , 0);
	...
	CTFCosts::tunnel_gold =                 ReadCost(cfg, "cost_tunnel_gold"        , 0);
	CTFCosts::quarry_stone =				ReadCost(cfg, "cost_quarry_stone"       , 0);
	CTFCosts::quarry_gold =					ReadCost(cfg, "cost_quarry_gold"        , 0);
	CTFCosts::quarry_count =				ReadCost(cfg, "cost_quarry_count"       , 1);

	//ArcherShop.as
	CTFCosts::arrows =                      ReadCost(cfg, "cost_arrows"             , 0);
	CTFCosts::waterarrows =                 ReadCost(cfg, "cost_waterarrows"        , 0);
	CTFCosts::firearrows =                  ReadCost(cfg, "cost_firearrows"         , 0);
	CTFCosts::bombarrows =                  ReadCost(cfg, "cost_bombarrows"         , 0);

	//KnightShop.as
	CTFCosts::bomb =                        ReadCost(cfg, "cost_bomb"               , 0);
	CTFCosts::waterbomb =                   ReadCost(cfg, "cost_waterbomb"          , 0);
	CTFCosts::mine =                        ReadCost(cfg, "cost_mine"               , 0);
	CTFCosts::keg =                         ReadCost(cfg, "cost_keg"                , 0);

	//BuilderShop.as
	CTFCosts::lantern_wood =                ReadCost(cfg, "cost_lantern_wood"       , 0);
	CTFCosts::bucket_wood =                 ReadCost(cfg, "cost_bucket_wood"        , 0);
	CTFCosts::filled_bucket =               ReadCost(cfg, "cost_filled_bucket"      , 0);
	CTFCosts::sponge =                      ReadCost(cfg, "cost_sponge"             , 0);
	CTFCosts::boulder_stone =               ReadCost(cfg, "cost_boulder_stone"      , 0);
	CTFCosts::trampoline_wood =             ReadCost(cfg, "cost_trampoline_wood"    , 0);
	CTFCosts::saw_wood =                    ReadCost(cfg, "cost_saw_wood"           , 0);
	CTFCosts::saw_stone =                   ReadCost(cfg, "cost_saw_stone"          , 0);
	CTFCosts::drill_stone =                 ReadCost(cfg, "cost_drill_stone"        , 0);
	CTFCosts::drill =                       ReadCost(cfg, "cost_drill"              , 0);
	CTFCosts::crate_wood =                  ReadCost(cfg, "cost_crate_wood"         , 0);
	CTFCosts::crate =                       ReadCost(cfg, "cost_crate"              , 0);

	//BoatShop.as
	CTFCosts::dinghy =                      ReadCost(cfg, "cost_dinghy"             , 0);
	CTFCosts::dinghy_wood =                 ReadCost(cfg, "cost_dinghy_wood"        , 0);
	CTFCosts::longboat =                    ReadCost(cfg, "cost_longboat"           , 0);
	CTFCosts::longboat_wood =               ReadCost(cfg, "cost_longboat_wood"      , 0);
	CTFCosts::warboat =                     ReadCost(cfg, "cost_warboat"            , 0);

	//VehicleShop.as
	CTFCosts::catapult =                    ReadCost(cfg, "cost_catapult"                   , 0);
	CTFCosts::ballista =                    ReadCost(cfg, "cost_ballista"                   , 0);
	CTFCosts::ballista_ammo =               ReadCost(cfg, "cost_ballista_ammo"              , 0);
	CTFCosts::ballista_ammo_upgrade_gold =  ReadCost(cfg, "cost_ballista_ammo_upgrade_gold" , 0);
	...
	//CommonBuilderBlocks.as
	CTFCosts::workshop_wood =               ReadCost(cfg, "cost_workshop_wood"      , 0);
	...
	WARCosts::trampoline_wood =         ReadCost(cfg, "cost_trampoline_wood"    , 0);
	WARCosts::crate_wood =              ReadCost(cfg, "cost_crate_wood"         , 0);
	WARCosts::drill_stone =             ReadCost(cfg, "cost_drill_stone"        , 0);
	WARCosts::saw_wood =                ReadCost(cfg, "cost_saw_wood"           , 0);
	WARCosts::dinghy_wood =             ReadCost(cfg, "cost_dinghy_wood"        , 0);
	WARCosts::boulder_stone =           ReadCost(cfg, "cost_boulder_stone"      , 0);

	//Scrolls
	WARCosts::crappiest_scroll =        ReadCost(cfg, "cost_crappiest_scroll"   , 0);
	WARCosts::crappy_scroll =           ReadCost(cfg, "cost_crappy_scroll"      , 0);
	WARCosts::medium_scroll =           ReadCost(cfg, "cost_medium_scroll"      , 0);
	WARCosts::big_scroll =              ReadCost(cfg, "cost_big_scroll"         , 0);
	WARCosts::super_scroll =            ReadCost(cfg, "cost_super_scroll"       , 0);

	//CommonBuilderBlocks.as
	WARCosts::factory_wood =            ReadCost(cfg, "cost_factory_wood"       , 0);
	WARCosts::workbench_wood =          ReadCost(cfg, "cost_workbench_wood"     , 0);

	//WAR_Base.as
	WARCosts::tunnel_stone =            ReadCost(cfg, "cost_tunnel_stone"       , 0);
	WARCosts::kitchen_wood =            ReadCost(cfg, "cost_kitchen_wood"       , 0);
	...
	BuilderCosts::back_stone_block =    ReadCost(cfg, "cost_back_stone_block"   , 0);
	BuilderCosts::stone_door =          ReadCost(cfg, "cost_stone_door"         , 0);
	BuilderCosts::wood_block =          ReadCost(cfg, "cost_wood_block"         , 0);
	BuilderCosts::back_wood_block =     ReadCost(cfg, "cost_back_wood_block"    , 0);
