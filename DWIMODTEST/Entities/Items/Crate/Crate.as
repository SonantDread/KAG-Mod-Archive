...
void onInit(CBlob@ this)
{
	...
	if (this.exists("frame"))
	{
		...
		// GIANT HACK!!!
		if (packed == "catapult" || packed == "bomber" || packed == "ballista" || packed == "mounted_bow" || packed == "longboat" || packed == "warboat" ||
		 packed == "car" || packed == "airship" || packed == "bison" ||packed == "necromancer" || packed == "shark")	 // HACK:
		{
