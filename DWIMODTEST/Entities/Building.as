...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Ship Shop", "$shipshop$", "shipshop", Descriptions::boatshop);
	...
	{
		ShopItem@ s = addShopItem(this, "Engineer Shop", "$engineershop$", "engineershop", "Shop full of useful beasts for reasonable prices.");
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 100);
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 150);
	}
}
