...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	*/
	...
	if (strategy != Strategy::idle && strategy != Strategy::runaway)
	{
		...
		caller.CreateGenericButton( "$migrant_standground$", Vec2f(0,-32), this,  this.getCommandID("migrant_stop"), "Tell migrant to stop", params );
	}
	else
	{
		...
		//params.write_u16( this.getNetworkID() );
		params.write_u8( strategy );
		caller.CreateGenericButton( "$migrant_continue$", Vec2f(0,-32), this,  this.getCommandID("migrant_start"), "Tell migrant to follow and or go to Dorm", params );
	}
