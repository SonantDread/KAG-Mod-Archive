...
{	 
	...
	this.set_bool("migrants auto", false);
...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	{
			CButton@ button = caller.CreateGenericButton( "$builder$", Vec2f(0, 0), this, 0, "Requires 1 migrant for healing and respawning" );
			if (button !is null) {
