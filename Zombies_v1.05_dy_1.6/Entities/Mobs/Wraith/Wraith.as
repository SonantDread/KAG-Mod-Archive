...
//	this.set_f32("map_bomberman_width", 24.0f);
    this.set_f32("explosive_radius", 30.0f);//default 40
    this.set_f32("explosive_damage",4.0f); ////default 5.0f
    this.set_u8("custom_hitter", Hitters::keg);
    this.set_string("custom_explosion_sound", "Entities/Items/Explosives/KegExplosion.ogg");
    this.set_f32("map_damage_radius", 38.0f);//default 48
