...
//create a statue damage event
GameplayEvent@ createStatueDamageEvent(CPlayer@ by, f32 damage)
{
	GameplayEvent g(GE_hit_statue, by);
	g.params.write_f32(damage);
	return g;
}

//create a statue destroy event
GameplayEvent@ createStatueDestroyEvent(CPlayer@ by)
{
	return GameplayEvent(GE_kill_statue, by);
}
