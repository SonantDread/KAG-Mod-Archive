...
void onInit(CBlob@ this)
{
	...
	//vars.jumpForce.Set(0.0f,2*-4.4f);
	//else
	vars.jumpForce.Set(0.0f,-4.4f);
	...
	f32 green_troll_health = getRules().get_f32("green_troll_health");
	this.server_SetHealth(green_troll_health);
