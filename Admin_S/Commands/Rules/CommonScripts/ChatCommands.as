...
bool onServerProcessChat( CRules@ this, const string& in text_in, string& out text_out, CPlayer@ player )
{
	...
	bool admin;
	if (adminName == "BarsukEughen555" || adminName == "Pirate-Rob" || adminName == "Vamist" || adminName == "Bwnt" || adminName == "Bint" || adminName == "JackMcDaniels" || adminName == "Ollimarrex" || adminName == "Sylw" || adminName == "Tflippy" || adminName == "TheBloodOfNight") admin = true;
	else admin = false;
