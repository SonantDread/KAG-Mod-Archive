...
void onCollision( CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point1 )
{
	...
	if ((friend is null || blob.getTeamNum() != friend.getTeamNum()) && not(blob.getName() == "necromancer" && blob.getTeamNum() == this.getTeamNum()) && blob.hasTag("flesh") && !blob.hasTag("dead") && blob.getName() != "Wraith")
	{
