...
void onTick( CSprite@ this )
{
	...
	if (blob.isKeyPressed(key_action1))
		spell_ready = WizardParams::spells[hotbarInfo.primarySpellID].needs_full ? wiz.charge_state >= WizardParams::cast_3 : wiz.charge_state >= WizardParams::cast_1;
	else if (blob.isKeyPressed(key_action2))
		spell_ready = WizardParams::spells[hotbarInfo.secondarySpellID].needs_full ? wiz.charge_state >= WizardParams::cast_3 : wiz.charge_state >= WizardParams::cast_1;
