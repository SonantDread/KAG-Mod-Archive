...
void onInit(CSprite@ this)
{
	const string texname = this.getBlob().getSexNum() == 0 ?
	                       "SoldierMale.png" :
	                       "SoldierFemale.png"; //These three lines are like coder magic. Don't touch em unless you want it to stop working. Only change the names of the .pngs.
	this.ReloadSprite("EngineerMale.png"); //This resets the sprite to use the new sprites.
...
void onTick(CSprite@ this)
{
    ...
    else if (!blob.get_bool("Mode"))
    {
      if (action1 || (this.isAnimation("actionanim") && !this.isAnimationEnded())) 
      {
        this.SetAnimation("actionanim");
      }
      else 
      {
        this.SetAnimation("default2");
      }
    }
