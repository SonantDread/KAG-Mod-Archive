...
void onInit(CSprite@ this)
{
	...
	this.ReloadSprite("SniperMale.png"); //This resets the sprite to use the new sprites.
...
void onTick(CSprite@ this)
{
	...
	if (!blob.hasTag(burning_tag)) //Are we burning? If so, lets not screw with the burning animations.
	{
		...
		else if (!right && !left &&(action2 || (this.isAnimation("actionanim") && !this.isAnimationEnded())))
		{
