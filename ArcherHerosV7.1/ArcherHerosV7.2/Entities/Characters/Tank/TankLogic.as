...
void onTick(CBlob@ this) //This script is called 30 times a second. It's a general update script. Most of your modding will be done here.
{
  ...
  if(this.isKeyPressed(key_action1)) 
  {
    ...
    {
      ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getAimPos() + Vec2f(0.0f, -2.0f), 16.0f, 0, false); 
      ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getAimPos() + Vec2f(0.0f, -2.0f), 12.0f, 0, false); 
      ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getAimPos() + Vec2f(0.0f, -2.0f), 8.0f, 0, false); 
      ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getAimPos() + Vec2f(0.0f, -2.0f), 4.0f, 0, false);
      this.set_u32("Reload",30);
    }
  ...
  {
    if(this.get_f32("Shield") < 24.0f)
    {
     this.set_f32("Shield", this.get_f32("Shield") + 0.05f);
    }
  }
