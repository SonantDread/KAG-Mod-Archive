...
float drawScoreboard(CPlayer@[] players, Vec2f topleft, CTeam@ team, Vec2f emblem)
{
	...
	GUI::DrawText(getTranslatedString("Rank"), Vec2f(bottomright.x - 120, topleft.y), SColor(0xffffffff));
	...
	for (u32 i = 0; i < players.length; i++)
	{
		...
		GUI::DrawText("" + p.getScore(), Vec2f(bottomright.x - 120, topleft.y), SColor(0xffffffff));
