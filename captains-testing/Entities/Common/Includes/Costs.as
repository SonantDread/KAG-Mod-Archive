...
void InitCosts()
{
	...
	CTFCosts::tunnel_stone =                ReadCost(cfg, "cost_tunnel_stone"       , 250);
	...
	CTFCosts::quarry_stone =				ReadCost(cfg, "cost_quarry_stone"       , 50);
	CTFCosts::quarry_gold =					ReadCost(cfg, "cost_quarry_gold"        , 50);
	CTFCosts::quarry_count =				ReadCost(cfg, "cost_quarry_count"       , 2);
	...
	//Quarry.as
	CTFCosts::dispense_stone = 				ReadCost(cfg, "cost_dispense_stone"		, 40);
