...
bool g_need_to_suddendeath_message = false;

void onTick(CRules@ this)
{
	if (g_need_to_suddendeath_message
		&& getGameTime() >= this.get_u16("sudden_death_vote_time"))
	{
		client_AddToChat(getTranslatedString("Sudden death vote is now available!"));
		g_need_to_suddendeath_message = false;
	}
...
void onRestart(CRules@ this)
{
	...
	if (this.hasTag("suddendeath_vote_allowed"))
		g_need_to_suddendeath_message = true;
	else
		g_need_to_suddendeath_message = false;
