...
void onTick(CMovement@ this)
{
	...
	const bool isTumbling = statusVars.tumbleTime > 0;
	...
	if (is_client && getGameTime() % 3 == 0)
	{
		...
		/* unfortunately, this doesn't work with ssk_archer bow draw stuff;
	...
	if (moveVars.jumpFactor > 0.01f && !isTumbling)
	{
		...
		if (upJustPressed && moveVars.numJumps < 2 && !statusVars.fastFalling)
		{
			...
			const f32 DOUBLE_JUMP_SPEED = 8.0f;
			f32 jumpSpeed = 0.0f;
	...
	bool left_or_right = (left || right);
	{
		...
		{
			// dash effects when changing direction while dashing
