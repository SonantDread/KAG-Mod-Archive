			...
			if (getNet().isServer())
			{
				...
				if (caller !is null && canChangeClass(this, caller))
				{
					...
					if (newBlob !is null)
					{
						...
						SSKStatusVars@ callerStatusVars;
						SSKStatusVars@ newBlobStatusVars;
						if (caller.get("statusVars", @callerStatusVars) && newBlob.get("statusVars", @newBlobStatusVars))
						{
							newBlobStatusVars.damageStatus = callerStatusVars.damageStatus;
							newBlobStatusVars.tumbleTime = callerStatusVars.tumbleTime;
						}
