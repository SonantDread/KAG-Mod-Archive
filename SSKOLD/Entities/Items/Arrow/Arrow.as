...
void onInit(CBlob@ this)
{
	...
	{
		SetupBomb(this, bomb_fuse, 48.0f, 15.0f, 24.0f, 0.5f, true);
...
void onCollision(CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point1)
{
	if (blob !is null && doesCollideWithBlob(this, blob) && !this.hasTag("collided"))
	{
		...
		else
		{
			...
			if (dmg > 0.0f)
			{
				CustomHitData customHitData(0, 2.0f, 0.06f);

				if (arrowType == ArrowType::fire)
					server_customHit(this, blob, point1, initVelocity, dmg, Hitters::fire, true, customHitData);
				else
					server_customHit(this, blob, point1, initVelocity, dmg, Hitters::arrow, true, customHitData);
			}
		}
	...
	if (this !is hitBlob && customData == Hitters::arrow)
	{
		...
		if (speed > ArcherParams::shoot_max_vel * 0.5f)
		{
			        ...
			        hitBlob.hasTag("player"))
			{
				...
				{
					hitBlobStatusVars.tumbleTime = 20;
