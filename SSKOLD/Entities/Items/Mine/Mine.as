...
void onTick(CBlob@ this)
{
	if(getNet().isServer())
	{
		...
		if(this.getVelocity().LengthSquared() < 1.0f && !this.isAttached() && (teamNum == 0 || teamNum == 1))
		{
...
void onDie(CBlob@ this)
{
	if(getNet().isServer() && this.hasTag("exploding"))
	{
		...
		for(u16 i = 0; i < blobs.length; i++)
		{
			...
			{
				CustomHitData customHitData(10, 3.0f, 0.08f);
				server_customHit(this, target, POSITION, Vec2f_zero, 8.0f, Hitters::mine_special, true, customHitData);
			}
		}
	}
}
