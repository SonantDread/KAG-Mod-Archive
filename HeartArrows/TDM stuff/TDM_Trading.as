...
void MakeTradeMenu(CBlob@ trader)
{
	...
	s32 cost_heartarrows = cfg.read_s32("cost_heartarrows", 50);
	...
	if (cost_heartarrows > 0)
		addItemForCoin(trader, "Heart Arrow", cost_heartarrows, true, "$mat_arrows$", "mat_heartarrows", descriptions[51]);
