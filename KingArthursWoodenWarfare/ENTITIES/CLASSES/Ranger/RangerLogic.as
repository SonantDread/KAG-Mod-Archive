...
void ClientFire(CBlob@ this, const s8 charge_time, const bool hasarrow, const u8 arrow_type, const bool legolas)
{
	...
	if (hasarrow && canSend(this))  // client-logic
	{
		...
		{
			ShootArrow(this, this.getPosition(), this.getAimPos() + Vec2f(-7.0f + XORRandom(14), -8.0f + XORRandom(16)), ArcherParams::shoot_max_vel*2.1f, ArrowType::normal, legolas);
		}
		else
		{
