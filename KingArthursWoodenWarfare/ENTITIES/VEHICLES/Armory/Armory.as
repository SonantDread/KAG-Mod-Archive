...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Tank Trap", "$tanktrap$", "tanktrap", "Czech hedgehog, will harm any enemy vehicles that collide with it.", false);
	...
	{
		ShopItem@ s = addShopItem(this, "Frag Grenade", "$grenade$", "grenade", "Press Space while holding to arm, ~4 seconds til' boom.", false);
		AddRequirement(s.requirements, "blob", "mat_scrap", "Scrap", 6);
	}
	{
	...
	{
		ShopItem@ s = addShopItem(this, "Heat Warheads", "$mat_heatwarhead$", "mat_heatwarhead", "Warheads used by the anti-tank class as ammunition.", false);
		AddRequirement(s.requirements, "blob", "mat_scrap", "Scrap", 20);
	}
	{
		ShopItem@ s = addShopItem(this, "Pipe Wrench", "$pipewrench$", "pipewrench", "Pipe wrench used by mechanic, left click by vehicles to repair them. Limited uses.", false);
		AddRequirement(s.requirements, "blob", "mat_scrap", "Scrap", 10);
	}
...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	this.set_Vec2f("shop offset", Vec2f(-20,-6));
