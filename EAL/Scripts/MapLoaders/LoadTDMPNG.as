...
bool LoadMap(CMap@ map, const string& in fileName)
{
	...
	int startIndex	= fileName.findLast("/") + 1;
	int endIndex	= fileName.findLast(".");
	int length		= endIndex - startIndex;

	getRules().set_string("mapname", fileName.substr(startIndex, length));
	getRules().Sync("mapname", true);
