...
{
	if (!this.get_bool("scramble"))
	{
		getNet().server_SendMsg("Not scrambling the teams...");
		return;
	}
...
{
	this.set_bool("scramble", true);//initial scramble value
	onRestart(this);
}
...
void onNewPlayerJoin(CRules@ this, CPlayer@ player)
{
	...
	core.ChangePlayerTeam(player, this.getSpectatorTeamNum());//blame jaytlebee
