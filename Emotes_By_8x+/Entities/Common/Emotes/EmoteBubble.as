...
void AddBubblesToMenu(CBlob@ this)
{
	...
	this.AddBubble("", Emotes::mmm);
	this.AddBubble("", Emotes::ohyea);
	this.AddBubble("", Emotes::ooo);
	this.AddBubble("", Emotes::imretarded);
	this.AddBubble("", Emotes::hm);
	this.AddBubble("", Emotes::imretarded1);
	this.AddBubble("", Emotes::imcoolpirate);
	this.AddBubble("", Emotes::FFFFF);

	this.AddBubble("", Emotes::down);
	
	this.AddBubble("", Emotes::yeah);
	this.AddBubble("", Emotes::imretarded2);
	this.AddBubble("", Emotes::ek);
	this.AddBubble("", Emotes::imretarded3);
	this.AddBubble("", Emotes::idea);
	this.AddBubble("", Emotes::keemstar);
	this.AddBubble("", Emotes::cook);
	this.AddBubble("", Emotes::beer);
	this.AddBubble("", Emotes::omg);
