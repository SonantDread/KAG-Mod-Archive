...
void onTick(CBlob@ this)
{
	...
	if(ismyplayer)
	{
		if(!this.hasTag("alternate_mode"))Pickaxe(this);
	...
	if(this.isKeyJustPressed(key_taunts)){
		if(!this.hasTag("alternate_mode"))this.Tag("alternate_mode");
		else this.Untag("alternate_mode");
	}
