...
void AddGameMusic(CBlob@ this, CMixer@ mixer)
{
	...
	switch (XORRandom(4))
	{
		case 0: mixer.AddTrack("../Mods/VolleyBall/Music/Tropical_Holiday.ogg", world_music); break;
		case 1: mixer.AddTrack("../Mods/VolleyBall/Music/DaysGoBy.ogg", 		world_music); break;
		case 2: mixer.AddTrack("../Mods/VolleyBall/Music/HyperParadise.ogg", 	world_music); break;
		case 3: mixer.AddTrack("../Mods/VolleyBall/Music/InTheAirTonight.ogg", 	world_music); break;
	}
}
