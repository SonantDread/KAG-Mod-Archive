...
void onSetTile(CMap@ map, u32 index, TileType tile_new, TileType tile_old)
{
	...
	if(!(map.isTileSolid(tile_new) || isTileCustomSolid(tile_new)))
	{
		CBlob@[] blobs;
		Vec2f pos = map.getTileWorldPosition(index)+Vec2f(map.tilesize/2,-map.tilesize/2);
