...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	else if (customData == Hitters::water_stun || customData == Hitters::water_stun_force)
	{
		//get sponge
		CBlob@ sponge = null;
		{
		...
		bool defended = blockAttack(this, velocity, damage) // shield blocks it
						&& (hitterBlob.getDamageOwnerPlayer() !is this.getPlayer());
