...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$parachute$", "ParachuteIcon.png", Vec2f(32, 16), 0);
	{
		ShopItem@ s = addShopItem(this, "Parachute", "$parachute$", "parachute", "Save the chickens!", false);
		AddRequirement(s.requirements, "coin", "", "Coins", 40);
	}
	{
		ShopItem@ s = addShopItem(this, "Lyrn", "$lyrn$", "lyrn", "Grapples into the ground and heals players and structures around it.", false);
	...
	{
		ShopItem@ s = addShopItem(this, "Floating platform", "$wyvernplatform$", "wyvernplatform", "Floats in the air, can be picked up", false);
