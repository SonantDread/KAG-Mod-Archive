...
void onInit(CBlob@ this)
{
	...
	this.set_f32("map_bomberman_width", 0.0f);
...
void onDie(CBlob @ this){
	...
	if(getNet().isServer()){
		CBlob @minikeg = server_CreateBlob("minikeg",this.getTeamNum(),this.getPosition()+Vec2f(0,-16));
		minikeg.SendCommand(minikeg.getCommandID("activate"));
		minikeg.setVelocity(Vec2f(0,-20));
		minikeg.SetDamageOwnerPlayer(this.getDamageOwnerPlayer());
		
		CBlob @minikeg1 = server_CreateBlob("minikeg",this.getTeamNum(),this.getPosition()+Vec2f(-16,0));
		minikeg1.SendCommand(minikeg.getCommandID("activate"));
		minikeg1.setVelocity(Vec2f(-15,-15));
		minikeg1.SetDamageOwnerPlayer(this.getDamageOwnerPlayer());
		
		CBlob @minikeg2 = server_CreateBlob("minikeg",this.getTeamNum(),this.getPosition()+Vec2f(16,0));
		minikeg2.SendCommand(minikeg.getCommandID("activate"));
		minikeg2.setVelocity(Vec2f(15,-15));
		minikeg2.SetDamageOwnerPlayer(this.getDamageOwnerPlayer());
	}
}