    ...
    if(args.length > 0)
    {
                ...
                {   
                    ...
                    if(createfaction == 0)
                    {
                        ...
                        if(fBase !is null)
                        {
                            ...
                            send_chat(this, player, name + " was created.", SColor(255, 0, 0, 0) ); 
                        }
                        else
                        {
                            send_chat(this, player, name + " could not be created because there is not enough room for the faction base or you are too close to another base.", SColor(255, 0, 0, 0) );
                        }
                    }
                    else if(createfaction == 1)
                    {
                        send_chat(this, player, name + " could not be created because there are too many factions!", SColor(255, 0, 0, 0) );
                    } 
                    else if(createfaction == 2)
                    {
                        send_chat(this, player, name + " could not be created because the name has been taken!", SColor(255, 0, 0, 0) );
                    } 
                }
                else
                {
                    send_chat(this, player, name + " could not be created because you don't have 20 coins, sell more logs to an arms tavern to earn some more.", SColor(255, 0, 0, 0) );
                }       
            }
            else
            {
                send_chat(this, player, "You must leave your faction to do that.", SColor(255, 0, 0, 0) ); 
            }
        }
        else if(args.length > 1 && args[0] == "!invite")
        {
            ...
            if(fact !is null && (fact.leader == player.getUsername() || fact.moderators.find(player.getUsername()) != -1))
            {
                ...
                send_chat(this, player, player_name + " was invited to your faction", SColor(255, 0, 0, 0) );
                send_chat(this, target, "You have been invited to " + fact.name + ", type !join " + fact.name, getTeamColor(fact.team));
        ...
        else if(args[0] == "!join")
        {
            ...
            if(fact !is null)
            {
                ...
                {
                    send_chat(this, player, "You have joined " + fact.name, SColor(255, 0, 0, 0) );
                ...
                {
                    send_chat(this, player, "You were not invited to this faction.", SColor(255, 0, 0, 0) );
                }
            }
            else
            {
                send_chat(this, player, "The faction no longer exists.", SColor(255, 0, 0, 0) );
            }
        }
        else if(args.length > 1 && args[0] == "!kick")
        {
            ...
            if(fact !is null && fact2 !is null && fact2.leader == player.getUsername() && player_name != player.getUsername())
            {
                ...
                send_chat(this, player, player_name + " was kicked from your faction.", SColor(255, 0, 0, 0) );
        ...
        else if(args.length > 1 && args[0] == "!newleader")
        {
            ...
            if(fact !is null && fact.leader == player.getUsername())
            {
                ...
                if(target !is null)
                {
                    ...
                    send_chat(this, target, "You were promoted to leader of your faction.", SColor(255, 0, 0, 0) );

                }
                send_chat(this, player, player_name + " was promoted to leader of your faction.", SColor(255, 0, 0, 0) );
            }
        }
        ...
        else if(args.length > 1 && args[0] == "!promote")
        {
            ...
            {   
                ...
                if(target !is null)
                {
                    ...
                    send_chat(this, target, "You have been promoted to moderator. You can invite other players using !f invite", SColor(255, 0, 0, 0));
                }
                send_chat(this, player, player_name + " was promoted to moderator.", SColor(255, 0, 0, 0) );
            }
        }
        else if(args.length > 1 && args[0] == "!demote")
        {
            ...
            if(fact !is null && fact.leader == player.getUsername())
            {
                ...
                if(target !is null)
                {
                    ...
                    send_chat(this, target, "You have been demoted from moderator. You can no longer invite players.", SColor(255, 0, 0, 0));
                }
                send_chat(this, player, player_name + " was demoted from moderator.", SColor(255, 0, 0, 0) );
            }
        }
        else if(args[0] == "!leave")
        {
            ...
            if(fact !is null)
            {
                ...
                send_chat(this, player, "You have left your faction.", SColor(255, 0, 0, 0) );
                if(blob !is null)
                {  
                    blob.server_Die();
                }
        ...
        else if(args[0] == "!help")
        {
            if(args.length == 1)
            {
                send_chat(this, player, "Welcome to The Hearth Factions!", SColor(255, 255, 0, 0));
                send_chat(this, player, "You start as a peasant, and once you obtain 20 coins you can create a faction.", SColor(255, 255, 0, 0));
            ...
            else if(args.length == 2)
            {
                ...
                if(t == "create")
                {
                    ...
                    send_chat(this, player, "It creates a faction with the given name and spawns a base at your position", SColor(255, 255, 0, 0));
                ...
                else if(t == "invite")
                {
                    ...
                    send_chat(this, player, "It invites a player to your faction with the given name", SColor(255, 255, 0, 0));
                ...
                else if(t == "join")
                {
                    ...
                    send_chat(this, player, "It allows you to join faction with the given name if you have already been invited", SColor(255, 255, 0, 0));
                }
                else if(t == "kick")
                {
                    send_chat(this, player, "Example: !kick makmoud98", SColor(255, 255, 0, 0));
                    send_chat(this, player, "It kicks a player from your faction with the given name", SColor(255, 255, 0, 0));
                    send_chat(this, player, "You need to be the leader of your faction to use this.", SColor(255, 255, 0, 0));
                }
                else if(t == "newleader")
                {
                    send_chat(this, player, "Example: !newleader makmoud98", SColor(255, 255, 0, 0));
                    send_chat(this, player, "It assigns a player that is already in your faction the leader title with the given name", SColor(255, 255, 0, 0));
                    send_chat(this, player, "You need to be the leader of your faction to use this.", SColor(255, 255, 0, 0));
                }
                else if(t == "list")
                {
                    send_chat(this, player, "Example: !list", SColor(255, 255, 0, 0));
                    send_chat(this, player, "It displays a list of all the factions", SColor(255, 255, 0, 0));
                    send_chat(this, player, "Example: '!list The Cool Kids'", SColor(255, 255, 0, 0));
                    send_chat(this, player, "It displays a list of all the players in the faction that is defined by the given name", SColor(255, 255, 0, 0));
                }
                else if(t == "promote")
                {
                    send_chat(this, player, "Example: !promote makmoud98", SColor(255, 255, 0, 0));
                    send_chat(this, player, "It assigns a player that is already in your faction the moderator title with the given name", SColor(255, 255, 0, 0));
                    send_chat(this, player, "You need to be the leader of your faction to use this.", SColor(255, 255, 0, 0));
                }
                else if(t == "demote")
                {
                    send_chat(this, player, "Example: !demote makmoud98", SColor(255, 255, 0, 0));
                    send_chat(this, player, "It demotes a player that is already in your faction from, the moderator title with the given name", SColor(255, 255, 0, 0));
                    send_chat(this, player, "You need to be the leader of your faction to use this.", SColor(255, 255, 0, 0));
                }
            }
        }
...
//this returns the full name of the faction by only typing in part of it
