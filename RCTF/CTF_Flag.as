...
void onRender(CSprite@ this)
{
	...
	if (blob.isAttached())
	{
		...
		if (localBlob is null || getRules().isWarmup()) return;
		
		if (localBlob.getTeamNum() == blob.getTeamNum() && blob.isAttachedToPoint("FLAG"))
		{
			...
			pos.y += deltaY;
			GUI::DrawIcon("GUI/PartyIndicator.png", 2, Vec2f(16, 16), pos, getCamera().targetDistance);
		}
		return;
	}
