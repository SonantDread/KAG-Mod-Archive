...
ShopItem@ addSeedItem( CBlob@ this, const string &in seedName,const string &in  description, u16 timeToMakeSecs, const u16 quantityLimit, CBitStream@ requirements = null )
{
	...
	ShopItem@ item = addProductionItem( this, "warboat", newIcon, "warboat", "", 85, true, 1, requirements );
	return item;
}
...
{
	const string newIcon = "$" + seedName + "$";
	ShopItem@ item = addProductionItem( this, "mounted_bow", newIcon, "mounted_bow", "", 40, true, 1, requirements );
	return item;
}
