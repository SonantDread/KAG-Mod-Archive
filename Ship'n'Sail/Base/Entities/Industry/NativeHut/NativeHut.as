...
ShopItem@ addSeedItem( CBlob@ this, const string &in seedName,const string &in  description, u16 timeToMakeSecs, const u16 quantityLimit, CBitStream@ requirements = null )
{
	...
	ShopItem@ item = addProductionItem( this, "raft", newIcon, "raft", "", 40, true, 1, requirements );
	return item;
}
...
{
	const string newIcon = "$" + seedName + "$";
	ShopItem@ item = addProductionItem( this, "mat_waterarrows", newIcon, "mat_waterarrows", "", 10, false, 2, requirements );
	return item;
}
...
{
	const string newIcon = "$" + seedName + "$";
	ShopItem@ item = addProductionItem( this, "mat_waterbombs", newIcon, "mat_waterbombs", "", 15, false, 2, requirements );
	return item;
}
