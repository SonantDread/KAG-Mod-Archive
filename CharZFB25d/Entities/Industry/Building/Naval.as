...
{	 
	...
	AddIconToken( "$warboatfactory$", "WarboatIcon.png", Vec2f(32,16), 0 );
    AddIconToken( "$sharknursery$", "SharkIcon.png", Vec2f(32,16), 0 );
	AddIconToken( "$boatfactory$", "DinghyIcon.png", Vec2f(32,16), 0 );
	
	this.Tag(SHOP_AUTOCLOSE);
	
	
	{ 
		ShopItem@ s = addShopItem( this, "Shark Nursery", "$sharknursery$", "sharknursery", "Raise sharks" );
