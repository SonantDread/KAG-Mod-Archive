...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$masonshop$", "MasonShop.png", Vec2f(40, 24), 0);
	...
	{
		ShopItem@ s = addShopItem(this, "Mason Shop", "$masonshop$", "masonshop", "To carve some fine stone works");
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 50);
	}
	{
		ShopItem@ s = addShopItem(this, "Rune Shop", "$runeshop$", "runeshop", "Get rune tatoos here.");
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 50);
		AddRequirement(s.requirements, "blob", "mat_gold", "Gold", 50);
	}
}
