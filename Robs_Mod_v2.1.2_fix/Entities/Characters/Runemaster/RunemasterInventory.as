...
void MakeBlocksMenu(CInventory@ this, const Vec2f &in INVENTORY_CE)
{
	...
	Vec2f MENU_SIZE = Vec2f(4, 6);
	
	if(blob.get_u8("build page") == 0)MENU_SIZE = Vec2f(3, 4);
	
	const Vec2f MENU_CE = Vec2f(0, 5 * -GRID_SIZE - GRID_PADDING) + INVENTORY_CE;
