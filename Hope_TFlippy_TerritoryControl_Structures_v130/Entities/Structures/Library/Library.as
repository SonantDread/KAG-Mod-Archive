...
void onInit(CBlob@ this)
{
	...
	}
	{
        ...
        {
		ShopItem@ s = addShopItem(this, "Weapons Blueprint", "$bp_weapons$", "bp_weapons", "The blueprint for special UPF weapon shop.", true);
    ...
    {
        ShopItem@ s = addShopItem(this, "Sell Weapons", "$COIN$", "coin-1250", "Sell blueprint for 1250 coins.");
