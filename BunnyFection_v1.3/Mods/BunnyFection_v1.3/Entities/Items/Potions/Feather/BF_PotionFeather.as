...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
    if (cmd == this.getCommandID("activate"))
    {
		...
		{
			//effect
			carrier.set_u16( "featherEffectTime", getGameTime() + EFFECT_TIME );//set here so drinking another speed potion resets it
			carrier.AddScript( "/BF_PotionFeatherEffect.as" );
