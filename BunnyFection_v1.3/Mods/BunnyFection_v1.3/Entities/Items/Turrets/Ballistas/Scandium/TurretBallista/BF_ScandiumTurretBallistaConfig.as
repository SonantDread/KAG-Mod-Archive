...
{
	this.set_f32( "min_fire_distance", 200.0f );
	...
	this.set_string( "projectile", "bf_scandiumballistaarrow" );
	this.set_f32( "projectile_speed", 15.0f );
	this.set_f32( "projectile_lifetime", 1.5f );
