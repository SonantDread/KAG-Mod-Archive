...
void onInit(CBlob@ this)
{
	...
	this.set_TileType("background tile", CMap::tile_castle_back);
		   		  ...
		   		  // how many physical migrants it needs
...
void onTick(CBlob@ this)
{
	...
	if (getNet().isServer())
	{
		...
		{
			sprite.ReloadSprite("../Mods/BunnyFection/Mods/BunnyFection_v1.3/Entities/Buildings/Townhall/BF_TownhallCapture.png");
		}
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	...
	if (cmd == this.getCommandID(framecmd))
	{
...
void onChangeTeam(CBlob@ this, const int oldTeam)
{
	...
	if (sprite !is null)
	{
		...
		{
		print("yay");
			sprite.ReloadSprite("../Mods/BunnyFection/Mods/BunnyFection_v1.3/Entities/Buildings/Townhall/BF_Townhall.png");
		}
