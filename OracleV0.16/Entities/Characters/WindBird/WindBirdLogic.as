...
void onInit(CBlob@ this)
{
  ...
  this.set_f32("SlashForce",150.0f);
  this.set_f32("SlashDamage",0.25f);
  this.set_f32("SlowFactor",1.0f);
  this.set_u32("ReloadMax",25);
  this.set_f32("Speed",0.8f);
  this.set_u32("Reload2",0);
  this.set_u32("Reload2Max",700);
  this.set_string("AbilityName","Resurrect Skeleton");
}
...
void onTick(CBlob@ this) //This script is called 30 times a second. It's a general update script. Most of your modding will be done here.
{
  ...
  if(this.isKeyPressed(key_action2)&& getKnocked(this) < 1) 
  {
    ...
    {
      CBlob@ slimetrap = server_CreateBlobNoInit("birdskeleton");
      this.getSprite().PlaySound("WindBirdSkeleton.ogg");
      if (slimetrap !is null)
      {
        slimetrap.Init();
        this.set_u32("Exp", this.get_u32("Exp") + 1);
        
        setProfileByBlobName(this);
        ...
        slimetrap.server_SetTimeToDie(15);	
      }
