...
{ 
    ...
    if(getKnocked(this) < 1  && this.get_u32("Reload2") < this.get_u32("Reload2Max") ) 
    {
    ...
    if(getKnocked(this) < 1  && this.get_u32("Reload2") == this.get_u32("Reload2Max") && this.isKeyPressed(key_action2) && !this.isKeyPressed(key_action1))
    {
      ...
      if(getNet().isServer())
      {
        ShootArrow(this, this.getPosition() , this.getAimPos() , 9.0f , 0.5f); 
        ShootArrow(this, this.getPosition() , this.getAimPos() , 9.0f  , 0.5f,14); 
        ShootArrow(this, this.getPosition() , this.getAimPos() , 9.0f  , 0.5f,-14); 
