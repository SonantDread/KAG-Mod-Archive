...
void onInit(CBlob@ this)
{
  ...
  this.set_f32("ArrowForce",11.0f);
  this.set_f32("SlowFactor",0.6f);
  this.set_u32("ReloadMax",32);
  this.set_f32("Speed",0.8f);
  this.set_u32("Reload",0);
  this.Sync("Reload",true);
  
  this.set_string("AbilityName","Fly");
  
  this.set_u32("Fly",0);
  
  this.set_u32("Reload2Max",120);
...
void onTick(CBlob@ this) //This script is called 30 times a second. It's a general update script. Most of your modding will be done here.
{
  ...
  if(this.isKeyJustPressed(key_action2) && this.get_u32("Reload2") >= this.get_u32("Reload2Max"))
  {
    ...
    ShapeConsts@ stuff = shape.getConsts();
    //if(stuff !is null)
    //{
      stuff.mapCollisions = false;
    //}
    this.set_u32("Reload2",0);
  ...
  if(this.get_u32("Fly") > 0)
  {
    this.set_u32("Fly", this.get_u32("Fly") - 1);
