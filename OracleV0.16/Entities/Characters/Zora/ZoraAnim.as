...
{
	addRunnerTextures(this, "zora", "Zora");
...
{
	ensureCorrectRunnerTexture(this, "zora", "Zora");
}
...
void onTick(CSprite@ this)
{
  ...
  const bool gotem = blob.isKeyJustReleased(key_action1);
    ...
    else if (action2 && blob.get_u32("Reload2") > 0)
		{
			this.SetAnimation("invisrun");
		}

		else if (action1  && blob.get_u32("Reload") < 6)
		{
