...
void InitClasses(CBlob@ this)
{
	...
	addPlayerClass(this, "Link", "$knight_class_icon$", "link", "Hack and Slash.");
	addPlayerClass(this, "Ram", "$knight_class_icon$", "ram", "Hack and Slash.");
	addPlayerClass(this, "Slime", "$knight_class_icon$", "slime", "Hack and Slash.");
	addPlayerClass(this, "Fox", "$knight_class_icon$", "fox", "Hack and Slash.");
	addPlayerClass(this, "Ralph", "$archer_class_icon$", "ralph", "The Ranged Advantage.");
	addPlayerClass(this, "Octorock", "$archer_class_icon$", "octorock", "The Ranged Advantage.");
	addPlayerClass(this, "Wizrobe", "$archer_class_icon$", "wizrobe", "The Ranged Advantage.");
	addPlayerClass(this, "Cactus", "$archer_class_icon$", "cactus", "The Ranged Advantage.");
	addPlayerClass(this, "Snake", "$archer_class_icon$", "snake", "The Ranged Advantage.");
}
