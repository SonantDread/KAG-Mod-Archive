// generic character head script, for the MEN heads
...
CSpriteLayer@ LoadHead(CSprite@ this, u8 headIndex)
{
	...
	// add head
	string texname = "Entities/Characters/Sprites/MenHeads.png";// custom men heads
...
void onGib(CSprite@ this)
{
	...
	if (blob !is null && blob.getName() != "bed")
	{
		...
		makeGibParticle("Entities/Characters/Sprites/MenHeads.png",// custom rat heads
