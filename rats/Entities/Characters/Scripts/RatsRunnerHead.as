// generic character head script, for the RAT heads
...
CSpriteLayer@ LoadHead(CSprite@ this, u8 headIndex)
{
	...
	// add head
	string texname = "Entities/Characters/Sprites/RatHeads.png";// custom rat heads
...
void onGib(CSprite@ this)
{
	...
	if (blob !is null && blob.getName() != "bed")
	{
		...
		makeGibParticle("Entities/Characters/Sprites/RatHeads.png",// custom rat heads
