...
{
    if (blobname == "wcrate") {
        return server_MakeSeed( atpos, blobname, 1200, 2, 8 );
    }
    

    return server_MakeSeed( atpos, blobname, 200, 0, 8 );
}
	...
	const string &in  description, u16 timeToMakeSecs, const u16 quantityLimit, CBitStream@ requirements = null )
{
	...
	ShopItem@ item = addProductionItem( this, seedName, newIcon, "wcrate", description, timeToMakeSecs, false, quantityLimit, requirements );
	return item;
}
