...
void onTick(CBlob@ this)
{
	...
	else if (burn_time > 0)
	{
		...
		if ((burn_time % 7) == 0)
		{
			if(!(this.get_s16("empowerfire") > 0))this.server_Hit(this, pos, Vec2f(0, 0), 0.25, this.get_u8(burn_hitter), true);
			else this.server_Hit(this, pos, Vec2f(0, 0), 1, this.get_u8(burn_hitter), true);
		}
