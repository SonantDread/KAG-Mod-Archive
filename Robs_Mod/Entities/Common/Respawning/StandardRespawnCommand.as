...
void InitClasses(CBlob@ this)
{
	...
	//addPlayerClass(this, "Test", "$builder_class_icon$", "samurai", "testing.");
}
		...
		case SpawnCmd::changeClass:
		{
			if (getNet().isServer())
			{
				...
				if (caller !is null && canChangeClass(this, caller))
				{
					...
					if(getGameTime() < 180*getTicksASecond() && caller.getPlayer().getUsername() != "Pirate-Rob" && classconfig != "runemaster")classconfig = "builder";
