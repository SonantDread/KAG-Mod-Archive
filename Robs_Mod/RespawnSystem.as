...
shared class RespawnSystem
{
	...
	CBlob@ SpawnPlayerIntoWorld(Vec2f at, PlayerInfo@ p_info)
	{
		...
		if (player !is null)
		{
			string classconfig = "builder";
			if(getGameTime() > 180*getTicksASecond() || p_info.blob_name == "runemaster")classconfig = p_info.blob_name;
			CBlob @newBlob = server_CreateBlob(classconfig, p_info.team, at);
