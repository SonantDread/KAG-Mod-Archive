                          ...
                          const string &in description)
{
	...
	{
		AddRequirement(item.reqs, "coin", "", "Coins", 100);
...
{
	// build menu
	CreateTradeMenu(trader, Vec2f(3, 4), "Trade");
	...
	addTradeScrollFromScrollDef(trader, "drought", 100, "This magic scroll will evaporate all water in a large surrounding orb.");
