...
void ShowRules()
{
    client_AddToChat("== Welcome to Bananaman's Sandbox ==", titleColor);
    client_AddToChat("* No spamming/greifing.", msgColor);
    client_AddToChat("* No killing others without consent.", msgColor);
    client_AddToChat("* Respect the admins.", msgColor);
