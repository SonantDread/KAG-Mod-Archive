...
void onInit(CBlob@ this)
{
	...
	AddIconToken( "$tunic_$", "TraverlersTunic.png", Vec2f(32,32), 0);
	...
	{
		ShopItem@ s = addShopItem(this, "Platium Bow", "$platiumbow_$", "platiumbow", "A bow made of platinum. x2 dmg", false);
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 200);
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 350);
	}
	{
