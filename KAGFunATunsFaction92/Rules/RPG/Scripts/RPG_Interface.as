...
void onInit(CRules@ this)
{
        ...
        this.set_CBitStream("rpg_serialised_team_hud", stream);
}
...
void onRenderScoreboard(CRules@ this)
{
        ...
        for (u32 i = 0; i < sortedplayers.length; i++)
        {
                ...
                {      
                        GUI::DrawPane(Vec2f(topleft.x+16, topleft.y-1), Vec2f(bottomright.x, bottomright.y+2), SColor(getTeamColor(p.getBlob().getTeamNum())) );
                }
