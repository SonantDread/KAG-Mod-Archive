...
void onInit(CBlob@ this)
{
	...
	Vehicle_Setup(this,
	              65.0f, // move speed
	              0.22f,  // turn speed
	              Vec2f(0.0f, 0.54f), // jump out velocity
	...
	Vehicle_SetupWeapon(this, v,
	                    ...
	                    "bullet", // bullet config name   //ballista_bolt
	                    "HeavyMachineGunShoot", // fire sound
	...
	Vehicle_SetupGroundSound(this, v, "TankEngine",  // movement sound
	                         0.6f, // movement sound volume modifier   0.0f = no manipulation
	                         -0.9f // movement sound pitch modifier     0.0f = no manipulation
	                        );
				...
				if (local !is null)
				{
					...
					if (front !is null)
					{
						...
						{	
							...
							arm.RotateBy(angle, Vec2f(-0.5f, 15.5f));
							arm.SetOffset(Vec2f(-2.0f, -27.0f));   //10.0f, -6.0f
						}
					}
				}
			}
