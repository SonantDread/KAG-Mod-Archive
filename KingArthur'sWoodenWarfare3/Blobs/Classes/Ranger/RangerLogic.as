...
void ClientFire(CBlob@ this, const s8 charge_time, const bool hasarrow, const u8 arrow_type, const bool legolas)
{
	...
	{
		ShootArrow(this, this.getPosition() + Vec2f(this.isFacingLeft() ? -5.0f : 5.0f, -0.0f), this.getAimPos() + Vec2f(-14.0f + XORRandom(28), -16.0f + XORRandom(28)), ArcherParams::shoot_max_vel*1.6f, ArrowType::normal, legolas);
	}
}
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	if (cmd == this.getCommandID("shoot arrow"))
	{
		...
		this.getSprite().PlaySound("RifleFire.ogg");
