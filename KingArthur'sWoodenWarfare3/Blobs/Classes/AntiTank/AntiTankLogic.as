...
void ClientFire(CBlob@ this, const s8 charge_time, const bool hasarrow, const u8 arrow_type, const bool legolas)
{
	...
	{
		ShootArrow(this, this.getPosition() + Vec2f(this.isFacingLeft() ? -4.0f : 4.0f, -1.0f), this.getAimPos() + Vec2f(-4.0f + XORRandom(8), -6.0f + XORRandom(8)), ArcherParams::shoot_max_vel*1.6f, ArrowType::normal, legolas);
	}
}
