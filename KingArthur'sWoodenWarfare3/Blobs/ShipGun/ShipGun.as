...
void onInit(CBlob@ this)
{
	Vehicle_Setup(this,
	              0.0f, // move speed
	              0.1f,  // turn speed
	              Vec2f(0.0f, -0.5f), // jump out velocity
	...
	Vehicle_SetupWeapon(this, v,
	                    ...
	                    "btrshell", // bullet config name
	                    "SniperFire", // fire sound
...
void Vehicle_onFire(CBlob@ this, VehicleInfo@ v, CBlob@ bullet, const u8 _unused)
{
	if (bullet !is null)
	{
		...
		angle += ((XORRandom(512) - 256) / 62.0f);

		Vec2f vel = Vec2f(540.0f / 16.0f * (this.isFacingLeft() ? -1 : 1), 0.0f).RotateBy(angle);
