...
void onInit(CBlob@ this)
{
	...
	this.getShape().SetOffset(Vec2f(-6, 14));
...
{
	if (this.getMap().isInWater(this.getPosition() + Vec2f(0.0f, 13.0f)))
	{
		this.AddForce(Vec2f(0, -1900.0f));
	}
	else
	{
