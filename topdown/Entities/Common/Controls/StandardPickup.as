...
void onTick(CBlob@ this)
{
	...
	u32 throwcharge = this.get_u32("throwcharge");
	bool chargingthrow = this.get_bool("chargingthrow");
	...
	*/
	...
	{
		//print(""+throwcharge);
		if(this.isKeyPressed(key_pickup) && !chargingthrow)
		{
			this.set_bool("chargingthrow", true);
		}

		if(!this.isKeyPressed(key_pickup) && chargingthrow)
		{
			this.set_bool("chargingthrow", false);
			throwcharge = 0;
			ClearPickupBlobs(this);
			client_SendThrowCommand(this);
			this.set_bool("release click", false);
		...
		if(this.isKeyPressed(key_pickup) && chargingthrow && throwcharge < 50)
		{
			throwcharge++;
		}
	...
	this.set_u32("throwcharge", throwcharge);
}
