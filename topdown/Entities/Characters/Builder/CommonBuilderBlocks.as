...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks)
{
  ...
  }
  {
	...
	if(SBX)
	{
		...
		{
			AddIconToken( "$colorlamp$", "ColorLamp.png", Vec2f(8,8), 1);
    ...
    {
		AddIconToken( "$healer$", "Healer.png", Vec2f(8,8), 1);
		BuildBlock b(0, "healer", "$healer$", "Healer\nHeals and repairs nearby blobs");
		blocks[3].push_back(b);
    }   
    ...
    {
		AddIconToken( "$window$", "Window.png", Vec2f(16,16), 0);
		BuildBlock b(0, "window", "$window$", "Window\nwork in progress");
		blocks[5].push_back(b);
    }       	
    {
		AddIconToken( "$metalladder$", "MetalLadder.png", Vec2f(16,24), 0);
		BuildBlock b(0, "metalladder", "$metalladder$", "Metal Ladder");
		blocks[5].push_back(b);
	}/*
    {
		AddIconToken( "$metal1$", "MetalBlock.png", Vec2f(8,8), 0);
		BuildBlock b(0, "metal1", "$metal1$", "Metal Block 1");
		blocks[5].push_back(b);
	}    */
	{
		AddIconToken( "$metal2$", "MetalBlock2.png", Vec2f(8,8), 0);
		BuildBlock b(0, "metal2", "$metal2$", "Metal Block 2");
		blocks[5].push_back(b);
	}
	{
		AddIconToken( "$metal_door$", "MetalDoor.png", Vec2f(16,8), 0);
		BuildBlock b(0, "metal_door", "$metal_door$", "Metal Door");
		blocks[5].push_back(b);
	}
	{
		AddIconToken( "$sentry$", "Sentry.png", Vec2f(16,16), 3);
		BuildBlock b(0, "sentry", "$sentry$", "Sentry Gun\nLight turret to keep the infantry away");
		blocks[5].push_back(b);
	}
   /* {
		AddIconToken( "$emitter2$", "Emitter2.png", Vec2f(16,16), 1);
		BuildBlock b(0, "emitter2", "$emitter2$", "Radial Emitter");
		blocks[5].push_back(b);
    }

    {
		AddIconToken( "$receiver2$", "Receiver2.png", Vec2f(16,16), 1);
		BuildBlock b(0, "receiver2", "$receiver2$", "Radial Receiver");
		blocks[5].push_back(b);
    }*/
	}
}
