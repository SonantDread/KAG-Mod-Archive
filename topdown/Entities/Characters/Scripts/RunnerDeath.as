...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	{	
		this.set_s32("llt", (5+XORRandom(90))*(XORRandom(20) > 10 ? 1 : -1));
		this.set_s32("lft", (5+XORRandom(90))*(XORRandom(20) > 10 ? 1 : -1));

		this.set_s32("rlt", (5+XORRandom(90))*(XORRandom(20) > 10 ? 1 : -1));
		this.set_s32("rft", (5+XORRandom(90))*(XORRandom(20) > 10 ? 1 : -1));

		this.set_s32("lat", (5+XORRandom(90))*(XORRandom(20) > 10 ? 1 : -1));
		this.set_s32("rat", (5+XORRandom(90))*(XORRandom(20) > 10 ? 1 : -1));

		this.set_s32("lht", (5+XORRandom(90))*(XORRandom(20) > 10 ? 1 : -1));
		this.set_s32("rht", (5+XORRandom(90))*(XORRandom(20) > 10 ? 1 : -1));


		f32 torque = -500 + XORRandom(500);
