...
#include "ExpensiveZonePlacement.as"
...
void Pickaxe(CBlob@ this)
{
	...
	bool strikeAnim = sprite.isAnimation("strike") || sprite.isAnimation("strike_fast") || sprite.isAnimation("chop") || sprite.isAnimation("chop_fast") || sprite.isAnimation("strike_very_fast") || sprite.isAnimation("chop_very_fast");
    ...
    if (detached.hasTag("temp blob"))
    {
        ...
        if (i >= 0 && i < blocks[PAGE].length)
        {
            ...
            if (b.name == detached.getName())
            {
                ...
                CBitStream requirements; get_maybe_expensive_zone_requirements(this, b.reqs, false, requirements);
