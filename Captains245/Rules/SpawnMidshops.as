void onInit( CMap@ this )
{
        ...
        if (block_width % 2 == 0)
        {
            ...
            //CBlob@ midshop = spawnBlob(map, "midshop6", offset, team);
            ...
            if(top_exists && bottom_exists)
            {
                ...
                {
                    //printf("t1");
                    CBlob@ midshop = server_CreateBlob("midshop6", -1, midshop_pos_bottom);
                ...
                else if(distance_top < distance_bottom)
                {
                    ...
                    CBlob@ midshop = server_CreateBlob("midshop6", -1, midshop_pos_top);
                    midshop.getShape().SetStatic(true);
                }
                else
                {
        ...
        else
        {
            ...
            if(top_exists && bottom_exists)
            {
                ...
                {
                    printf("t1");
                    CBlob@ midshop = server_CreateBlob("midshop5", -1, midshop_pos_bottom);
                    midshop.getShape().SetStatic(true);
                }
                else if(distance_top < distance_bottom)
                {
                    printf("t2");
                    printf("midshop_pos_top: " + midshop_pos_top.x + ", " + midshop_pos_top.y);
                    CBlob@ midshop = server_CreateBlob("midshop5", -1, midshop_pos_top);
                    midshop.getShape().SetStatic(true);
                }
                else
                {
