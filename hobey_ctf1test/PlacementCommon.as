...
const f32 MAX_BUILD_LENGTH_WARMUP = 9.0f;
...
void SetTileAimpos(CBlob@ this, BlockCursor@ bc)
{
    ...
    const f32 maxLen = getRules().isWarmup() ? MAX_BUILD_LENGTH_WARMUP : MAX_BUILD_LENGTH;
    mouseNorm /= mouseLen;
...
{
    float maxLen = getRules().isWarmup() ? MAX_BUILD_LENGTH_WARMUP : MAX_BUILD_LENGTH;
    return (maxLen + 0.51f) * getMap().tilesize;
}
