...
shared class CTFCore : RulesCore
{
    ...
    void AddPlayer(CPlayer@ player, u8 team = 0, string default_config = "")
    {
        ...
        string class_name = "knight";
        if (getRules().isWarmup()) class_name = "builder";
        CTFPlayerInfo p(player.getUsername(), team, class_name);
...
{
    Reset(this);
    this.set_s32("restart_rules_after_game_time", 20 * 30);
}
