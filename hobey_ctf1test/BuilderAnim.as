    ...
    if (!blob.hasTag(burning_tag)) //give way to burning anim
    {
        ...
        else if (blob.hasTag("seated"))
        {
            ...
            if (getRules().isWarmup()) {
                bool start_of_animation = this.animation.name != "strike";
                this.SetAnimation("strike");
                if (start_of_animation) {
                    this.animation.frame = 5;
                }
                // this.SetAnimation("strike_fast");
            } else {
                this.SetAnimation("strike");
            }
        } else if (this.isAnimation("strike")      && !this.isAnimationEnded()) { this.SetAnimation("strike");
            // } else if (this.isAnimation("strike_fast") && !this.isAnimationEnded()) { this.SetAnimation("strike_fast");
        }
...
void onRender(CSprite@ this)
{
    ...
    if (blob.isKeyPressed(key_action1) || this.isAnimation("strike") /*|| this.isAnimation("strike_fast")*/)
    {
