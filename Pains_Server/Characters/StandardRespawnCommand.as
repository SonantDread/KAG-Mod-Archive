...
void InitClasses(CBlob@ this)
{
	...
	AddIconToken("$hoplite_class_icon$", "GUI/MenuItems.png", Vec2f(32, 32), 32);
	...
	addPlayerClass(this, "Hoplite", "$hoplite_class_icon$", "hoplite", "Its hammer time!.");
	addPlayerClass(this, "Crusher", "$crusher_class_icon$", "crusher", "not done.");
}
