...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks)
{
	...
	for(int i = 0; i < 20;i+=1){
		...
		blocks.push_back(page_1);
		{
			...
			AddRequirement(b.reqs, "blob", "mat_stone", "Stone", 5);
			if(getRuneCodeName(i) == "witness")AddRequirement(b.reqs, "blob", "mat_gold", "Gold", 9999);
			else if(getRuneCodeName(i) == "curse") AddRequirement(b.reqs, "blob", "mat_gold", "Gold", 9999);
