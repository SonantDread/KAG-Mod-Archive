...
const string[] descriptions =
{
	...
	/* 61  */               "Arrows that heal you and your friends :)",         // heartarrows
	/* 62  */               "Arrows that pierce through doors, platforms and trap blocks (fuck tunnelers)",         // piercing arrows
	/* 63 */ 				"Freeze plebs"						//frost arrows
};
