...
void onInit(CRules@ this)
{
	...
	AddIconToken("$FrostArrows$", "Entities/Characters/Archer/ArcherIcons.png", Vec2f(16, 32), 6);
	...
	AddIconToken("$mat_heartarrows1$", "MoreMaterials.png", Vec2f(16, 16), 0);
	AddIconToken("$mat_piercingarrows1$", "MoreMaterials.png", Vec2f(16, 16), 1);
	AddIconToken("$mat_frostarrows1$", "MoreMaterials.png", Vec2f(16, 16), 2);
}
