...
void InitClasses(CBlob@ this)
{
	...
	addPlayerClass(this, "Character", "$change_class$", "character", "A base class."); //This is where I added template class. The first string is a pretty name for the menu. The second is the token name. The third is the actual name for your class/blob. The fifth is dumb.
}
