...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	{
		caller.CreateGenericButton( 15, Vec2f(0,-20), this, this.getCommandID("repair"), "Repair " + name, params );
	}
	else
	{
		CButton@ repairBtn = caller.CreateGenericButton( 15, Vec2f(0,-20), this, 0, "Repair " + name + ": Requires "+repairCosts+" " + matName );
