...
void onDie(CBlob@ this)
{
	if (getNet().isServer())
	{
		for (int i = 0; i < meteor_necro(); i++)
		{
			CBlob@ necromancer = server_CreateBlob( "necromancer", 3, this.getPosition());
            if (necromancer !is null) {
                necromancer.setVelocity(Vec2f(XORRandom(8)-2.5f,XORRandom(8)-2.5f));
                necromancer.AddScript( "DropGold.as" );
            }
		}
	}
