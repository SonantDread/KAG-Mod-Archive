...
{
	/* 00  */               "",
	/* 01  */               "Bombs for FIGHTER only.",   // bomb
	/* 02  */               "Something's familliar with these blades...",         // arrows
	/* 03  */               "",                     //
	/* 04  */               "Highly explosive powder keg for FIGHTER only.",                  // keg
	...
	/* 09  */               "Lanterns for lighting caves up. And maybe your mood too.",                         // lantern
	...
	/* 17  */               "A purple mushroom used to throw these at you.", // boulder
	...
	/* 31  */               "A stationary projectile-firing death machine.", // mounted_bow
	/* 32  */               "Fire Combusting Projectiles can be used to set wooden structures on fire.", // fire arrows
	...
	/* 41  */               "Barracks allow changing class to Thrower or Fighter.", //  barracks
	/* 42  */               "A storage than can hold materials and items and share them with other storages.", //  storage
	/* 43  */               "A mining drill. Increases speed of digging and gathering resources, but gains only half the possible resources.\nCan only be used by builders.", //  drill
	/* 44  */               "Bombs for fighters & projectiles for throwers.\nAutomatically distributed on respawn.", //  military basics
	...
	/* 50  */               "Water capsules for the Thrower. These capsules used to store hearts...",         // water arrows
	/* 51  */               "You can throw them?",         // bomb arrows
	/* 52  */               "Water bomb for FIGHTER. Can extinguish fires and stun enemies.",         // water bomb
	...
	/* 55  */               "Fighter workshop for building explosives and changing class to Fighter",         // knightshop
	/* 56  */               "Thrower workshop for making stuff that you can throw and changing class to Thrower",         // archershop
