...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "King's Throwing Swords", "$mat_arrows$", "mat_arrows", descriptions[2], true);
	...
	{
		ShopItem@ s = addShopItem(this, "Rockets", "$mat_bombarrows$", "mat_bombarrows", descriptions[51], true);
