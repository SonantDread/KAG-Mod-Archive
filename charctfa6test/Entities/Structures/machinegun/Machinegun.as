...
void onInit(CBlob@ this)
{
	...
	Vehicle_SetupWeapon(this, v,
	                    ...
	                    "mat_bolterarrows", // bullet ammo config name
	                    "arrowAPC", // bullet config name
	                    "BowFire", // fire sound
	...
	this.set_string("autograb blob", "mat_bolterarrows");
	...
	if (getNet().isServer())
	{
		CBlob@ ammo = server_CreateBlob("mat_bolterarrows");
		if (ammo !is null)
		{
