...
void onTick(CBlob@ this)
{
	...
	if (this.getMap().getBlobsInRadius(this.getPosition(), this.getRadius() * 3.0f, @blobs))
	{
		for (int i = 0; i < blobs.length; i++)
		{
			...
			{
				CBlob@ blob = blobs[i];
				if (blob.hasTag("player")) blob.server_SetHealth(Maths::Min(blob.getHealth() + 0.125f, blob.getInitialHealth()));
			}
		}
	}
