...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	if (this.isOverlapping(caller) && this.hasTag("travel tunnel") && this.getTeamNum() == caller.getTeamNum())
	{
...
{
	if (tunnel.getName() == "fortress") return "$TRAVEL_FORTRESS$";
