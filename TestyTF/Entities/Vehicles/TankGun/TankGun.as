...
void onInit(CBlob@ this)
{
	...
	Vehicle_SetupWeapon(this, v,
	                    ...
	                    "TankGun_Shoot_Single", // fire sound
	                    "EmptyFire" // empty fire sound
	                   );
	v.charge = 400;
	// init arm + cage sprites
	CSprite@ sprite = this.getSprite();
	CSpriteLayer@ arm = sprite.addSpriteLayer("arm", "TankGun_Top.png", 40, 16);
...
void Vehicle_onFire(CBlob@ this, VehicleInfo@ v, CBlob@ bullet, const u8 _unused)
{
	...
	if (getNet().isClient())
	{
		...
		ShakeScreen(64, 10, this.getPosition());	
		
		// CSprite@ sprite = this.getSprite();
		// sprite.SetEmitSound("/TankGun_Shoot.ogg");
	...
	if (getNet().isServer())
	{
		...
		if (mapHit)
		{
			...
			{
				map.server_DestroyTile(hitPos, damage * 1.50f);
			}
		}
	}
