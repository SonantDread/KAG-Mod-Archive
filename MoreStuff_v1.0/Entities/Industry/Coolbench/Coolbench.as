...
void InitWorkshop(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Amphibian", "$Amphibian$", "Amphibian", "Amphibian act like boat and car\nat the same time!", false);
...
void onInit(CSprite@ this)
{
	...
	CSpriteLayer@ planks = this.addSpriteLayer("planks", this.getFilename() , 32, 32, blob.getTeamNum(), blob.getSkinNum());

	if (planks !is null)
	{
		Animation@ anim = planks.addAnimation("default", 0, false);
		anim.AddFrame(1);
		planks.SetOffset(Vec2f(0, -8.0f));
