...
void onInit(CBlob@ this)
{
	...
	this.push("names to activate", "clusterkeg");
...
void onTick(CBlob@ this)
{
	         ...
	         (pressed_a2 || (specialShieldState)))
	{
		...
		if (this.hasBlob("glassvial", 1))
		{
			this.TakeBlob("glassvial", 1);
			
			if (this.isMyPlayer() && !this.wasKeyPressed(key_action1))   // playing annoying no ammo sound
			{
