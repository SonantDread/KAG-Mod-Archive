...
void onInit(CBlob@ this)
{
	...
	this.server_setTeamNum(14); //seperate team
	...
	this.getCurrentScript().runProximityRadius = 50.0f;
...
void onDie(CBlob@ this)
{
	if(getNet().isServer())
	{
		...
		server_CreateBlob("rawmeat",-1,this.getPosition());
		server_CreateBlob("beasthorn",-1,this.getPosition());
		server_CreateBlob("beasthorn",-1,this.getPosition());
	}
}
