             ...
             const bool bother_raycasting = true, const bool should_teamkill = false)
{
	...
	this.server_Hit(hit_blob, hit_blob_pos,
					...
					hit_blob.hasTag("explosion always teamkill")) && !(hit_blob.hasTag("ignorekegs")) // check for override with tag
	               );
	return true;
}
