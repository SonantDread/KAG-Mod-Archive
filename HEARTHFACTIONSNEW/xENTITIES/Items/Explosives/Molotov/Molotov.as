...
void ExplodeWithFire(CBlob@ this)
{
    ...
    {
        map.server_setFireWorldspace(Vec2f(this.getPosition().x, this.getPosition().y + ((XORRandom(3)) * 8)), true);
        map.server_setFireWorldspace(Vec2f(this.getPosition().x, this.getPosition().y - ((XORRandom(3)) * 8)), true);
        map.server_setFireWorldspace(Vec2f(this.getPosition().x + ((XORRandom(3)) * 8), this.getPosition().y), true);
        map.server_setFireWorldspace(Vec2f(this.getPosition().x - ((XORRandom(3)) * 8), this.getPosition().y), true);
        map.server_setFireWorldspace(Vec2f(this.getPosition().x + ((XORRandom(3)) * 8), this.getPosition().y + ((XORRandom(3)) * 8)), true);
        map.server_setFireWorldspace(Vec2f(this.getPosition().x - ((XORRandom(3)) * 8), this.getPosition().y - ((XORRandom(3)) * 8)), true);
        map.server_setFireWorldspace(Vec2f(this.getPosition().x + ((XORRandom(3)) * 8), this.getPosition().y - ((XORRandom(3)) * 8)), true);
        map.server_setFireWorldspace(Vec2f(this.getPosition().x - ((XORRandom(3)) * 8), this.getPosition().y + ((XORRandom(3)) * 8)), true);
