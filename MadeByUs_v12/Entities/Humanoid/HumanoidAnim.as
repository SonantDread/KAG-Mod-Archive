...
Vec2f DefaultMainArmOffset = Vec2f(2.0f, -2.5f);
Vec2f DefaultSubArmOffset = Vec2f(-3.0f, -2.5f);
Vec2f DefaultFrontLegOffset = Vec2f(1.0f, -1.0f);
Vec2f DefaultBackLegOffset = Vec2f(2.0f, -1.0f);
...
void onTick(CSprite@ this)
{
	...
	if(LyingDown){
		canUseArms = false;
		setAimValues(this.getSpriteLayer("frontarm"), mainarmvisible, 0, Vec2f(0, 0), "default");
		this.getSpriteLayer("frontarm").SetOffset(Vec2f(-3,5.5f));
		
		setAimValues(this.getSpriteLayer("backarm"), subarmvisible, 0, Vec2f(0, 0), "default");
	...
	if(canUseArms){
		...
		if(aimingMain){
			...
			setAimValues(this.getSpriteLayer("frontarm"), mainarmvisible, Down, Vec2f(0, 0), "broken");
		}
		if(aimingSub){
			...
			setAimValues(this.getSpriteLayer("backarm"), mainarmvisible, Down, Vec2f(0, 0), "broken");
		}
		...
		if(mainpickaxing){
			setAimValues(this.getSpriteLayer("frontarm"), mainarmvisible, angle-70*inverse+mainpickaxe_drawback*inverse*15, Vec2f(0, 0), "stretch");
			setAimValues(this.getSpriteLayer("mainpick"), true, angle-70*inverse+mainpickaxe_drawback*inverse*15, Vec2f(0, 0), "default");
			this.getSpriteLayer("mainpick").SetOffset(MainArmOffset);
		} else setAimValues(this.getSpriteLayer("mainpick"), false, 0, Vec2f(0, 0), "default");
		
		if(subpickaxing){
			setAimValues(this.getSpriteLayer("backarm"), subarmvisible, angle-70*inverse+subpickaxe_drawback*inverse*15, Vec2f(0, 0), "stretch");
			setAimValues(this.getSpriteLayer("subpick"), true, angle-70*inverse+subpickaxe_drawback*inverse*15, Vec2f(0, 0), "default");
			this.getSpriteLayer("subpick").SetOffset(SubArmOffset);
		} else setAimValues(this.getSpriteLayer("subpick"), false, 0, Vec2f(0, 0), "default");
