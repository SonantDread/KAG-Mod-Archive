void ManageAxe(CBlob @this, bool holding, string type){
	...
	if(getEquippedBlob(this,type+"_arm") !is null){
		if(getEquippedBlob(this,type+"_arm").getName() == "axe")damage = 4.0f;
		if(getEquippedBlob(this,type+"_arm").getName() == "hachet")damage = 2.5f;
	}
