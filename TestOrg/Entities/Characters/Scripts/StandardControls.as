...
void ManageCamera(CBlob@ this)
{
	...
	bool binoculars = carried !is null && carried.exists("scope_zoom"); // carried.getName() == "binoculars";
	...
	// camera
	camera.mouseFactor = 0.5f + (binoculars ? carried.get_f32("scope_zoom") : 0.00f); // doesn't affect soldat cam
