...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Fragmentation Grenade (1)", "$icon_fraggrenade$", "mat_fraggrenade-1", "A small hand grenade, especially useful against infantry. Thanks to low block damage, it's quite useful for interior usage.");
		AddRequirement(s.requirements, "coin", "", "Coins", 75);
		AddRequirement(s.requirements, "blob", "mat_sulphur", "Sulphur", 25);
