...
void onInit(CBlob@ this)
{
...

	{
		...
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", CTFCosts::quarry_stone*2);
		AddRequirement(s.requirements, "blob", "mat_gold", "Gold", CTFCosts::quarry_gold*2);
	}
	AddIconToken("$barracks__icon$", "Barracks.png", Vec2f(40, 24), 0);
	{
		ShopItem@ s = addShopItem(this, "Barracks", "$barracks__icon$", "barracks", "A place to swap classes");
