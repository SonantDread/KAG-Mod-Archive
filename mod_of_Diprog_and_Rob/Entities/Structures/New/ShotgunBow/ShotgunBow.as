...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if (caller.isAttached())
	{
		if (fireBullets != 7) 
		{ 
			caller.CreateGenericButton( 5, Vec2f(0.0,-4.0), this, this.getCommandID("add arrow"), "+1 arrows. " + fireBullets + " arrows are set", params ); 
		}
		else if (fireBullets == 7)
		{
			CButton@ button = caller.CreateGenericButton( 5, Vec2f(0,-4.0), this, 0, "Max arrows count is 7. You can't add more." );
			if (button !is null) button.SetEnabled( false );
		}
	
		if(fireBullets != 1) { caller.CreateGenericButton( 4, Vec2f(0.0,4.0), this, this.getCommandID("remove arrow"), "-1 arrow. Now " + fireBullets + " arrows are set", params ); }
		else if (fireBullets == 7)
		{
			CButton@ button = caller.CreateGenericButton( 5, Vec2f(0,-4.0), this, 0, "Min arrows count is 1. You can't subtract any more." );
			if (button !is null) button.SetEnabled( false );
		}
	}
}
