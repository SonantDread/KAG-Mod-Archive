...
{	 
	...
	AddIconToken( "$MegaLantern$", "MgLntrn.png", Vec2f(8,12), 1 );
	AddIconToken( "$DivingHelmet$", "DivingHelmet.png", Vec2f(12,14), 0 );
	AddIconToken( "$Chainsaw$", "Chainsaw.png", Vec2f(32,16), 0 );
	...
	{	 
		ShopItem@ s = addShopItem( this, "Chainsaw", "$Chainsaw$", "chainsaw",  "Used to cut wood.", false );
	...
	{	 
		ShopItem@ s = addShopItem( this, "Arrows", "$mat_arrows$", "mat_arrows", "Craft arrows.", false );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 100 );
	}
	{	 
		ShopItem@ s = addShopItem( this, "Mega Lantern", "$MegaLantern$", "mega_lantern", "Large light radius.", false );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 75 );
	}
	{	 
		ShopItem@ s = addShopItem( this, "Diving Helmet", "$DivingHelmet$", "divinghelmet", "Breath under water.", false );
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 200 );
	}
	{	 
		ShopItem@ s = addShopItem( this, "Mega Sponge", "$mega_sponge$", "mega_sponge",  descriptions[53], false );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", COST_WOOD_SPONGE + 100 );
	}
	this.set_string("required class", "builder");
}
