...
void InitBarracksClasses( CBlob@ this )
{
    ...
    addBarracksPlayerClass(this, "Paladin", "$paladin_class_icon$", "paladin", "Holy crusher.");
    addBarracksPlayerClass(this, "Priest", "$priest_class_icon$", "priest", "Holy smiter.");
    addBarracksPlayerClass(this, "Samurai", "$samurai_class_icon$", "samurai", "The slash and fly.");
    addBarracksPlayerClass(this, "Gravity Charmer", "$mindman_class_icon$", "mindman", "The hover and float.");
    addBarracksPlayerClass(this, "Shadow Master", "$shadowman_class_icon$", "shadowman", "The phase and stab.");
    addBarracksPlayerClass(this, "Rune Scribe", "$runescribe_class_icon$", "runescribe", "The write and spell.");
}
