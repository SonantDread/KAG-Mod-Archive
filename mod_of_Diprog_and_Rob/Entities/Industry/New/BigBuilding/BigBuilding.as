...
{	 
	...
	AddIconToken( "$ZombieAltar$", "ZombieAltar.png", Vec2f(40,35), 0 );
	
	this.Tag(SHOP_AUTOCLOSE);
	{
		ShopItem@ s = addShopItem( this, "Animal Shop", "$AnimalShop$", "animalshop", "Buy animals." );
	...
	{
		ShopItem@ s = addShopItem( this, "Fighters Shop", "$FightersShop$", "fightersshop", "Buy strong NPC!" );
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 150 );
	}
	{
		ShopItem@ s = addShopItem( this, "Zombie Altar", "$ZombieAltar$", "zombiealtar", "Corpse = zombie" );
