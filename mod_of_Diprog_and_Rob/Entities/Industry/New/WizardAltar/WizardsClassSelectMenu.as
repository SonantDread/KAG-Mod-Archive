...
void addWizardAltarPlayerClass( CBlob@ this, string name, string iconName, string configFilename, string description, string ITEM, string ITEMDESC )
{
    if (!this.exists("wizardaltarplayerclasses"))
    {
        NewPlayerClass[] classes;
        this.set( "wizardaltarplayerclasses", classes );
    }
    ...
    this.push("wizardaltarplayerclasses", p);
}

//helper for building menus of classes

void addWizardAltarClassesToMenu(CBlob@ this, CGridMenu@ menu, u16 callerID)
{
    NewPlayerClass[]@ classes;
...
NewPlayerClass@ getWizardAltarDefaultClass(CBlob@ this)
{
    NewPlayerClass[]@ classes;
