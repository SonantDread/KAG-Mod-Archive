...
void AddBubblesToMenu( CBlob@ this )
{
	...
	this.AddBubble( "", Emotes::castle );	
	this.AddBubble( "yes", Emotes::yes );	
	this.AddBubble( "no", Emotes::no );	
	this.AddBubble( "", Emotes::tease );	
	this.AddBubble( "", Emotes::teased );	
	this.AddBubble( "", Emotes::gold );	
	this.AddBubble( "", Emotes::afk );	
