...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks)
{
	...
	{   // stone platform
		BuildBlock b( 0, "stone_platform", "$stone_platform$", "Stone Platform\nStronger than Wooden Platform" );
	...
	{   // steel block
		BuildBlock b( 0, "steel_block", "$steel_block$", "Steel Block\nThe strongest block" );
	...
	{   // back_wood_block
		...
		AddRequirement( b.reqs, "blob", "mat_wood", "Back Wood Wall\nCheap extra support", 1 );
		blocks[0].push_back( b );
	}
	{   // wooden_door
	...
	/*{   // wooden_door
		BuildBlock b( 0, "alpha_door", "$alpha_door$", "Alpha Door\nCheap door" );
		AddRequirement( b.reqs, "blob", "mat_wood", "Wood", 25 );
		blocks[0].push_back( b );
	}*/
	{   // wooden spikes
	...
	{   // wooden trap
		BuildBlock b( 0, "wooden_trap_block", "$wooden_trap_block$", "Wooden Trap Block\nCheap Trap Block" );
		AddRequirement( b.reqs, "blob", "mat_wood", "Wood", 15 );
		blocks[0].push_back( b );
	}
	...
	{   // platform
		BuildBlock b( 0, "teamcolored_wooden_platform", "$teamcolored_wooden_platform$", "Team Colored Wooden Platform\nUnbrekable by teammates" );
		AddRequirement( b.reqs, "blob", "mat_wood", "Wood", 50 );
		blocks[0].push_back( b );
	}
	{   // lamp block
		BuildBlock b( 0, "lamp_block", "$lamp_block$", "Lamp Block\nMakes light, can be disabled/enabled" );
		AddRequirement( b.reqs, "blob", "mat_wood", "Wood", 20 );
		blocks[0].push_back( b );
	}
	{   // fire trap block
		BuildBlock b( 0, "fire_trap_block", "$fire_trap_block$", "Fire Trap Block\nFires wooden structures and enemies" );
	...
	{   // gold block
		BuildBlock b( 0, "gold_block", "$gold_block$", "Gold Nugget\nCompressed gold, gives gold on hit" );
		AddRequirement( b.reqs, "blob", "mat_gold", "Gold", 20 );
		blocks[0].push_back( b );
	}
	{   // triangle wood
		BuildBlock b( 0, "triangle_wood_block", "$triangle_wood_block$", "Triangle Wood" );
		AddRequirement( b.reqs, "blob", "mat_wood", "Wood", 5 );
		blocks[0].push_back( b );
	}
	{   // triangle stone
		BuildBlock b( 0, "triangle_stone_block", "$triangle_stone_block$", "Triangle Stone" );
		AddRequirement( b.reqs, "blob", "mat_stone", "Stone", 5 );
		blocks[0].push_back( b );
	}
	
	{   // farming block
		BuildBlock b( 0, "farming_block", "$farming_block$", "Farming Block\nPlants can grow on it" );
	...
	{   // explosive trap
		BuildBlock b( 0, "explosive_trap", "$explosive_trap$", "Explosive Trap\nExplodes on enemy collision" );
		AddRequirement( b.reqs, "blob", "mat_stone", "Stone", 40 );
	...
	{   // ladder
		BuildBlock b( 0, "trap_ladder", "$ladder$", "Ladder\nEnemies can't climb it, but can destroy it" );
		AddRequirement( b.reqs, "blob", "mat_wood", "Wood", 100 );
		blocks[0].push_back( b );
	}

		{   // building
				BuildBlock b( 0, "bigbuilding", "$bigbuilding$",
