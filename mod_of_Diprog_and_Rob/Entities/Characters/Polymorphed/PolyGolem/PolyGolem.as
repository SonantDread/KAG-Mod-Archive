...
void onTick(CBlob@ this)
{
	...
	if (this.hasTag(punch_tag))//getNet().isServer() && 
	{
		...
		if (lastbite > bitefreq)
		{
			...
			vel = Vec2f(1,0);
			{
				...
				HitInfo@[] hitInfos;
				CMap @map = getMap();
				if (map.getHitInfosFromArc(this.getPosition(), vel.Angle(), 360, 32, this, @hitInfos ))
				{
...
void onCollision( CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point1 )
{
	...
	if (blob.getTeamNum() != this.getTeamNum() && !blob.hasTag("dead"))
	{
		MadAt( this, blob );
	}
}
