...
void onRender( CSprite@ this )
{
	...
	{
		if (type == OrbType::normal) GUI::DrawIcon( "Orbs.png", 0, Vec2f(9,9), tl+delta+Vec2f(21 + (slotsSize-3)*32, 7), 1.0f, 1);
		else if (type == OrbType::fire) GUI::DrawIcon( "Orbs.png", 4, Vec2f(9,9), tl+delta+Vec2f(21 + (slotsSize-3)*32, 7), 1.0f, 1);
		else if(type == OrbType::bomb) GUI::DrawIcon( "Orbs.png", 8, Vec2f(9,9), tl+delta+Vec2f(21 + (slotsSize-3)*32, 7), 1.0f, 1);
		else if (type == OrbType::water) GUI::DrawIcon( "Orbs.png", 12, Vec2f(9,9), tl+delta+Vec2f(21 + (slotsSize-3)*32, 7), 1.0f, 1);
