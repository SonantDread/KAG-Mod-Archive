...
void onTick(CBlob@ this)
{
	...
	if(this.get_s16("empowerwaterlvl2") > 0 || this.get_s16("empowerwaterlvl3") > 0)return;
	...
	if (getNet().isServer())
	{
		...
		if ((inwater && divingHelmet < 1) ^^ (this.get_s16("cant_breathe_air") >0))
		{
			if (aircount > -100)
			{
				aircount -= FREQ;
				if(this.get_s16("empowerwater") > 0)aircount -= FREQ;
			}
