...
shared class RespawnSystem
{
    ...
    CBlob@ SpawnPlayerIntoWorld(Vec2f at, PlayerInfo@ p_info)
    {
		...
		if (player !is null && ( p_info.blob_name == "wizard" || p_info.blob_name == "heavyknight" || p_info.blob_name == "crossbowman" || p_info.blob_name == "Necromancer" || p_info.blob_name == "hunter"))
        {
