...
void MakeTradeMenu(CBlob@ trader)
{
	...
	s32 cost_bombs = cfg.read_s32("cost_bombs", 1);
	s32 cost_waterbombs = cfg.read_s32("cost_waterbombs", 1);
	s32 cost_keg = cfg.read_s32("cost_keg", 2);
	s32 cost_mine = cfg.read_s32("cost_mine", 1);

	s32 cost_arrows = cfg.read_s32("cost_arrows", 1);
	s32 cost_waterarrows = cfg.read_s32("cost_waterarrows", 1);
	s32 cost_firearrows = cfg.read_s32("cost_firearrows", 1);
	s32 cost_bombarrows = cfg.read_s32("cost_bombarrows", 2);

	s32 cost_boulder = cfg.read_s32("cost_boulder", 1);
	s32 cost_burger = cfg.read_s32("cost_burger", 2);
