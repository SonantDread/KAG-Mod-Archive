...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	...
	else if (cmd == this.getCommandID("throw"))
	{
		...
		this.getSprite().PlaySound("itemthrow1.ogg", 1.5f);
	}
}
...
void DoThrow(CBlob@ this, CBlob@ carried, Vec2f pos, Vec2f vector, Vec2f selfVelocity)
{
	...
	if (carried !is null)
	{
		...
		{
			if (carried.hasTag("throwable"))
			{
				vel *= 1.2f;
				
				carried.set_bool("dangerous projectile", true);
				carried.Sync("dangerous projectile", true);
			}
