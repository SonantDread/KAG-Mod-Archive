...
const uint totalToKickSeconds = 60;
...
void onTick(CRules@ this)
{
	...
	// don't kick AFK players that are 'dead'
	CBlob@ playerBlob = p.getBlob();
	if (playerBlob !is null && !playerBlob.hasTag("fighter"))
	{
		return;
	}
	...
	kickImmunity = true;	// override for SSK mode
