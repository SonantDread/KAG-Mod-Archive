...
class PNGLoader
{
	...
	void handlePixel(SColor pixel, int offset)
	{
		...
		else if (pixel == color_wooden_platform_up)
		{
			spawnBlob( map, "wooden_platform", offset, 255, true );
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_wooden_platform_right)
		{
		...
		else if (pixel == color_wooden_platform_down)
		{
			CBlob@ blob = spawnBlob( map, "wooden_platform", offset, 255, false );
			offsets[autotile_offset].push_back( offset );
		...
		else if (pixel == color_wooden_platform_left)
		{
			CBlob@ blob = spawnBlob( map, "wooden_platform", offset, 255, false );
			offsets[autotile_offset].push_back( offset );
			CShape@ shape = blob.getShape();
		...
		else if (pixel == SColor(255, 130, 60, 10))
		{
