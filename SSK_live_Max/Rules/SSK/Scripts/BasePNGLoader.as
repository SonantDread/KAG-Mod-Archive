...
class PNGLoader
{
	...
	{	
		...
		else
		{
			...
			// Platforms
			case map_colors::wooden_platform_up:    autotile(offset); spawnBlob(map, "wooden_platform", offset, 255, true); break;
			case map_colors::wooden_platform_right: autotile(offset); spawnBlob(map, "wooden_platform", offset, 255, true, Vec2f_zero,  90); break;
			case map_colors::wooden_platform_down:  autotile(offset); spawnBlob(map, "wooden_platform", offset, 255, true, Vec2f_zero, 180); break;
			case map_colors::wooden_platform_left:  autotile(offset); spawnBlob(map, "wooden_platform", offset, 255, true, Vec2f_zero, -90); break;

			case map_colors::stone_platform_up:    autotile(offset); spawnBlob(map, "stone_platform", offset, 255, true); break;
			case map_colors::stone_platform_right: autotile(offset); spawnBlob(map, "stone_platform", offset, 255, true, Vec2f_zero,  90); break;
			case map_colors::stone_platform_down:  autotile(offset); spawnBlob(map, "stone_platform", offset, 255, true, Vec2f_zero, 180); break;
			case map_colors::stone_platform_left:  autotile(offset); spawnBlob(map, "stone_platform", offset, 255, true, Vec2f_zero, -90); break;

			case map_colors::bedrock_platform_up:    autotile(offset); spawnBlob(map, "bedrock_platform", offset, 255, true); break;
			case map_colors::bedrock_platform_right: autotile(offset); spawnBlob(map, "bedrock_platform", offset, 255, true, Vec2f_zero,  90); break;
			case map_colors::bedrock_platform_down:  autotile(offset); spawnBlob(map, "bedrock_platform", offset, 255, true, Vec2f_zero, 180); break;
			case map_colors::bedrock_platform_left:  autotile(offset); spawnBlob(map, "bedrock_platform", offset, 255, true, Vec2f_zero, -90); break;
			...
			case map_colors::barrel_spawner:
			{
				CBlob@ blob = spawnBlob( map, "barrel_spawner", offset, 255, false );
				offsets[autotile_offset].push_back( offset );
