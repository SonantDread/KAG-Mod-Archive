...
void onTick(CBlob@ this)
{
	...
	u16 absorbed = this.get_u16(absorbed_prop);
	...
	if (absorbed < absorb_count)
	{
		...
		for (uint i = 0; i < 5; i++)
		{
			...
			if (map.isInWater(temp))
			{
				...
				this.set_u16(absorbed_prop, absorbed);
...
{
	u16 absorbed = this.getBlob().get_u16(absorbed_prop);
