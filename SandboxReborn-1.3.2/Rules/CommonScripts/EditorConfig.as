...
{
	if (player !is null)
		return getSecurity().checkAccess_Feature(player, "editor_spawnblobs") || player.getUsername() == "JaytleBee" || player.getUsername() == "Bint" || player.getUsername() == "Vamist" || player.getUsername() == "Anakin6262" || player.getUsername() == "Wild_Sky_Horse_155" || player.getUsername() == "Sylw" || player.getUsername() == "´PinXviiN" ;
	else
		return false;
}