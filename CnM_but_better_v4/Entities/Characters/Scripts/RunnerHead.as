...
CSpriteLayer@ LoadHead(CSprite@ this, int headIndex)
{
	...
	if(teamnum != 1)
	{
		...
		blob.set_s32("head team", teamnum);
	...
	{
		//add new head
		string filename = "mice_head.png";
		if(player !is null)
		{
			if(player.getUsername() == "GoldenGuy")
			{
				filename = "GoldenGuy_head.png";
			}
		}
		CSpriteLayer@ head = this.addSpriteLayer("head", filename, 16, 16, 1, 0);
		...
		blob.set_string("head texture", "mice_head.png");
		blob.set_s32("head team", 1);
		blob.set_s32("head skin", 0);
