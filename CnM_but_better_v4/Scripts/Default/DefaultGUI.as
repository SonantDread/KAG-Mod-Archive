...
void LoadDefaultGUI()
{
	if (v_driver > 0)
	{
		...
		AddIconToken("$ladder_tile$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_ladder_n);
		AddIconToken("$gold_brick$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_goldbrick);
		AddIconToken("$fake_dirt$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_fake_dirt);
		AddIconToken("$fake_castle$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_fake_castle);
		AddIconToken("$fake_wood$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_fake_wood);
		AddIconToken("$fake_gold_brick$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_fake_goldbrick);
