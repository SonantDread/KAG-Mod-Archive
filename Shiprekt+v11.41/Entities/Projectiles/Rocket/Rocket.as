		...
		if (getMap().getHitInfosFromRay( pos, -vel.Angle(), vel.Length(), this, @hitInfos ))
		{
			...
			for (uint i = 0; i < hitInfos.length; i++)
			{
				...
				if (color > 0 || !isBlock)
				{
					...
					{
						if ( blockType == Block::MOTHERSHIP5 || Block::isSolid(blockType) || blockType == Block::DOOR ||  ( (b.hasTag( "weapon" ) || b.hasTag( "rocket" )) && !sameTeam ) )
							killed = true;
...
void onHitBlob( CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitBlob, u8 customData )
{
	...
	else	if (Block::isSolid(blockType) || blockType == Block::MOTHERSHIP5 ||  blockType == Block::SEAT || blockType == Block::DOOR || hitBlob.hasTag( "weapon" ) )
	{
