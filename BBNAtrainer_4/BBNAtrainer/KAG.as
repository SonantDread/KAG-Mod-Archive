...
void onRestart(CRules@ this)
{
	...
	if (map !is null)
	{
		map.SetBorderFadeWidth(1.0f);
		map.SetBorderColourTop(SColor(0xffffff));
		map.SetBorderColourLeft(SColor(0x80000000));
		map.SetBorderColourRight(SColor(0x80000000));
		map.SetBorderColourBottom(SColor(0x80000000));
...
void onTick(CRules@ this)
{
	...
	if (need_sky_check)
	{
		...
		map.SetBorderColourTop(SColor(has_solid_tiles ? 0xff000000 : 0xffffff));
	}
}
