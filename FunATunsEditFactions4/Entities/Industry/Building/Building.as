...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Knight Shop", "$knightshops$", "knightshops", "Factory's for knights");
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 200);
	}
	{
		ShopItem@ s = addShopItem(this, "Archer Shop", "$archershops$", "archershops", "Factory's for archers");
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 200);
	}
	{
