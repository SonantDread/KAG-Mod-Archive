            ...
            if (blob !is null && ap.socket)
            {
                ...
                if (ap.name == "FLYER")
                {
                    ...
                    if (ap.isKeyJustReleased( key_action3 ) && this.getName() == "zeppelin")
                    {
                        ...
                        CBlob@ molotov = inv.getItem( "mat_molotov" );
                        CBlob@ bomb = inv.getItem( "mat_bombs" );
						CBlob@ mine = inv.getItem( "mine" );
                        ...
                        else if ( molotov !is null)
                        {
                            molotov.server_Die();
                            Vec2f pos = this.getPosition();
                            pos.y += 35;
                            server_CreateBlob( "molotov", this.getTeamNum(), pos );
                        }
						...
						else if ( mine !is null)
                        {
                            ...
                            Vec2f pos = this.getPosition();
                            pos.y += 35;
                            server_CreateBlob( "mine", this.getTeamNum(), pos );
                        }
                    }
