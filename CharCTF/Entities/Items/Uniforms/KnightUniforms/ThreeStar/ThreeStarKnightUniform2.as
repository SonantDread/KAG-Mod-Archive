...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if (kek == 1)
	{	
		caller.CreateGenericButton( 11, Vec2f_zero, this, this.getCommandID("sassassin"), "Use this to change into a stronger knight.", params );
	}
}
...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("sassassin"))
	{
        ...
        if (getNet().isServer() )
        {
            ...
            {
				warn("chealler:");
                string classconfig = "threestarknight2";//params.read_string();
