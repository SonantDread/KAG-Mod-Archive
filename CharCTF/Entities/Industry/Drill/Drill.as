...
const string required_class1 = "onestarbuilder";
const string required_class2 = "onestarbuilder2";
const string required_class3 = "twostarbuilder";
const string required_class4 = "twostarbuilder2";
const string required_class5 = "threestarbuilder";
const string required_class6 = "threestarbuilder2";
...
void onTick(CBlob@ this)
{
	...
	if (this.isAttached())
	{
		...
		if (holder.getName() == required_class || holder.getName() == required_class1 || holder.getName() == required_class2 || holder.getName() == required_class3 || holder.getName() == required_class4 || holder.getName() == required_class5 || holder.getName() == required_class6 || sv_gamemode == "TDM")
		{
