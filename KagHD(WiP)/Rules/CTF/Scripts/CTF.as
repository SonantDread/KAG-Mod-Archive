...
shared class CTFCore : RulesCore
{
	...
	void SetupBases()
	{
		...
		if (map !is null)
		{
			...
			f32 auto_distance_from_edge_tents = Maths::Min(map.tilemapwidth * 0.3f * 16.0f, 200.0f);
			...
			f32 auto_distance_from_edge = Maths::Min(map.tilemapwidth * 0.5f * 16.0f, 800.0f);
