...
{
	// knight
	AddIconToken("$Bomb$", "Entities/Characters/Knight/KnightIcons.png", Vec2f(32, 64), 0);
	AddIconToken("$WaterBomb$", "Entities/Characters/Knight/KnightIcons.png", Vec2f(32, 64), 2);
	AddIconToken("$Satchel$", "Entities/Characters/Knight/KnightIcons.png", Vec2f(32, 64), 3);
	AddIconToken("$Keg$", "Entities/Characters/Knight/KnightIcons.png", Vec2f(32, 64), 4);
	AddIconToken("$Help_Bomb1$", "Entities/Common/GUI/HelpIcons.png", Vec2f(16, 32), 30);
	AddIconToken("$Help_Bomb2$", "Entities/Common/GUI/HelpIcons.png", Vec2f(16, 32), 31);
	AddIconToken("$Swap$", "Entities/Common/GUI/HelpIcons.png", Vec2f(32, 32), 7);
	AddIconToken("$Jab$", "Entities/Common/GUI/HelpIcons.png", Vec2f(32, 32), 20);
	AddIconToken("$Slash$", "Entities/Common/GUI/HelpIcons.png", Vec2f(32, 32), 21);
	AddIconToken("$Shield$", "Entities/Common/GUI/HelpIcons.png", Vec2f(32, 32), 22);
	// archer
	AddIconToken("$Arrow$", "Entities/Characters/Archer/ArcherIcons.png", Vec2f(32, 64), 0);
	AddIconToken("$WaterArrow$", "Entities/Characters/Archer/ArcherIcons.png", Vec2f(32, 64), 1);
	AddIconToken("$FireArrow$", "Entities/Characters/Archer/ArcherIcons.png", Vec2f(32, 64), 2);
	AddIconToken("$BombArrow$", "Entities/Characters/Archer/ArcherIcons.png", Vec2f(32, 64), 3);
	AddIconToken("$Daggar$", "Entities/Common/GUI/HelpIcons.png", Vec2f(32, 32), 10);
	AddIconToken("$Help_Arrow1$", "Entities/Common/GUI/HelpIcons.png", Vec2f(16, 32), 216);
	AddIconToken("$Help_Arrow2$", "Entities/Common/GUI/HelpIcons.png", Vec2f(16, 32), 29);
	AddIconToken("$Swap$", "Entities/Common/GUI/HelpIcons.png", Vec2f(32, 32), 7);
	AddIconToken("$Grapple$", "Entities/Common/GUI/HelpIcons.png", Vec2f(32, 32), 32);
	// builder
	AddIconToken("$Build$", "Entities/Common/GUI/HelpIcons.png", Vec2f(32, 32), 11);
	AddIconToken("$Pick$", "Entities/Common/GUI/HelpIcons.png", Vec2f(32, 32), 12);
	AddIconToken("$Rotate$", "Entities/Common/GUI/HelpIcons.png", Vec2f(32, 32), 5);
	AddIconToken("$Help_Block1$", "Entities/Common/GUI/HelpIcons.png", Vec2f(16, 32), 12);
	AddIconToken("$Help_Block2$", "Entities/Common/GUI/HelpIcons.png", Vec2f(16, 32), 13);
	AddIconToken("$Swap$", "Entities/Common/GUI/HelpIcons.png", Vec2f(32, 32), 7);
	AddIconToken("$BlockStone$", "Sprites/world.png", Vec2f(16, 16), 96);

	AddIconToken("$workshop$", "Entities/Common/GUI/HelpIcons.png", Vec2f(32, 32), 2);
}
