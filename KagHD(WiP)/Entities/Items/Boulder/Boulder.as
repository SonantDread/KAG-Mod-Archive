...
const f32 hit_amount_ground = 0.4f;
const f32 hit_amount_air = 6.0f;
const f32 hit_amount_cata = 20.0f;
...
void Slam( CBlob @this, f32 angle, Vec2f vel, f32 vellen )
{
	...
	{			   
		...
		map.server_DestroyTile( pos + Vec2f( 24.0f, 24.0f), 10.0f, this );
		map.server_DestroyTile( pos - Vec2f( 24.0f, 24.0f), 10.0f, this );
	}
}
