...
void onInit( CBlob@ this )
{
	...
	this.set_f32("map_bomberman_width", 48.0f);
    ...
    this.set_f32("map_damage_radius", 144.0f);
    ...
    CSpriteLayer@ fuse = this.getSprite().addSpriteLayer( "fuse", "Keg.png" , 32, 32, 0, 0 );
