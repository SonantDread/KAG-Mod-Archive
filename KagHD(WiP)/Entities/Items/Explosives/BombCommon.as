...
bool UpdateBomb(CBlob@ this)
{
	...
	else
	{
		...
		if (XORRandom(2) == 0)
		{
			sparks(this.getPosition(), this.getAngleDegrees(), 7.0f + (XORRandom(10) / 5.0f), lightColor);
		}
...
{
	this.server_Hit(this, this.getPosition(), Vec2f(0, 0), this.hasTag("flesh") ? 14.0f : 8.0f, 0, true);
	BombFuseOff(this);
}
