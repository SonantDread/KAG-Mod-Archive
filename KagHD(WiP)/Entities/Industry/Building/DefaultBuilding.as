...
void onTick( CBlob@ this )
{
	if (this.getTickSinceCreated() == 10)
	{
		...
		if(getBlobsByTag( "building", buildings ))
		{
			...
			Vec2f myhalfsize = Vec2f(myshape.getWidth(), myshape.getHeight()) * 0.25f;
			...
			for(uint i = 0; i < buildings.length; ++i)
			{
				...
				Vec2f theirhalfsize = Vec2f(theirshape.getWidth(), theirshape.getHeight()) * 0.25f;
