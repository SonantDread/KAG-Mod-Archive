...
void onInit(CBlob@ this)
{
	...
	AddIconToken( "$put_migrant$", "Entities/Characters/Migrant/MigrantMale.png", Vec2f(128,128), 3 );
	AddIconToken( "$out_migrant$", "Entities/Characters/Migrant/MigrantMale.png", Vec2f(128,128), 17 );
...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if (carried !is null && carried.hasTag("migrant") && !isRoomFullOfMigrants(this))
	{
		...
		caller.CreateGenericButton( "$put_migrant$", Vec2f(0.0f, 28.0f), this, this.getCommandID("put migrant"), "Tuck into bed", params );
	}
	//else
...
void onTick( CBlob@ this )
{
	if (getNet().isServer())
	{
		...
		CBlob@[] blobsInRadius;
		if (this.getTeamNum() != 255 && !isRoomFullOfMigrants(this) && this.getMap().getBlobsInRadius( this.getPosition(), this.getRadius()*2.5f, @blobsInRadius ))
		{
