...
void onInit(CBlob@ this)
{
	...
	this.set_Vec2f("nobuild extend", Vec2f(0.0f, 16.0f));
	...
	if (sprite !is null)
	{
		...
		this.set_u32("next offset", traderRandom.NextRanged(32));
...
void onTick(CSprite@ this)
{
	...
	else
	{
		...
		else if (moving_left && offset.x <= -next_offset)
		{
			...
			blob.set_u32("next offset", traderRandom.NextRanged(32));
			trader.SetAnimation("stop");
