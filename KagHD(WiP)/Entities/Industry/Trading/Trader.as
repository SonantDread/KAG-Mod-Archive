...
void onGib(CSprite@ this)
{
	...
	CParticle@ Gib1     = makeGibParticle("Entities/Special/WAR/Trading/TraderGibs.png", pos, vel + getRandomVelocity(90, hp , 80), 0, 0, Vec2f(32, 32), 2.0f, 20, "/BodyGibFall");
	CParticle@ Gib2     = makeGibParticle("Entities/Special/WAR/Trading/TraderGibs.png", pos, vel + getRandomVelocity(90, hp - 0.2 , 80), 1, 0, Vec2f(32, 32), 2.0f, 20, "/BodyGibFall");
	CParticle@ Gib3     = makeGibParticle("Entities/Special/WAR/Trading/TraderGibs.png", pos, vel + getRandomVelocity(90, hp , 80), 2, 0, Vec2f(32, 32), 2.0f, 0, "/BodyGibFall");
}
...
{
	if (hitterBlob !is this && getMap().isBlobInRadius("tradingpost", this.getPosition(), 64.0f))
	{
		return 0.0f;
	}
	return damage;
