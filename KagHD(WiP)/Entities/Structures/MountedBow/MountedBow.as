...
void onInit( CBlob@ this )
{
    ...
    CSpriteLayer@ arm = sprite.addSpriteLayer( "arm", sprite.getConsts().filename, 32, 32 );
    ...
    CSpriteLayer@ cage = sprite.addSpriteLayer( "cage", sprite.getConsts().filename, 16, 32 );
