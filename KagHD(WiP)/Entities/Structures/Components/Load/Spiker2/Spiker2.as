...
class Spiker : Component
{
	...
	void Activate(CBlob@ this)
	{
		...
		CMap@ map = getMap();
		if(map.rayCastSolid(position + offset * 10, position + offset * 22))
		{
		...
		{
			CBlob@[] blobs;
			map.getBlobsAtPosition(offset * 16 + position, @blobs);
...
void onSetStatic(CBlob@ this, const bool isStatic)
{
	...
	CSpriteLayer@ layer = sprite.addSpriteLayer("background", "Spiker2.png", 16, 32);
