...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$lever_0$", "Lever.png", Vec2f(32, 32), 4);
	AddIconToken("$lever_1$", "Lever.png", Vec2f(32, 32), 5);
}
...
void onSetStatic(CBlob@ this, const bool isStatic)
{
	...
	CSpriteLayer@ layer = sprite.addSpriteLayer("background", "Lever2.png", 16, 16);
