...
void onInit( CBlob@ blob )
{
    ...
    //init emote layer
    CSpriteLayer@ emote = sprite.addSpriteLayer( "bubble", "Entities/Common/Emotes/Emoticons.png", 64, 64, 0, 0 );

    if (emote !is null)
    {
        emote.SetOffset(Vec2f(0,-sprite.getBlob().getRadius()*1.5f-32));
