...
void makeFireParticle(Vec2f pos, int smokeRandom = 1)
{
	...
	ParticleAnimated(texture, pos, Vec2f(0, 0), 0.0f, 1.0f, 10, -0.1, true);
}

void makeSmokeParticle(Vec2f pos, f32 gravity = -0.12f)
{
	string texture;
	...
	ParticleAnimated(texture, pos, Vec2f(0, 0), 0.0f, 1.0f, 10, gravity, true);
}