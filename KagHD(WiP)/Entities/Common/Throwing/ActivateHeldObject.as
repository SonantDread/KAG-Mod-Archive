...
const f32 DEFAULT_THROW_VEL = 12.0f;
...
Vec2f getThrowVelocity(CBlob@ this, Vec2f vector, Vec2f selfVelocity, f32 this_vel_affect = 0.2f)
{
	Vec2f vel = vector;
	...
	f32 closeDist = this.getRadius() + 128.0f;
	if (selfVelocity.getLengthSquared() < 0.2f && len < closeDist)
	{
		vel *= len / closeDist;
	}
	return vel;
