...
void MakeParticleSplash(const string &in file, s32 xchunk, s32 ychunk, const Vec2f &in pos, f32 vel = 8.0f, s32 team = 0)
{
	...
	makeGibParticle( CFileMatcher(file).getRandom(), pos,
						getRandomVelocity( angle, vel + partsplash_randomFloat(4.0f), spread ),
	...
	makeGibParticle( CFileMatcher(file).getRandom(), pos,
						getRandomVelocity( angle, vel + partsplash_randomFloat(6.0f), spread ),
