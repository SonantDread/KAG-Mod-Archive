...
void onInit( CBlob@ this )
{
    ...
    if (!this.exists("created_blob_radius")) {
        this.set_u8("created_blob_radius", 8);
    }
...
void LoadSprite( CBlob@ this, string filename, u8 spriteIndex )
{
    ...
    if (anim !is null)
    {
        switch (spriteIndex)
        {
        case 2: anim.AddFrame(20); anim.AddFrame(21); sprite.SetOffset( Vec2f(0,-4) ); break;

        case 3: anim.AddFrame(4); anim.AddFrame(5); sprite.SetOffset( Vec2f(0,-4) ); break;
