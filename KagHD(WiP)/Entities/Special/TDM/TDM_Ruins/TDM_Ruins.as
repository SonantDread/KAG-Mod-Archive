...
{
    this.CreateRespawnPoint( "ruins", Vec2f(0.0f, 64.0f) );
...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
    if (canChangeClass( this, caller )) 
	{
		...
		else 
		{
			...
			caller.CreateGenericButton( "$change_class$", Vec2f(0, 24), this, this.getCommandID("class menu"), "Change class", params );
		}
    }
