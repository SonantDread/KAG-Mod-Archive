...
void LoadSprites( CSprite@ this )
{
    string texname = this.getBlob().getSexNum() == 0 ?
                     "../Mods/KagHD(WiP)/Entities/Characters/Archer/ArcherMale.png" :
                     "../Mods/KagHD(WiP)/Entities/Characters/Archer/ArcherFemale.png";
    ...
    CSpriteLayer@ frontarm = this.addSpriteLayer( "frontarm", texname , 64, 32, this.getBlob().getTeamNum(), this.getBlob().getSkinNum() );
    ...
    CSpriteLayer@ backarm = this.addSpriteLayer( "backarm", texname , 64, 32, this.getBlob().getTeamNum(), this.getBlob().getSkinNum() );
    ...
    CSpriteLayer@ arrow = this.addSpriteLayer( "held arrow", "Arrow.png" , 32, 16, this.getBlob().getTeamNum(), this.getBlob().getSkinNum() );
    ...
    CSpriteLayer@ quiver = this.addSpriteLayer( "quiver", texname , 32, 32, this.getBlob().getTeamNum(), this.getBlob().getSkinNum() );
    ...
    CSpriteLayer@ hook = this.addSpriteLayer( "hook", texname , 32, 16, this.getBlob().getTeamNum(), this.getBlob().getSkinNum() );
    ...
    CSpriteLayer@ rope = this.addSpriteLayer( "rope", texname , 64, 16, this.getBlob().getTeamNum(), this.getBlob().getSkinNum() );
...
void doRopeUpdate(CSprite@ this, CBlob@ blob, ArcherInfo@ archer)
{
	...
	f32 ropelen = Maths::Max(0.1f,off.Length() / 64.0f);
	if(ropelen > 400.0f)
	{
		rope.SetVisible(false);
		hook.SetVisible(false);
	...
	rope.TranslateBy( Vec2f(ropelen*32.0f,0.0f) );
