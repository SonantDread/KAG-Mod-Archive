...
bool grappleHitMap(ArcherInfo@ archer, CMap@ map, const f32 dist = 32.0f)
{
	return  map.isTileSolid(archer.grapple_pos + Vec2f(0, -6)) ||			//fake quad
	        map.isTileSolid(archer.grapple_pos + Vec2f(6, 0)) ||
	        map.isTileSolid(archer.grapple_pos + Vec2f(-6, 0)) ||
	        map.isTileSolid(archer.grapple_pos + Vec2f(0, 6)) ||
...
void ClientFire(CBlob@ this, const s8 charge_time, const bool hasarrow, const u8 arrow_type, const bool legolas)
{
	...
	if (hasarrow && canSend(this))  // client-logic
	{
		...
		ShootArrow(this, this.getPosition() + Vec2f(0.0f, -4.0f), this.getAimPos() + Vec2f(0.0f, -4.0f), arrowspeed, arrow_type, legolas);
	}
}
...
void onCreateInventoryMenu(CBlob@ this, CBlob@ forBlob, CGridMenu @gridmenu)
{
	...
	CGridMenu@ menu = CreateGridMenu(pos, this, Vec2f(arrowTypeNames.length * 2, 2), "Current arrow");
