...
void onInit(CSprite@ this)
{
    const string texname = this.getBlob().getSexNum() == 0 ?
                           "../Mods/KagHD(Wip)/Entities/Characters/Builder/BuilderMale.png" :
                           "../Mods/KagHD(WiP)/Entities/Characters/Builder/BuilderFemale.png";
...
void DrawCursorAt(Vec2f position, string& in filename)
{
    ...
    position = getDriver().getScreenPosFromWorldPos(position);
    GUI::DrawIcon(filename, position, getCamera().targetDistance * getDriver().getResolutionScaleFactor());
}

// render cursors

const string cursorTexture = "../Mods/KagHD/Entities/Characters/Sprites/TileCursor.png";
