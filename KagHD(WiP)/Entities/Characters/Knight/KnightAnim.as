...
void onInit(CSprite@ this)
{
    string texname = this.getBlob().getSexNum() == 0 ?
                     "../Mods/KagHD(WiP)/Entities/Characters/Knight/KnightMale.png" :
                     "../Mods/KagHD(WiP)/Entities/Characters/Knight/KnightFemale.png";
    ...
    CSpriteLayer@ shiny = this.addSpriteLayer(shiny_layer, "AnimeShiny.png", 32, 32);
...
void onTick( CSprite@ this )
{
    ...
    if (shiny !is null)
    {
        ...
        if (shinydot)
        {
            ...
            shiny.SetOffset(Vec2f(24, -4 + ratio * 16));
        }
    }
...
void onGib(CSprite@ this)
{
    ...
    CParticle@ Body     = makeGibParticle("Entities/Characters/Knight/KnightGibs.png", pos, vel + getRandomVelocity(90, hp , 80), 0, 0, Vec2f(32, 32), 2.0f, 20, "/BodyGibFall", team);
    CParticle@ Arm      = makeGibParticle("Entities/Characters/Knight/KnightGibs.png", pos, vel + getRandomVelocity(90, hp - 0.2 , 80), 1, 0, Vec2f(32, 32), 2.0f, 20, "/BodyGibFall", team);
    CParticle@ Shield   = makeGibParticle("Entities/Characters/Knight/KnightGibs.png", pos, vel + getRandomVelocity(90, hp , 80), 2, 0, Vec2f(32, 32), 2.0f, 0, "Sounds/material_drop.ogg", team);
    CParticle@ Sword    = makeGibParticle("Entities/Characters/Knight/KnightGibs.png", pos, vel + getRandomVelocity(90, hp + 1 , 80), 3, 0, Vec2f(32, 32), 2.0f, 0, "Sounds/material_drop.ogg", team);
}
...
void DrawCursorAt(Vec2f position, string& in filename)
{
    ...
    position = getDriver().getScreenPosFromWorldPos(position - Vec2f(2, 2));
...
void onRender(CSprite@ this)
{
    ...
    if (blob.isKeyPressed(key_action1))
    {
        ...
        if ((map.isTileSolid(tile) || map.isTileGrass(tile.type)) && map.getSectorAtPosition(surface_position, "no build") is null && distance < 32.0f)
        {
