...
//	this.getShape().getConsts().transports = true;
	...
	CSpriteLayer@ balloon = sprite.addSpriteLayer("balloon", "Balloon.png", 96, 128);
	if (balloon !is null)
	{
		...
		balloon.SetOffset(Vec2f(0.0f, -52.0f));
	}

	CSpriteLayer@ background = sprite.addSpriteLayer("background", "Balloon.png", 64, 32);
	if (background !is null)
	{
		...
		background.SetOffset(Vec2f(0.0f, -10.0f));
	}

	CSpriteLayer@ burner = sprite.addSpriteLayer("burner", "Balloon.png", 16, 32);
	if (burner !is null)
	{
		{
		...
		burner.SetOffset(Vec2f(0.0f, -52.0f));
	}
}
...
void onTick(CSprite@ this)
{
	...
	if (burner !is null)
	{
		burner.SetOffset(Vec2f(0.0f, -28.0f));
