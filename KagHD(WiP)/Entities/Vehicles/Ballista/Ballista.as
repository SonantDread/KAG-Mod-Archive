...
void onInit(CBlob@ this)
{
	...
	Vehicle_SetupWeapon(this, v,
	                    ...
	                    Vec2f(-12.0f, -16.0f), // fire position ffset
	...
	{ CSpriteLayer@ w = Vehicle_addWoodenWheel(this, v, 0, Vec2f(20.0f, 36.0f)); if (w !is null) w.SetRelativeZ(20.0f); }
	{ CSpriteLayer@ w = Vehicle_addWoodenWheel(this, v, 0, Vec2f(-2.0f, 36.0f)); if (w !is null) w.SetRelativeZ(20.0f); }
	{ CSpriteLayer@ w = Vehicle_addWoodenWheel(this, v, 0, Vec2f(-22.0f, 36.0f)); if (w !is null) w.SetRelativeZ(20.0f); }
	...
	CSpriteLayer@ arm = sprite.addSpriteLayer("arm", sprite.getConsts().filename, 48, 80);
	...
	if (arm !is null)
	{
		...
		if (arm !is null)
		{
			...
			arm.SetOffset(Vec2f(20.0f, -12.0f));
		}
	}
	...
	CSpriteLayer@ flag = sprite.addSpriteLayer("flag layer", sprite.getConsts().filename, 64, 64);
	if (flag !is null)
	{
		...
		flag.SetOffset(Vec2f(40.0f, -4.0f));
	}
}
...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	if (caller.getTeamNum() == this.getTeamNum() && isOverlapping(this, caller) && !caller.isAttached())
	{
		if (!isAnotherRespawnClose(this) && !isFlipped(this))
		{
			...
			CButton@ button = caller.CreateGenericButton("$change_class$", Vec2f(0, -8), this, SpawnCmd::buildMenu, "Change class", params);
		}
