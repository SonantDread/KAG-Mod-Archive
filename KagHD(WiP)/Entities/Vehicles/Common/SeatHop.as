...
void onTick( CBlob@ this )
{
    ...
    {
        CBlob@[] blobsInRadius;
        this.getMap().getBlobsInRadius( this.getPosition(), this.getRadius()*1.5f + 50.0f, @blobsInRadius );
        ...
        for (uint i = 0; i < points.length; i++)
        {
            ...
            {
                f32 distance = (pos - (ap.getPosition() + Vec2f(0.0f, 8.0f))).getLength();     //adjust to detect lower

                if (distance <= ap.radius+8.0f)
                {
