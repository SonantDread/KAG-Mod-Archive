...
{		
    ...
    Vehicle_addWheel( this, v, "WoodenWheels.png", 32, 32, 1, Vec2f(-20.0f,22.0f) );
    Vehicle_addWheel( this, v, "WoodenWheels.png", 32, 32, 0, Vec2f(16.0f,20.0f) );
		...
		if(getNet().isClient()) //only matters visually on client
		{
			...
			
			{
				...
				if (arm !is null)
				{
					...
					Vec2f offset = Vec2f(8,-20);
					offset.RotateBy( -armAngle, Vec2f(0.0f, 26.0f) );
					offset += armOffset + Vec2f(56,0);
