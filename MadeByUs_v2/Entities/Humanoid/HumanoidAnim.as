...
void onTick(CSprite@ this)
{
	...
	if(aimingMain){
		...
		setAimValues(this.getSpriteLayer("frontarm"), armvisible, Down+Wobble*20, Vec2f(0, 0), "default");
	...
	if(aimingSub){
		...
		setAimValues(this.getSpriteLayer("backarm"), armvisible, Down-Wobble*20, Vec2f(0, 0), "default");
		if(blob.getCarriedBlob() !is null){
			int Carry = -20;
			if (this.isFacingLeft())Carry = 20;
	...
	if(grapple.grappling){
		...
		setAimValues(this.getSpriteLayer("frontarm"), armvisible, grappleAngle, Vec2f(0, 0), "stretch");
		setAimValues(this.getSpriteLayer("backarm"), armvisible, grappleAngle, Vec2f(0, 0), "stretch");
	}
	...
	if(mainpole){
		...
		setAimValues(this.getSpriteLayer("frontarm"), armvisible, Down-mainpole_drawback*test, Vec2f(0, 0), "default");
	} else {
	...
	if(subpole){
		...
		setAimValues(this.getSpriteLayer("backarm"), armvisible, Down-subpole_drawback*test, Vec2f(0, 0), "default");
	} else {
	...
	if(bow){
		...
		setAimValues(this.getSpriteLayer("frontarm"), true, angle, Vec2f(offset, 0), "open_hand");
		setAimValues(this.getSpriteLayer("backarm"), true, angle, Vec2f(0, 0), "stretch");
	} else {
