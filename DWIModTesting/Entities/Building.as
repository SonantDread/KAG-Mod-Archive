...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Ship Shop", "$shipshop$", "shipshop", "Ship Shop for all your flying/sailing needs!");
	...
	{
		ShopItem@ s = addShopItem(this, "Animal Shop", "$animalshop$", "animalshop", "Shop full of useful beasts for reasonable prices.");
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 100);
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 150);
	}
	{
		ShopItem@ s = addShopItem(this, "Engineer Shop", "$engineershop$", "engineershop", "Shop full of wacky engineer stuff");
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 100);
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 150);
	}
}
