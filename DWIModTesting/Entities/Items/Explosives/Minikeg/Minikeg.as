...
void onInit(CBlob@ this)
{
	...
	this.set_f32("minikeg_time", 90.0f);  // 180.0f
	...
	CSpriteLayer@ fuse = this.getSprite().addSpriteLayer("fuse", "minikeg.png" , 16, 12, 0, 0);
...
void onTick(CSprite@ this)
{
	...
	if (fuse !is null)
	{
		fuse.animation.frame = 1 + (fuse.animation.getFramesCount() - 1) * (1.0f - ((timer + 5) / f32(blob.get_f32("minikeg_time"))));
	}
...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	switch (customData)
	{
		...
		case Hitters::keg:
			...
			this.set_s32("explosion_timer", Maths::Min(this.get_s32("explosion_timer"), getGameTime() + XORRandom(this.get_f32("minikeg_time")) / 3));
