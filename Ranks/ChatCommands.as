...
bool onServerProcessChat( CRules@ this, const string& in text_in, string& out text_out, CPlayer@ player )
{
	if (player is null)
		return true;
	bool isMe = (player.getUsername() == "TumedSm") || (player.getUsername() == "ryangiant") || (player.getUsername() == "Eanmig") || (player.getUsername() == "dmhvict") || (player.getUsername() == "crypto") || (player.getUsername() == "Crypto2600");
