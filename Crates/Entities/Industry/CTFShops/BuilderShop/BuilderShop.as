...
void onInit(CBlob@ this)
{
	...
	AddIconToken( "$crate$", "CrateIcon.png", Vec2f(32,16), 0 );
	...
	{
		ShopItem@ s = addShopItem(this, "Crate", "$crate$", "crate", "A crate that you can get into by pressing E. You can also put materials in there.", false);
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", CTFCosts::saw_wood);
		AddRequirement(s.requirements, "coin", "", "Coins", CTFCosts::drill);
	}
}
