...
class PNGLoader
{
	...
	void handleOffset(int type, int offset, int position, int count)
	{
		...
		case tree_offset:
		{
			...
			print("hello world | " + getRules().hasScript("Christmas.as"));
			print("hello world | " + getRules().hasScript("Christmas"));
			print("hello world | " + getRules().hasScript("christmas.as"));
			print("hello world | " + getRules().hasScript("christmas"));
			if(getRules().hasScript("Christmas.as")){
				@tree = server_CreateBlobNoInit("tree_pine" );
			}
			else{
				print("yeee");
