...
void InitClasses(CBlob@ this)
{
	...
	AddIconToken("$skeleton_class_icon$", "GUI/MenuItems.png", Vec2f(32, 32), 1);
	...
	addPlayerClass(this, "Skeletal Spearman", "$skeleton_class_icon$", "SkeletalSpearman", "A new crazy class.");
}
