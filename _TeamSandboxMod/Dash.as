...
const f32 DASH_FORCE = 420.0f;//force applied

void onInit( CBlob@ this )
{
	string name = this.getName();
	if ( name == "knight" || name == "archer" || name == "builder" )
	{
...
{
	string name = this.getName();
	if ( name != "knight" && name != "archer" && name != "builder" ) return;//there's probably a better way
