...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	CButton@ button = caller.CreateGenericButton(11, Vec2f_zero, this, this.getCommandID("usebook"), "Gain control over the world around you.", params);
		...
		if (caller !is null)
		{
			...
			if (player !is null)
			{
				if(player.get_s16("book_level") >= 3){
					CBlob @newBlob = server_CreateBlob("mindman", caller.getTeamNum(), this.getPosition());
					if (newBlob !is null)
					{
