...
const string[] arrowTypeNames = { "mat_bolterarrows",
                                  "mat_bolterwaterarrows",
                                  "mat_bolterfirearrows",
                                  "mat_bolterbombarrows"
                                };

const string[] arrowNames = { "Bolter Regular arrows",
                              "Bolter Water arrows",
                              "Bolter Fire arrows",
                              "Bolter Bomb arrow"
                            };

const string[] arrowIcons = { "$BolterArrow$",
                              "$BolterWaterArrow$",
                              "$BolterFireArrow$",
                              "$BolterBombArrow$"
                            };
