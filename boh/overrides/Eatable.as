// OVERRIDE MOD
// changes: added "does not heal" tag support
...
void Heal(CBlob@ this, CBlob@ blob)
{
	...
	if (getNet().isServer() && blob.hasTag("player") && !blob.hasTag("does not heal") && blob.getHealth() < blob.getInitialHealth() && !this.hasTag("healed") && exists)
	{
		CBitStream params;
