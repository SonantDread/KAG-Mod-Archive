...
void onCreateInventoryMenu(CBlob@ this, CBlob@ forBlob, CGridMenu @gridmenu)
{
	...
	if (menu !is null)
	{
		...
		menu.AddButton("$herosword$", "Create a sword which a human can use to become a hero! Costs 50 golden essence.", this.getCommandID("makesword"));
		menu.AddButton("$goldenorb$", "Create a shiney golden orb to light up dark places. Costs 10 golden essence.", this.getCommandID("makeorb"));
		menu.AddButton("$mat_stone$", "A blessing of goods for the mortals! Costs 10 golden essence.", this.getCommandID("makegoods"));
		menu.AddButton("$goldenfish$", "Create an item to immortalize your favourite follower! Costs 30 golden essence.", this.getCommandID("makefish"));
	}
}
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	...
	if (cmd == this.getCommandID("makesword"))if(this.get_s16("power") > 50){
		if (getNet().isServer())
		{
