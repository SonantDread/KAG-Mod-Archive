...
void InitClasses(CBlob@ this)
{
	...
	addPlayerClass(this, "Bomb Archer", "$archer_class_icon$", "archer", "The Ranged Advantage.");
	//addPlayerClass(this, "ArcherNew", "$archer_class_icon$", "bombArcher", "The Ranged HAXOR.");
}
