...
CBlob@ CreateArrow(CBlob@ this, Vec2f arrowPos, Vec2f arrowVel, u8 arrowType)
{
	...
	{
		CBlob@ arrow = server_CreateBlobNoInit("mine");
	...
	{
		CBlob@ arrow = server_CreateBlobNoInit("keg");
...
arrow.Tag("activated");
arrow.set_s32("explosion_timer", getGameTime() + arrow.get_f32("keg_time"));
arrow.Tag("exploding");
arrow.SetLight(true);
arrow.SetLightRadius(this.get_f32("explosive_radius") * 0.5f);
arrow.getSprite().SetEmitSound("/Sparkle.ogg");
	...
	return server_CreateBlobNoInit("arrow");
