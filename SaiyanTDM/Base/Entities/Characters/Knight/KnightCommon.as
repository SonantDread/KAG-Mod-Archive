...
namespace KnightVars
{
	...
	const ::s32 slash_charge_level2 = 7;
	const ::s32 slash_charge_limit = slash_charge_level2 + slash_charge + 10000;
	const ::s32 slash_move_time = 4;
	const ::s32 slash_time = 13;
	const ::s32 double_slash_time = 8;

	const ::f32 slash_move_max_speed = 20.5f;

	const u32 glide_down_time = 50000;
}
