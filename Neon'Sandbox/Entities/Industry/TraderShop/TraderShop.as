...
{	 
	...
	{
		ShopItem@ s = addShopItem( this, "Book of the Dragoon", "$sdragoon$", "sdragoon", "Transform into a Dragoon for 1 life", true );
		AddRequirement( s.requirements, "coin", "", "Coins", 150 );
	}	
	{
		ShopItem@ s = addShopItem( this, "Book of the Wizard", "$swizard$", "swizard", "Transform into a Wizard for 1 life", true );
		AddRequirement( s.requirements, "coin", "", "Coins", 50 );
	}	
	{
		ShopItem@ s = addShopItem( this, "Book of the Pyromancer", "$spyro$", "spyro", "Transform into a Pyromancer for 1 life", true );
		AddRequirement( s.requirements, "coin", "", "Coins", 50 );
	}	
	{
		ShopItem@ s = addShopItem( this, "Book of the Burd", "$sburd$", "sburd", "Transform into a Burd Builder for 1 life", true );
		AddRequirement( s.requirements, "coin", "", "Coins", 50 );
		AddRequirement( s.requirements, "blob", "mat_gold", "Gold", 50 );
