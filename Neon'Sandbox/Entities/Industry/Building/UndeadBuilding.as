...
{	 
	...
	{
		ShopItem@ s = addShopItem( this, "Undead Barracks", "$undeadbarracks$", "undeadbarracks", "Advanced classes." );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 50 );
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 50 );
		AddRequirement( s.requirements, "blob", "mat_gold", "Gold", 50 );
	}	
	{
		ShopItem@ s = addShopItem( this, "Altar of Minos", "$minosaltar$", "minosaltar", "Heal." );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 50 );
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 50 );
	}
}
