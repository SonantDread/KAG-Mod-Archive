...
{
return (this.getTeamNum() != blob.getTeamNum() && blob.hasTag("flesh")) || blob.hasTag("survivorbuilding")|| blob.hasTag("door") || blob.hasTag("undeaddoor") || blob.hasTag("dead") || blob.hasTag("enemy");
}
