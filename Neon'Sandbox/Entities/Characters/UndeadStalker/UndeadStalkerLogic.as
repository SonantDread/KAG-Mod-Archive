...
void onInit(CBlob@ this)
{
	...
	SetHelp( this, "help show", "undeadstalker", "$Screech$ Screech using $SPACE$", "" );	
...
void onTick(CBlob@ this) 
{
	...
	if(this.isKeyPressed(key_action1) && !this.isKeyPressed(key_action2))
	{
		if(this.get_s16("stab_cooldown") <= 0){
			if(!this.isFacingLeft())DoAttack(this, 2.0f, 0.0f, 45.0f, Hitters::fire, 1);
			else DoAttack(this, 2.0f, 180.0f, 45.0f, Hitters::fire, 1);
