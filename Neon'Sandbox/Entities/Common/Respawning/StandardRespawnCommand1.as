...
void InitClasses(CBlob@ this)
{
	...
	addPlayerClass(this, "Assassin", "$knight_class_icon$", "assassin", "High Flying Slash.");
	addPlayerClass(this, "Crossbow Knight", "$archer_class_icon$", "crossbow", "The best of both.");
