...
void onInit(CBlob@ this)
{
	...
	//front bits
	{
		Vec2f[] shape = { Vec2f(60.0f,  8.0f) - pos_off,
		                  Vec2f(90.0f,  8.0f) - pos_off,
		                  Vec2f(112.0f,  40.0f) - pos_off,
		                  Vec2f(94.0f,  40.0f) - pos_off
		                };
		this.getShape().AddShape(shape);
	}
	...
	//back bit
	{
		Vec2f[] shape = { Vec2f(12.0f,  12.0f) - pos_off,
		                  Vec2f(34.0f, 12.0f) - pos_off,
		                  Vec2f(11.0f, 18.0f) - pos_off,
		                  Vec2f(14.0f, 14.0f) - pos_off
		                };
		this.getShape().AddShape(shape);
	}
	//rudder
	...
	CSpriteLayer@ front = sprite.addSpriteLayer("front layer", sprite.getConsts().filename, 120, 60);
	if (front !is null)
	{
