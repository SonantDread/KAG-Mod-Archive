...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$Assassin_class_icon$", "GUI/MenuItems.png", Vec2f(32, 32), 3);
	...
	addPlayerClass(this, "Polearm", "$Polearm_class_icon$", "Polearm", "Melee with better range and mobility.");
	addPlayerClass(this, "Assassin", "$Assassin_class_icon$", "assassin", "Archer and knight combo.");
