...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
  ...
  this.setPosition(caller.getPosition());
	//if(caller)
	if(this.get_u8("cooldown") == 1 && this.isAttachedTo(caller))
	{
    this.setPosition(caller.getPosition());
		CButton@ button = caller.CreateGenericButton(15, Vec2f(0,0), this, this.getCommandID("equip"), "Equip this Item!", params);
