...
void giveResources( CPlayer@ this )
{
	...
	Material::createFor( blob,  "mat_wood", 150 );
	Material::createFor( blob,  "mat_stone", 100 );
}
...
void MatchDirector( CRules@ this )
{
	...
	print("Bunnies: "+ bunnyCount);
	print("Mutants: " + mutantCount);
	if ( bunnyCount == 0 )
	{
		//print( "Mutants WIN!" );
...
bool SpawnCorruption( CRules@ this, Vec2f spot, f32 radius )
{
	...
	for ( int c = 0; c < corrupted.length; c++ )
		...
		{
			Material::createFor( corrupted[c], "bf_materialbiomass", 7 );
