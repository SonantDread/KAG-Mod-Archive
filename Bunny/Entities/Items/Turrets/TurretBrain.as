...
void onTick( CBrain@ this )
{
	...
	bf_SearchTarget( this, false, ARC360 );
    ...
    {    
		...
		if ( targetVisible && inFront && inRange ) 
		{
...
void Shoot( CBlob@ this, f32 aimAngle )
{
	...
	string PROJECTILE = this.get_string( "projectile_name" );
	...
	{		
        ...
        Vec2f offset = Vec2f( 12.0f, 0.0f );//this should be a variable
        offset.RotateBy( aimAngle );
