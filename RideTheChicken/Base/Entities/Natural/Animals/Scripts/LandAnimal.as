...
void onTick(CMovement@ this)
{
	...
	if (left || right || up)
	{
		...
		if ((blob.isOnGround() || blob.isInWater() || blob.getName() == "chicken") && (up || (right && map.isTileSolid(Vec2f(pos.x + radius, pos.y + 0.45f * radius))) || (left && map.isTileSolid(Vec2f(pos.x - radius, pos.y + 0.45f * radius)))
		                                               )
		   )
		{
