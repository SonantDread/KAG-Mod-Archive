...
void onInit(CBlob@ this)
{
	...
	{
		string airship_icon = getTeamIcon("airship", "VehicleIcons.png", team_num, Vec2f(32, 32), 2);
		ShopItem@ s = addShopItem(this, "Air Ship", airship_icon, "airship", airship_icon + "\n\n\n" + Descriptions::warboat, false, true);
		AddRequirement(s.requirements, "coin", "", "Coins", 300);
		s.crate_icon = 6;
	}
	{
		string bomber_icon = getTeamIcon("bomber", "VehicleIcons.png", team_num, Vec2f(32, 32), 7);
		ShopItem@ s = addShopItem(this, "Bomber", "$bomber$", "bomber", "Flying hot air Balloon of malice intent", false, true);
