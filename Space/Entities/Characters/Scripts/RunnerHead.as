...
const string head_path = "../Mods/Space/Heads/";
const int head_size = 1024;
...
CSpriteLayer@ LoadHead(CSprite@ this, u8 headIndex)
{
	...
	if (blob !is null)
	{
		...
		CFileImage@ image = CFileImage(head_path + sprite_name + ".png");
		if (image.getSizeInPixels() == head_size)
		{
			blob.set_string("sprite_path", head_path + sprite_name + ".png");
