bool doesCollideWithBlob( CBlob@ this, CBlob@ blob )
{
	...
	return this.getTeamNum() != blob.getTeamNum() || blob.hasTag("zombie") || blob.hasTag ("door") || blob.hasTag ("undeaddoor") || blob.getName() == "wooden_platform"; //collides with blobs from other teams or blobs with the zombie tag
}