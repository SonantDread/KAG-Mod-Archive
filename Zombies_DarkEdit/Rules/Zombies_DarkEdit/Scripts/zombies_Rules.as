...
void Config(ZombiesCore@ this)
{
    ...
    string configstr = "../Mods/Zombies_DarkEdit/Rules/Zombies_DarkEdit/zombies_vars.cfg";
	...
	s32 boss_zombie_knockback_power = cfg.read_s32("boss_zombie_knockback_power", 5);
	getRules().set_s32("boss_zombie_knockback_power", boss_zombie_knockback_power);
