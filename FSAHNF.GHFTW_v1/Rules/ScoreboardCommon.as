...
SColor getNameColour(CPlayer@ p)
{
	...
	if (username == "WhatWeGonnaDo" || username == "Bunnie" || username == "Vamist" || username == "Pirate-Rob" || username == "TFlippy " || username == "Hallic" || username == "Icewuerfel" || username == "8x") 
	{
		...
		c = SColor(255, uint(r * 255.0f), uint(g * 255.0f), uint(b * 255.0f));
	}
