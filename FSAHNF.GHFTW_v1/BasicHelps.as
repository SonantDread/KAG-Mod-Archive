...
void onInit(CRules@ this)
{
	...
	AddIconToken("$BouncyBomb$", "BouncyBombIcon.png", Vec2f(16, 32), 0);
	AddIconToken("$StickyBomb$", "StickyBombIcon.png", Vec2f(16, 32), 0);
	AddIconToken("$ImpactBomb$", "ImpactBombIcon.png", Vec2f(16, 32), 0);
	
	AddIconToken("$KnockbackBomb$", "KnockbackBombIcon.png", Vec2f(16, 32), 0);
	AddIconToken("$FloatBomb$", "FloatBombIcon.png", Vec2f(16, 32), 0);
	AddIconToken("$GravBomb$", "GravBombIcon.png", Vec2f(16, 32), 0);
	AddIconToken("$FireBomb$", "FireBombIcon.png", Vec2f(16, 32), 0);
	AddIconToken("$Grenade$", "GrenadeIcon.png", Vec2f(16, 32), 0);
	...
	AddIconToken("$KegArrow$", "Entities/Characters/Archer/ArcherIcons.png", Vec2f(16, 32), 4);
