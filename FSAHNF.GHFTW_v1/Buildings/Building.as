...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$demon_altar$", "Altar.png",Vec2f(40, 24), 0);
	AddIconToken("$kegshop$", "KEGShop.png",Vec2f(40, 24), 0);
	...
	{
		ShopItem@ s = addShopItem(this, "Demonic Altar", "$demon_altar$", "altar", "A demonic altar used in sacrifices.\nBe careful, a deal with the devil is sure to end badly");
	...
	{
		ShopItem@ s = addShopItem(this, "King's Explosive Groceries", "$kegshop$", "kegshop", "WELCOME TO THE KING'S EXPLOSIVE GROCERIES!\nKEGS 50% OFF FOR A LIMITED TIME!");
