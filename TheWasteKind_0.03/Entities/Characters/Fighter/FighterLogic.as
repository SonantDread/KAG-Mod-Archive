...
// Osmal - for characters not to collide with enemies
...
void ClientFire(CBlob@ this, const s8 charge_time, const bool hasarrow, const u8 arrow_type, const bool legolas)
{
	...
	if (hasarrow && canSend(this))  // client-logic
	{
		...
		{
			arrowspeed = FighterParams::shoot_max_vel * 1.25; //Trying to get faster arrows
		}

		ShootArrow(this, this.getPosition() + Vec2f(0.0f, -6.0f), this.getAimPos() + Vec2f(0.0f, -2.0f), arrowspeed, arrow_type, legolas);
	}
}
