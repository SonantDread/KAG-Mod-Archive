...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Golden Heart", "$goldheart$", "goldheart", descriptions[2], true);
		AddRequirement(s.requirements, "blob", "mat_gold", "Gold", 15);
	}
	{
		ShopItem@ s = addShopItem(this, "Home Stone", "$homestone$", "homestone", descriptions[2], true);
		AddRequirement(s.requirements, "blob", "mat_gold", "Gold", 10);
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 20);
	}
	{
		ShopItem@ s = addShopItem(this, "Golem", "$golem$", "golem", descriptions[2], true);
