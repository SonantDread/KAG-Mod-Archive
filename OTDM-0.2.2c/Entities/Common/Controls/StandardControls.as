...
void ManageCamera(CBlob@ this)
{
	...
	if (zoom < 1.0f && controls.isKeyPressed(KEY_KEY_R))  // zoomed out
	{
		camera.mousecamstyle = 2;
	}
	if (controls.isKeyPressed(KEY_KEY_R))  // zoomed out
	{	
		camera.mouseFactor = 1.0f;
	}	
	if (!controls.isKeyPressed(KEY_KEY_R))  // zoomed out
	{	
	...
	// camera
	//camera.mouseFactor = 1.5f; // doesn't affect soldat cam
