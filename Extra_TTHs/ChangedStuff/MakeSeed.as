...
CBlob@ server_MakeSeed(Vec2f atpos, string blobname, u16 growtime, u8 spriteIndex, u8 created_blob_radius, u16 qual)
{
	...
	if (seed !is null)
	{
		...
		seed.set_u16("quality", qual);
		//printf("WHILST MAKING SEED DECIDED THAT QUALITY WAS: " + seed.get_u16("quality"));
		seed.Init();
	}
...
{
	return server_MakeSeed(atpos, blobname, growtime, spriteIndex, created_blob_radius, 0);
}
