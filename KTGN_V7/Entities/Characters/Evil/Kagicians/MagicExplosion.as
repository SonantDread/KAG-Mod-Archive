...
{
	ParticleAnimated("Entities/Effects/Sprites/SmallMagicExplosion" + (XORRandom(3) + 1) + ".png",
...
{
	ParticleAnimated("Entities/Effects/Sprites/MagicExplosion.png",
	                 pos, Vec2f(0, 0.5f), 0.0f, 1.0f,
	                 3 + XORRandom(3),
	                 -0.1f, true);
}
...
void Explode(CBlob@ this, f32 radius, f32 damage)
{
	...
	if (getNet().isServer())
	{
		...
		for (uint i = 0; i < blobs.length; i++)
		{
			...
			if(hit_blob.getName() == this.getName())
				continue;
             ...
             const bool bother_raycasting = true, const bool should_teamkill = false)
{
	...
	//hit the object
	MagicHitBlob(this, hit_blob, hit_blob_pos,
	                bombforce, dam,
	                hitter, 
