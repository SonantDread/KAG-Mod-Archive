...
{
	this.getCurrentScript().tickFrequency = 4 * getTicksASecond();
...
void adjustManaRegenStepToPlayersAmount()
{
    ...
    if (necros > 0)
        manaRegenerateStep = survivors / necros; //UHHH.
...
void onTick(CBlob@ this)
{
	...
	necro.mana = Maths::Min(necro.maxMana, necro.mana + ((getPlayerCount() / 3.0f) + 2));
}