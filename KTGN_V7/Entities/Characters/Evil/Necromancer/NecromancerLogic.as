...
void onInit( CBlob@ this )
{
	...
	AddIconToken( "$Lantern$", "SpellIcons.png", Vec2f(16,16), 10 );
...
void SummonZombie(string name, Vec2f pos, int team, CPlayer@ p)
{
...
void CastSpell(CBlob@ this, const s8 charge_state, const Spell spell, Vec2f aimpos )
{
    ...
    if (spell.type == SpellType::summoning)
    {
        ...
        SummonZombie(spellName, pos, this.getTeamNum(), p);
    }//summoning
    ...
    else if (spellName == "teleport")
    {
		...
		int mapheight = map.tilesize * map.tilemapheight;
        if(aimpos.y > mapheight)
		{
