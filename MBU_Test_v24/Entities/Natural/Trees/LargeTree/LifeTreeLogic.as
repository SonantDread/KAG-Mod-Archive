...
void onInit(CBlob@ this)
{
	...
	this.SetLight(true);
	this.SetLightColor(SColor(255, 213, 255, 171));
...
void GrowSprite(CSprite@ this, TreeVars@ vars)
{
	...
	for (uint i = 0; i < segments.length; i++)
	{
		...
		if (segment !is null && !segment.gotsprites)
		{
			...
			{
				CSpriteLayer@ newsegment = this.addSpriteLayer("segment " + i, "LifeTreeTrunk.png" , 64, 16, 0, 0);
			...
			else if (segment.grown_times == 3 && i > 0 && i != vars.max_height - 1)
			{
				...
				{
					CSpriteLayer@ newsegment = this.addSpriteLayer("leaves " + i + " " + spriteindex, "LifeTreeLeaves.png" , 64, 64, 0, 0);
			...
			{
				f32 flipsign = 1.0f;
				CSpriteLayer@ newsegment = this.addSpriteLayer("roots", "LifeTreeRoots.png" , 32, 16, 0, 0);
			...
			{
				CSpriteLayer@ newsegment = this.addSpriteLayer("extra leaves top", "LifeTreeLeaves.png" , 64, 64, 0, 0);
