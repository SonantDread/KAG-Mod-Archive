...
void onTick( CMovement@ this )
{
	...
	CBlob@ carryBlob3 = blob.getCarriedBlob();
	if (carryBlob3 !is null)
		{
	
			if (carryBlob3.hasTag("regen"))
			{
			 blob.AddScript("RegenHealth2.as");
			}
			//else
			//{
			// blob.RemoveScript("RegenHealth2.as");
			//}
			
			  if (carryBlob3.hasTag("regen2"))
			{
			 blob.AddScript("RegenHealth.as");
			}
			//else
			//{
			// blob.RemoveScript("RegenHealth.as");
			//}
			
			 if (carryBlob3.hasTag("regen3"))
			{
			 blob.AddScript("RegenHealth3.as");
			}
			//else
			//{
			// blob.RemoveScript("RegenHealth3.as");
			//}
			
			 if (carryBlob3.hasTag("jumpy"))
			{
			 blob.AddScript("DoubleJump.as");
			}
			//else
			//{
			// blob.RemoveScript("DoubleJump.as");
			//}
			
            if (carryBlob3.hasTag("jumpy2"))
			{
			 blob.AddScript("TripleJump.as");
			}
			//else
			//{
			// blob.RemoveScript("TripleJump.as");
			//}
			
			 if (carryBlob3.hasTag("jumpy3"))
			{
			blob.AddScript("QuadJump.as");
				
			}
			//else
			//{
			// blob.RemoveScript("QuadJump.as");
			//}
			
			 if (carryBlob3.hasTag("fly"))
			{
			moveVars.jumpCount = 0;
			blob.RemoveScript("DrainHealth.as");
			}
			//else
			//{
			// blob.RemoveScript("DrainHealth.as");
		...
		if (carryBlob !is null)
		{
			...
			// {
				...
				// timefly--;
					// if(vel.y > 0.5f)
					// {
					// blob.AddForce(Vec2f(0,-180));
					// }
					// timeoff = 600;
				// }
			// }
			
			// else if (carryBlob.hasTag("healthy"))
			// {
				// blob.server_SetHealth(3.5f); //2.5
			// }
...
void CleanUp(CMovement@ this, CBlob@ blob, RunnerMoveVars@ moveVars)
{
	...
	if (carryBlob3 is null)
		{
			...
			//if (!blob.exists(rate_prop))
			 //blob.set_f32("regen rate", 0.0f);
			 //carryBlob3.Untag("regen");
			 //blob.Untag("regen");
			 //blob.RemoveScript("RegenHealth2.as");

			 //carryBlob3.Untag("rfalldmg");
			 //blob.Untag("rfalldmg");
			// blob.RemoveScript("rfalldmg.as");
			 
			// carryBlob3.Untag("regen2");
			// blob.Untag("regen2");
			// blob.RemoveScript("RegenHealth.as");	 
			 
			// carryBlob3.Untag("regen3");
			// blob.Untag("regen3");
			// blob.RemoveScript("RegenHealth3.as");
			 
			 //carryBlob3.Untag("jumpy");
			// blob.Untag("jumpy");
			 blob.RemoveScript("DoubleJump.as");
			 
			 //carryBlob3.Untag("jumpy2");
			// blob.Untag("jumpy2");
			 blob.RemoveScript("TripleJump.as");
			 
			 //carryBlob3.Untag("jumpy3");
			// blob.Untag("jumpy3");
			 blob.RemoveScript("QuadJump.as");
			 
			 //carryBlob3.Untag("fly");
			 //blob.Untag("fly");
			// blob.RemoveScript("DrainHealth.as");
	...
	//blob.RemoveScript("RegenHealth2.as");
	//blob.RemoveScript("RegenHealth.as");
	//blob.RemoveScript("DoubleJump");
	//blob.RemoveScript("TripleJump");
	//blob.RemoveScript("QuadJump");
	//blob.RemoveScript("rfalldmg");
}
