...
string[] layout_names = 
{"piano","bayan","guitar","wicki", "flute"};
...
void onRender(CSprite@ this)
{
	...
	if(blob !is null)
	{
		...
		if(playerblob !is null && playerblob.isMyPlayer())
		{
    ...
    {        
        ...
        if(isGuitar)
        {
        	for(s8 i = 7; i > 0; i--)
        	{
        		...
        		GUI::DrawText( ""+i+":"+number, Vec2f(0, scr.y*6/8+40+(7-i)*10) , Vec2f(scr.x/2 + scr.x/4 , scr.y/12), withinRange?firstcolor:secondcolor, true, true);
        	}
        }
