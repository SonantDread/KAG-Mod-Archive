...
const int coinsOnDamageAdd = 6; //5
const int coinsOnAssistAdd = 14; //7 helping is just as useful as killing
const int coinsOnKillAdd = 14; //10

const int coinsOnDeathLosePercent = 10; //20
const int coinsOnTKLose = 50; //50

const int coinsOnRestartAdd = 100; //0
const bool keepCoinsOnRestart = false;

const int coinsOnHitSiege = 2; // 5 per heart of damage
const int coinsOnKillSiege = 10; //20 siege meta cringe

const int coinsOnCapFlag = 250; //100

const int coinsOnBuildStoneBlock = 4; //3
const int coinsOnBuildStoneDoor = 6; //5
const int coinsOnBuildWood = 2; //1
const int coinsOnBuildWorkshop = 16; //10
