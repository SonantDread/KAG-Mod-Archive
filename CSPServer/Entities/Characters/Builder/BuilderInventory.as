...
void onInit( CInventory@ this )
{
	...
	if (!blob.exists(inventory_offset)) blob.set_Vec2f(inventory_offset, Vec2f(0.0f, 174));
...
void MakeBlocksMenu( CInventory@ this, CGridMenu @invmenu )
{
	...
	Vec2f pos( invmenu.getUpperLeftPosition().x + 0.5f*(invmenu.getLowerRightPosition().x - invmenu.getUpperLeftPosition().x), invmenu.getUpperLeftPosition().y - 24 * MENU_SIZE.y - 50 );
