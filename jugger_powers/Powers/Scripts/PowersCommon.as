...
string getPowerName(u8 pow) {
    switch(pow) {
        ...
        case Powers::FLIGHT: return "Flight";
        ...
        case Powers::KNOCKBACK: return "Knockback";
    }
    return "No Power";
}
...
string getPowerScriptName(u8 pow) {
    switch(pow) {
        ...
        case Powers::FLIGHT: return "PowerFlight.as";
        ...
        case Powers::KNOCKBACK: return "PowerKnockback";
    }
    return "";
}
...
string getPowerTip(u8 pow) {
    switch(pow) {
        ...
        case Powers::FLIGHT: return "The Flight power allows you to fly!";
	    ...
	    case Powers::HEALER: return "Healer allows you to heal everyone around you with the B key!";
        case Powers::KNOCKBACK: return "The Knockback power allows you to hit things farther!";
    }
    return "";
}
