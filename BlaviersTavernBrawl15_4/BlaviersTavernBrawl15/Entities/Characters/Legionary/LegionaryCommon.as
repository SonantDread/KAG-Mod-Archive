...
namespace KnightVars
{
	...
	const ::s32 slash_charge_level2 = 40;
	const ::s32 slash_charge_limit = 34;
...
const f32 DEFAULT_ATTACK_DISTANCE = 30.0f;
const f32 MAX_ATTACK_DISTANCE = 44.0f;
const f32 SHIELD_KNOCK_VELOCITY = 9.0f;

const f32 SHIELD_BLOCK_ANGLE = 250.0f;
const f32 SHIELD_BLOCK_ANGLE_GLIDING = 160.0f;
