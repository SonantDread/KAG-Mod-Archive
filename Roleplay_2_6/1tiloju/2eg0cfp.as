...
string getSkinPath( CBlob@ blob, CPlayer@ player, string username )
{
	...
	if (username == "Aphelion")
		...
		skin_path = "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Builder/Sprites/Special/Ultimate.png";
	...
	// -- SPONSOR
	else if (username == "master-chief")
		skin_path = "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Builder/Sprites/Special/Sponsor/Chief.png";
	else if (username == "bbpolkagal")
		skin_path = "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Builder/Sprites/Special/Doggie.png";
		...
		skin_path = "../Mods/" + RP_NAME + "/Entities/Characters/Classes/Builder/Sprites/Special/Sponsor/Doggie.png";
