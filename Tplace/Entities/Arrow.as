...
const f32 arrowMediumSpeed = 25.0f;
const f32 arrowFastSpeed = 50.0f;
//maximum is 15 as of 22/11/12 (see ArcherCommon.as)

const f32 ARROW_PUSH_FORCE = 10.0f;
const f32 SPECIAL_HIT_SCALE = 2.0f; //special hit on food items to shoot to team-mates

const s32 FIRE_IGNITE_TIME = 500000000;
