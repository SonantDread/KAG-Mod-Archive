...
namespace ArcherParams
{
	...
	const ::s32 legolas_arrows_count = 10;
	const ::s32 legolas_arrows_volley = 10;
	const ::s32 legolas_arrows_deviation = 30;
	const ::s32 legolas_time = 100;
}

//TODO: move vars into archer params namespace
const f32 archer_grapple_length = 170.0f;
const f32 archer_grapple_slack = 16.0f;
const f32 archer_grapple_throw_speed = 25.0f;
