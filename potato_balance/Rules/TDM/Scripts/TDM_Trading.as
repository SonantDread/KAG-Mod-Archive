...
void MakeTradeMenu(CBlob@ trader)
{
	...
	addItemForCoin(trader, "Splash Bomb", cost_waterbombs, true, "$mat_waterbombs$", "mat_waterbombs", Descriptions::waterarrows);
	...
	addItemForCoin(trader, "Splash Arrows", cost_waterarrows, true, "$mat_waterarrows$", "mat_waterarrows", Descriptions::waterarrows);
