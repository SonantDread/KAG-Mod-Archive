...
void onInit(CBlob@ this)
{
	...
	{
		AddIconToken("$shop_waterbombs$", "/Entities/Items/Explosives/WaterBomb.png", Vec2f(16.0f, 16.0f), 1);
		ShopItem@ s = addShopItem(this, "Splash Bombs", "$shop_waterbombs$", "mat_waterbombs", Descriptions::waterbomb, true);
