...
void onInit(CBlob@ this)
{
	...
	{
		AddIconToken("$shop_waterarrows$", "/Entities/Materials/Materials.png", Vec2f(16.0f, 16.0f), 36);
		ShopItem@ s = addShopItem(this, "Splash Arrows", "$shop_waterarrows$", "mat_waterarrows", Descriptions::waterarrows, true);
...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	if (caller.getConfig() == this.get_string("required class") || getRules().get_bool("lockclasses"))
	{
		this.set_Vec2f("shop offset", Vec2f_zero);
	}
	else
