//Boomeranger "cling" clashing sound
...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	if (hitterBlob.getPosition().x < this.getPosition().x && hitterBlob.getName() == "boomeranger") // Boomeranger and the left one (to play only once)
	{
