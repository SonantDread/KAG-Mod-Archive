...
{
	const ::s32 resheath_time = 30; //5

	const ::s32 slash_charge = 27;
	const ::s32 slash_charge_level2 = 63; //53
	const ::s32 slash_charge_limit = 100; //70
...
const int DELTA_END_ATTACK = 4; //4
