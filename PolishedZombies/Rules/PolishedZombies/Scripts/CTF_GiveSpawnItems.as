...
const u32 materials_wait_warmup = 0; //seconds between free mats
...
bool GiveSpawnResources(CRules@ this, CBlob@ blob, CPlayer@ player, CTFPlayerInfo@ info)
{
	...
	else if (blob.getName() == "mage")
	{
		ret = SetMaterials(blob, "mat_orbs", 16) || ret;

		if (ret)
		{
			info.items_collected |= ItemFlag::Mage;
		}
	}
