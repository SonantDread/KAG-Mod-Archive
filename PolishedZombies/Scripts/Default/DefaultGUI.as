...
void LoadDefaultGUI()
{
	if (v_driver > 0)
	{
		...
		AddIconToken("$gold_block$", "Sprites/World.png", Vec2f(8, 8), CMap::tile_goldB);
		...
		AddIconToken("$gold_door$", "GoldDoorIcon.png", Vec2f(10, 8), 0);
		...
		AddIconToken("$mageshop$", "MageShop.png", Vec2f(40, 24), 0);
		AddIconToken("$stonequarry$", "Quarry.png", Vec2f(40, 24), 4);
		AddIconToken("$drill$", "DrillIcon.png", Vec2f(16, 16), 0);
		AddIconToken("$megadrill$", "MegaDrillIcon.png", Vec2f(16, 16), 0);
	}
}
