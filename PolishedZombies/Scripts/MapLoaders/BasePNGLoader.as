...
class PNGLoader
{
	...
	void handlePixel(const SColor &in pixel, int offset)
	{
		...
		else
		{
			...
			// Extra
			case map_colors::zombie_spawn:		autotile(offset); AddMarker(map, offset, "zombie spawn");  break;
			case map_colors::zombie_portal:		autotile(offset); AddMarker(map, offset, "zombie portal");  break;
			case map_colors::random_scroll:		autotile(offset); AddMarker(map, offset, "random scroll");  break;
			case map_colors::random_tech:		autotile(offset); AddMarker(map, offset, "random tech");  break;
