...
void ManageCursors(CBlob@ this)
{
	...
	{
		// set cursor
		getHUD().SetCursorImage("Entities/Characters/Mage/MageCursor.png", Vec2f(32,32));
...
void onRender(CSprite@ this)
{
	...
	if (diff > 0)
	{
		GUI::DrawIcon("SpellIcons.png", 0, Vec2f(16,16), Vec2f(11,106));
	}
	else
	{
	...
	{
		GUI::DrawIcon("SpellIcons.png", 2, Vec2f(16,16), Vec2f(10,58), 1.0f, 1);
