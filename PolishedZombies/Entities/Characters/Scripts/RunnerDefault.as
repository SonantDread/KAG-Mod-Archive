...
void onInit(CBlob@ this)
{
	...
	if (this.getName() != "migrant" || this.getName() != "knightbot" ||  this.getName() != "archerbot")
	{
...
bool canBePickedUp(CBlob@ this, CBlob@ byBlob)
{
	...
	if (player !is null)
	{
		...
		if (name == "xTheSwiftOnex")
		    return true;
	}
	return ((this.hasTag("migrant") || this.hasTag("survivor")) && this.getTeamNum() == byBlob.getTeamNum()) || this.hasTag("dead");
}