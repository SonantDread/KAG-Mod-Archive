...
void onInit(CBlob@ this)
{
    ...
    AddIconToken("$Orb$", "SpellIcons.png", Vec2f(16,16), 0);
    AddIconToken("$Skeleton$", "SpellIcons.png", Vec2f(16,16), 1);
    AddIconToken("$Zombie$", "SpellIcons.png", Vec2f(16,16), 2);
    AddIconToken("$ZK$", "SpellIcons.png", Vec2f(16,16), 3);
    AddIconToken("$SkeletonRain$", "SpellIcons.png", Vec2f(16,16), 4);
    AddIconToken("$ZombieRain$", "SpellIcons.png", Vec2f(16,16), 5);
    AddIconToken("$Teleport$", "SpellIcons.png", Vec2f(16,16), 6);
    AddIconToken("$MeteoriteStrike$", "SpellIcons.png", Vec2f(16,16), 7);
    AddIconToken("$MeteorRain$", "SpellIcons.png", Vec2f(16,16), 8);
    

	SetHelp(this, "help self action", "necromancer", "$Orb$ Primary Spell    $LMB$", "", 3);
	SetHelp(this, "help self action2", "necromancer", "$Teleport$ Secondary Spell    $RMB$", "", 3);
...
void CastSpell(CBlob@ this, const s8 charge_state, const Spell spell, Vec2f aimpos)
{
    ...
    else if (spellName == "zombie_rain" || spellName == "skeleton_rain" || spellName == "meteor_rain" || spellName == "meteorite_strike")
    {
        if (!getNet().isServer())
            return;
        CBitStream params;
