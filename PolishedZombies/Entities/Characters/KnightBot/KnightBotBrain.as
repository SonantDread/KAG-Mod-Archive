...
void AttackBlob(CBlob@ blob, CBlob @target)
{
	...
	bool shieldTime = gametime - blob.get_u32("shield time") < uint(20 * 1.33f + XORRandom(20));
    ...
    {
        // start attack
        if (XORRandom(Maths::Max(3, -8)) == 0 && (getGameTime() - blob.get_u32("attack time")) > 10)
        {		
    ...
    else if (targetDistance < 40.0f && getGameTime() - blob.get_u32("attack time") < (Maths::Min(13, 18))) // release and attack when appropriate
    {
