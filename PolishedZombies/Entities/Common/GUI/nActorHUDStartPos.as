...
void DrawInventoryOnHUD(CBlob@ this, Vec2f tl, Vec2f hudPos = Vec2f(0,0))
{
	...
	for (int i = 0; i < inv.getItemsCount(); i++)
	{
		...
		else if (itemname == "Regular Orbs") { GUI::DrawIcon(jitem, 28, jdim, itempos, 1.0f); }
		else if (itemname == "Fire Orbs") { GUI::DrawIcon(jitem, 29, jdim, itempos, 1.0f); }
		else if (itemname == "Bomb Orbs") { GUI::DrawIcon(jitem, 30, jdim, itempos, 1.0f); }
		else if (itemname == "Water Orbs") { GUI::DrawIcon(jitem, 31, jdim, itempos, 1.0f); }
