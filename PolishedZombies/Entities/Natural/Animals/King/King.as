...
const u16 BLOCK_HIT_CHANCE = 100;
const f32 KNOCKBACK_POWER = 23.0f;
const u16 COINS_ON_DEATH = 275;
...
{	
    ...
    getNet().server_SendMsg("An undead king has appeared!");
...
if (hitBlob !is null)
	{
		...
		Vec2f force = forcePow * this.getMass() * damage * KNOCKBACK_POWER * 0.5;
