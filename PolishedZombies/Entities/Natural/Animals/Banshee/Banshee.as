...
{	
	...
	this.getSprite().PlayRandomSound("/BansheeSpawn");

	this.getSprite().SetEmitSound("/BansheeFly");
    ...
    // explosiveness
	this.set_f32("explosive_radius", 350.0f);
	this.set_f32("explosive_damage", 25.0f);
	this.set_string("custom_explosion_sound", "Entities/Items/Explosives/KegExplosion.ogg");
	this.set_f32("map_damage_radius", 350.0f);
	this.set_f32("map_damage_ratio", 7.0f);
