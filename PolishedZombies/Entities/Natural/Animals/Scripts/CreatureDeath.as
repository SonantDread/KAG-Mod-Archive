...
void onTick(CBlob@ this)
{
	...
	if (this.get_u32("death time") + VANISH_BODY_SECS * getTicksASecond() < getGameTime())
	{
		...
		else if (this.getName() == "zknight")
			server_CreateBlob("zknight", -1, this.getPosition());
		else if (this.getName() == "horror")
			server_CreateBlob("horror", -1, this.getPosition());
		else if (this.getName() == "king")
			server_CreateBlob("king", -1, this.getPosition());
		else if (this.getName() == "hknight")
			server_CreateBlob("hknight", -1, this.getPosition());
