...
void onInit(CBlob @ this)
{
	...
	this.set_string("custom_explosion_sound", "MeteorExplosion.ogg");
...
void onCollision(CBlob@ this, CBlob@ blob, bool solid)
{
	...
	if (solid || (solid && this.getTeamNum() != blob.getTeamNum()))
	{		
...
void makeSmokeParticle(CBlob@ this, const Vec2f vel, const string filename = "Smoke")
{
	...
	CParticle@ p = ParticleAnimated("GenericBlast.png", this.getPosition() + random, Vec2f(0,0), float(XORRandom(360)), 1.0f, 2 + XORRandom(3), 0.0f, false);
	if (p !is null)
	{
		p.bounce = 0;
