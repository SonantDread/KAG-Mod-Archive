...
{	 
	...
	{
		ShopItem@ s = addShopItem( this, "Heroic Soul", "$whitebook$", "randomBook", "Merge 10 Soul Shards into a random Heroic Soul.", true);
		AddRequirement( s.requirements, "blob", "whitepage", "Soul Shards", 10 );
	}	
