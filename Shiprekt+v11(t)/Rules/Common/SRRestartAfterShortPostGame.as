...
string getRandomMap(CRules@ this)
{
	...
	if ( pCount <= 8 || true )
	{
		maps.push_back( "CenterIsles2.png" );
	 	   maps.push_back( "CenterIsles.png" );    maps.push_back( "SandBars.png" );  maps.push_back( "LandSlabs.png" ); maps.push_back( "ScatteredIsles.png" );  maps.push_back( "Islands.png" );  maps.push_back( "Lanes.png" );           	}
