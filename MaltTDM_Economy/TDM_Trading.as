...
void MakeTradeMenu(CBlob@ trader)
{
	...
	s32 cost_bombs = 20;// cfg.read_s32("cost_bombs", 10);
	s32 cost_waterbombs = 60; //cfg.read_s32("cost_waterbombs", 60);
	s32 cost_keg = 50; //cfg.read_s32("cost_keg", 40);
	s32 cost_mine = 40; //cfg.read_s32("cost_mine", 40);

	s32 cost_arrows = 0; //cfg.read_s32("cost_arrows", 0);
	s32 cost_waterarrows = 60; //cfg.read_s32("cost_waterarrows", 40);
	s32 cost_firearrows = 15; //cfg.read_s32("cost_firearrows", 15);
	s32 cost_bombarrows = 40; //cfg.read_s32("cost_bombarrows", 30);

	s32 cost_boulder = 20; //cfg.read_s32("cost_boulder", 10);
	s32 cost_burger = 50; //cfg.read_s32("cost_burger", 50);
	s32 cost_sponge = 10; //cfg.read_s32("cost_sponge", 10);
  s32 cost_chicken = 20;
	...
	addItemForCoin(trader, "Chicken", cost_chicken, true, "$chicken$", "chicken", Descriptions::chicken);
	//vehicles
