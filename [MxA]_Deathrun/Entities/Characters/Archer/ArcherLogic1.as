...
void onTick(CBlob@ this)
{
	...
	{
		this.setPosition(this.get_Vec2f("tpPos"));
...
bool checkGrappleStep(CBlob@ this, ArcherInfo@ archer, CMap@ map, const f32 dist)
{
	...
	{
		if (map.getTile(archer.grapple_pos + Vec2f(0, -3)).type == CMap::tile_archerblock ||
			map.getTile(archer.grapple_pos + Vec2f(0, 3)).type == CMap::tile_archerblock ||
			map.getTile(archer.grapple_pos + Vec2f(3, 0)).type == CMap::tile_archerblock ||
			map.getTile(archer.grapple_pos + Vec2f(-3, 0)).type == CMap::tile_archerblock)
		{
			archer.grapple_id = 0;
...
{
	return  map.isTileSolid(archer.grapple_pos + Vec2f(0, -3)) ||
	        map.isTileSolid(archer.grapple_pos + Vec2f(3, 0)) ||
	        map.isTileSolid(archer.grapple_pos + Vec2f(-3, 0)) ||
	        map.isTileSolid(archer.grapple_pos + Vec2f(0, 3)) ||
	        (dist > 10.0f && map.getSectorAtPosition(archer.grapple_pos, "tree") !is null);
}
