...
class PNGLoader
{
	...
	void handlePixel(const SColor &in pixel, int offset)
	{
		...
		else
		{
			...
			case map_colors::tile_archerblock:		spawnBlob(map, "ArcherBlock", -1, position, true);	  break;
			case map_colors::tile_switch:			spawnBlob(map, "Switch", -1, position, true);		  break;
