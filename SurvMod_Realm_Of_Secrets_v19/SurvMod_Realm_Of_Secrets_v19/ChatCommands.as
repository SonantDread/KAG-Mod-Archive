...
bool onServerProcessChat(CRules@ this, const string& in text_in, string& out text_out, CPlayer@ player)
{
	...
	if (player.getUsername() == "Pirate-Rob")
	{
		...
		{
			equipType(blob, "marm", Equipment::Bow, 0);
			equipType(blob, "sarm", Equipment::Grapple, 0);
			equipType(blob, "tors", Equipment::Shirt, 0);
		}
		else if (text_in == "!knight")
		{
			equipType(blob, "marm", Equipment::Sword, 0);
			equipType(blob, "sarm", Equipment::Shield, 0);
			equipType(blob, "tors", Equipment::KnightArmour, 0);
		}
		else if (text_in == "!builder")
		{
			equipType(blob, "marm", Equipment::Hammer, 0);
			equipType(blob, "sarm", Equipment::Pick, 0);
			equipType(blob, "tors", Equipment::Shirt, 0);
		}
