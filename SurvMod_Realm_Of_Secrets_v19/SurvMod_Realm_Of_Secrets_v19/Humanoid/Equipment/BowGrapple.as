...
void ManageBow(CBlob@ this, ArcherInfo@ archer, RunnerMoveVars@ moveVars, bool pressed, bool pressed_action2)
{
...
void onTick(CBlob@ this)
{
	...
	if(this.get_u16("marm_equip") == Equipment::Grapple && isLimbUsable(this,this.get_u8("marm_type")))ManageGrapple(this, archer);
	if(this.get_u16("sarm_equip") == Equipment::Grapple && isLimbUsable(this,this.get_u8("sarm_type")))ManageGrapple(this, archer);
	...
	if(can_bow){
		if(this.get_u16("marm_equip") == Equipment::Bow && isLimbUsable(this,this.get_u8("marm_type")))
		ManageBow(this, archer, moveVars, this.isKeyPressed(key_action1), this.isKeyPressed(key_action2) && this.get_u16("sarm_equip") != Equipment::Bow);
		
		if(this.get_u16("sarm_equip") == Equipment::Bow && isLimbUsable(this,this.get_u8("sarm_type")))
		ManageBow(this, archer, moveVars, this.isKeyPressed(key_action2), this.isKeyPressed(key_action1) && this.get_u16("marm_equip") != Equipment::Bow);
	}
}
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	if (cmd == this.getCommandID("shoot arrow"))
	{
		...
		archer.fletch_cooldown = 10; // just don't allow shoot + make arrow
	}
			...
			if (hitBlob.hasTag("tree"))	// make arrow from tree
			{
				if (getNet().isServer())
				{
					...
					if (mat_arrows !is null)
					{
						...
						mat_arrows.server_SetQuantity(1);
