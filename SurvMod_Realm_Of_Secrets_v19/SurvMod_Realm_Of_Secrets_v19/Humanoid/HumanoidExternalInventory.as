...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if(this.getPlayer() is null && (!this.getBrain().isActive() || this.getTeamNum() == caller.getTeamNum()) && this.getDistanceTo(caller) < 24)caller.CreateGenericButton(13, Vec2f(0,0), this, this.getCommandID("access_inv"), "Equipment", params);
}
