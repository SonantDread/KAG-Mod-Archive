...
void MakeTradeMenu(CBlob@ trader)
{
	...
	s32 cost_satchel = cfg.read_s32("cost_satchel", 60);
	s32 cost_molotov = cfg.read_s32("cost_molotov", 35);
	...
	s32 cost_mountedbow = cfg.read_s32("cost_mountedbow", 50);
	...
	if (cost_mine > 0)
		addItemForCoin(trader, "Molotov Cocktail", cost_molotov, true, "$mat_molotov$", "mat_molotov", "Made by Diprog");

	if (cost_satchel > 0)
		addItemForCoin(trader, "Bomb Satchel", cost_satchel, true, "$bomb_satchel$", "bomb_satchel", "Made by Skinney");
