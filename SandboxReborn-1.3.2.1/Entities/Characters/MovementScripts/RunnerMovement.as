...
void onTick(CMovement@ this)
{
	...
	//flying - overrides other movement partially
	if (blob.get_bool("flight") && !isknocked)
	{
		shape.SetGravityScale(0.0f);
		Vec2f flightforce;
	...
	if (blob.isInWater() && !isknocked)
	{
		...
		const f32 swimspeed = blob.get_bool("aqua")?moveVars.swimspeed*5:moveVars.swimspeed;
