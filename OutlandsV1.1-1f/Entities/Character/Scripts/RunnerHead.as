...
CSpriteLayer@ LoadHead(CSprite@ this, u8 headIndex)
{
	...
	string tex = "Entities/Characters/Sprites/Heads.png";
	if (team <= 7)
		tex = "Entities/Characters/Sprites/Heads.png";
	else if (team >= 8 && team <= 15)
		tex = "..Mods/"+mod_name+"/Entities/Character/Sprites/HeadsB.png";
	else if (team >= 16 && team <= 23)
		tex = "..Mods/"+mod_name+"/Entities/Character/Sprites/HeadsS.png";
	else if (team >= 24 && team <= 31)
		tex = "..Mods/"+mod_name+"/Entities/Character/Sprites/HeadsW.png";
...
void onTick(CSprite@ this)
{
	...
	if (head !is null)
	{
		...
		string texname = "nope";
		string tex = blob.getSexNum() == 0 ?
						"Entities/Characters/"+this.getBlob().getName()+"/"+this.getBlob().getName()+"Male.png" :
						"Entities/Characters/"+this.getBlob().getName()+"/"+this.getBlob().getName()+"Female.png";
		texname = tex;
		PixelOffset @po = getDriver().getPixelOffset( texname, this.getFrame());
