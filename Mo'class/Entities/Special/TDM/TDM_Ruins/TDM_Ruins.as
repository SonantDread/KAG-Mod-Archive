...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$berserker_class_icon$", "GUI/MenuItems.png", Vec2f(32, 32), 16);
	AddIconToken("$ranger_class_icon$", "GUI/MenuItems.png", Vec2f(32, 32), 16);
	AddIconToken("$scout_class_icon$", "GUI/MenuItems.png", Vec2f(32, 32), 16);
	AddIconToken("$guard_class_icon$", "GUI/MenuItems.png", Vec2f(32, 32), 13);
	//TDM classes
	...
	addPlayerClass(this, "Berserker", "$berserker_class_icon$", "berserker", "Brute With a Dash");
	addPlayerClass(this, "Ranger", "$ranger_class_icon$", "ranger", "Quickshot Demon");
	addPlayerClass(this, "Scout", "$scout_class_icon$", "scout", "Speed and Swankity Swank");
	addPlayerClass(this, "Guard", "$guard_class_icon$", "guard", "6 Hearts of Steel");
