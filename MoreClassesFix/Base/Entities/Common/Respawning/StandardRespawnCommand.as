...
void InitClasses(CBlob@ this)
{
	...
	AddIconToken("$crossbowman_class_icon$", "GUI/MenuItems.png", Vec2f(32, 32), 36);
...
void BuildRespawnMenuFor(CBlob@ this, CBlob @caller)
{
	...
	{
		CGridMenu@ menu = CreateGridMenu(caller.getScreenPos() + Vec2f(24.0f, caller.getRadius() * 1.0f + 48.0f), this, Vec2f(3 * CLASS_BUTTON_SIZE, ((classes.length) / 3 + 1) * CLASS_BUTTON_SIZE), "Swap class");
		if (menu !is null)
		{
