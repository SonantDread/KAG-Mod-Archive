...
void onInit(CSprite@ this)
{
	...
	string texname = this.getBlob().getSexNum() == 0 ?
	                 modpath+"KnightMaleShieldLess.png" :
					 modpath+"KnightFemaleShieldLess.png";
...
void onTick(CSprite@ this)
{
	...
	if(!blob.hasTag("has_shield_sprite") && blob.hasTag("has_shield")){
		string modpath = getFilePath(getCurrentScriptName())+"/";
		string texname = this.getBlob().getSexNum() == 0 ?
	                 modpath+"KnightMale.png" :
					 modpath+"KnightFemale.png";
		this.ReloadSprite(texname);
		blob.Tag("has_shield_sprite");
	}
