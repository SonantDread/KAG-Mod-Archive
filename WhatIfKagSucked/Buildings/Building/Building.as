...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$blacksmith$", "Blacksmith.png", Vec2f(40, 24), 0);
	AddIconToken("$forge$", "Forge.png", Vec2f(40, 24), 0);
	AddIconToken("$mat_metalbars$", "MetalBars.png", Vec2f(16, 16), 3);
	...
	{
		ShopItem@ s = addShopItem(this, "Forge", "$forge$", "forge", "A place for smelting.");
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 100);
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 50);
	}
	{
		ShopItem@ s = addShopItem(this, "Blacksmith", "$blacksmith$", "blacksmith", "A place for smithing metal.");
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 100);
		AddRequirement(s.requirements, "blob", "mat_metalbars", "Metal Bars", 5);
	}
}
