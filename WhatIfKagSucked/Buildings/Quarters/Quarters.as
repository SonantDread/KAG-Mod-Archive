...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Bread", "$bread$", "bread", "Heals 2 hearts.", true);
		AddRequirement(s.requirements, "blob", "grain", "Grain", 1);
	}
	{
		ShopItem@ s = addShopItem(this, "Steak", "$cookedsteak$", "cooked_steak", "Heals 2 hearts.", true);
		AddRequirement(s.requirements, "blob", "steak", "Raw Steak", 1);
	}
	{
		ShopItem@ s = addShopItem(this, "Burger", "$burger$", "food", "Heals 4 hearts.", true);
		AddRequirement(s.requirements, "blob", "bread", "Bread", 1);
		AddRequirement(s.requirements, "blob", "cooked_steak", "Steak", 1);
	}
	{
		ShopItem@ s = addShopItem(this, "Fish Stick", "$fishstick$", "cooked_fish", "Heals 3 hearts.", true);
