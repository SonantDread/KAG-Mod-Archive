...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
  ...
  caller.CreateGenericButton(11, Vec2f_zero, this, this.getCommandID("sudden gib"),
                             "Use this to make all visible enemies instantly turn into a pile of gibs.", params);
}
