...
void InitLoot( CBlob@ this )
{
    ...
    */
	...
	addLoot(this, "coins", 100, XORRandom(200) + 1); //chest will drop coins with quantity 1 - 30
	addLoot(this, "shard", 0, 1);
	...
	if (rc3==0)
		...
		addLoot(this, "goldenegg", 0, 1);
	else if (rc1==2)
		addLoot(this, "shard", 0, 2);
	else if (rc3==3)
		addLoot(this, "dragoonwings", 0, 1);
	else if (rc3==4)
		addLoot(this, "wizardstaff", 0, 1);
	else if (rc3==5)
		addLoot(this, "greataxe", 0, 1);
	
	// item
	int ri1 = XORRandom(10);
	...
	if (ri1==0)
		...
		addLoot(this, "goldengun", 0, 1);
	else if (ri1<=5)
		addLoot(this, "golddrill", 0, 1);
