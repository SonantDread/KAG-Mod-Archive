...
const f32 speed_thresh = 5.0f;
const f32 speed_hard_thresh = 5.0f;

const string buzz_prop = " timer";

const string heat_prop = "blesseddrill heat";
const u8 heat_max = 320;

const u8 heat_add = 0;
const u8 heat_add_blob = heat_add*0.5;
...
void onTick( CBlob@ this )
{
    ...
    if (this.isAttached())
    {
		...
		if (inwater)
		{
			this.getSprite().SetEmitSoundSpeed(0.6f + (getGameTime() % 13)*0.01f);
		}
		else
		{
