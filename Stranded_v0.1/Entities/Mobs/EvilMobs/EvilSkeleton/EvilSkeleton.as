...
void onInit(CBlob@ this)
{
	...
	this.set_string("attack sound", "EvilSkeletonAttack");
	this.set_u16("coins on death", COINS_ON_DEATH);
	this.set_f32(target_searchrad_property, 512.0f);

    this.getSprite().PlayRandomSound("/EvilSkeletonSpawn");
...
void onTick(CBlob@ this)
{
	...
	{
		this.getSprite().PlaySound("/EvilSkeletonSayDuh");
	}
...
f32 onHit( CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData )
{
	if (damage >= 0.0f)
	{
	    this.getSprite().PlaySound("/EvilSkeletonHit");
    }
...
void onDie( CBlob@ this )
{
    ...
    this.getSprite().PlaySound("/EvilSkeletonBreak1");	
}