...
{	 
	...
	}	
	{
		...
		AddRequirement( s.requirements, "blob", "wizardstaff", "wizardstaff", 1);
	}
	{
	...
	{
		ShopItem@ s = addShopItem( this, "GunShop", "$gunshop$", "gunshop", "Buy guns that go pew pew." );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 200 );
		AddRequirement( s.requirements, "blob", "mat_stone", "Stone", 200 );
		AddRequirement( s.requirements, "blob", "mat_iron", "Iron", 200 );
		AddRequirement( s.requirements, "blob", "goldengun", "goldengun", 1 );
	}
