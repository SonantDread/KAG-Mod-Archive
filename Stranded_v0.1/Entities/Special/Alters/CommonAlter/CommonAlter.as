...
{	 
	...
	CSpriteLayer@ portal = this.getSprite().addSpriteLayer( "portal", "CommonAlter.png" , 64, 64);
...
{
	int spawnRate = 200 + (190 * this.getHealth() / 44.0);
...
{
	server_DropCoins(this.getPosition() + Vec2f(0,-32.0f), 200);
