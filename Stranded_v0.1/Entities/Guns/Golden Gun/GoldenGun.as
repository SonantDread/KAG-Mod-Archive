...
const u8 FIRE_INTERVAL = 60; // How long do we wait before firing again in ticks
const u8 CLIP        = 6;  // Clip size
const u8 TOTAL       = 64;  // Total ammo count
...
const s16 G_RECOIL = -5; // 0 is off, add's recoil based on number given (try -10 for example)

const float B_DAMAGE = 10.0f; // 1.0f = 1 heart
