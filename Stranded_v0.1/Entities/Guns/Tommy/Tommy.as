...
const u8 FIRE_INTERVAL = 5; // How long do we wait before firing again in ticks
const u8 CLIP        = 30;  // Clip size
const u8 TOTAL       = 250;  // Total ammo count
const u8 RELOAD_TIME = 7;   // How long do we wait in ticks to reload
...
const u8 B_SPEED	 = 45;   // Bullet speed, STRONGLY AFFECTED/EFFECTS B_GRAV FOR NOW
...
const float B_DAMAGE = 3.5f; // 1.0f = 1 heart

const Vec2f B_GRAV   = Vec2f(0.0,0.003); // Bullet gravity drop
...
const string FIRE_SOUND    = "SMGFire.ogg";   // Sound we make when pulling the trigger
