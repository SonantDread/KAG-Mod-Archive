...
const u8 FIRE_INTERVAL = 20; // How long do we wait before firing again in ticks
const u8 CLIP        = 8;  // Clip size
const u8 TOTAL       = 160;  // Total ammo count
...
const u8 B_SPREAD	 = 1;    // The higher the value, the more 'uncontrolable' bullets get | USEFUL FOR BUL_PER_SHOT INCREASE 
const u8 B_SPEED	 = 50;   // Bullet speed, STRONGLY AFFECTED/EFFECTS B_GRAV FOR NOW
...
const float B_DAMAGE = 3.0f; // 1.0f = 1 heart
...
const string FIRE_SOUND    = "AutoFire.ogg";   // Sound we make when pulling the trigger
