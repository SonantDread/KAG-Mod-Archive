...
const SColor color_spawn_ruins(0xff329332);
const SColor color_alter(0xff710d71);
...
class PNGLoader
{
	...
	if (pixel == color_tile_ground) {
		...
		//BUILDINGS
			...
			spawnBlob( map, "hand", offset, 0);
			offsets[autotile_offset].push_back( offset );
		}	
		else if (pixel == color_zombie_spawn) {
			spawnBlob( map, "evilportal", offset, 1);
			AddMarker( map, offset, "mob spawn" );
		}			
		else if (pixel == color_spawn_ruins) {
			spawnBlob( map, "ruinsspawn", offset, 1);
		}	
		else if (pixel == color_alter) {
			AddMarker( map, offset, "alter" );
		}		
	...
	void SetupBackgrounds()
	{
		...
		map.AddBackground( "Sprites/Back/Jungle_BackgroundPlains.png", Vec2f(0.0f, 0.0f), Vec2f(0.3f, 0.3f), color_white ); 
		...
		map.AddBackground( "Sprites/Back/BackgroundCastle-autumn.png", Vec2f(0.0f, 50.0f), Vec2f(0.6f, 0.6f), color_white ); 
		map.AddBackground( "Sprites/Back/BackgroundCastle-summer.png", Vec2f(0.0f, 50.0f), Vec2f(0.6f, 0.6f), color_white ); 
