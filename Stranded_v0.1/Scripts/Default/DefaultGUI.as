...
void LoadDefaultGUI()
{
    if (v_driver > 0)
    {
		...
		AddIconToken( "$commonalter$", "..Special/Alters/AlterIcon.png", Vec2f(16,16), 0 );
		AddIconToken( "$rarealter$", "..Special/Alters/AlterIcon.png", Vec2f(16,16), 0 );
		AddIconToken( "$epicalter$", "..Special/Alters/AlterIcon.png", Vec2f(16,16), 0 );
