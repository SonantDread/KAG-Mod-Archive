...
s32 cost_keg = 120;
s32 cost_mine = 60;
s32 cost_molotov = 50;  // <== Change that value if you're willing to change the cost of a molotov.

void onInit(CBlob@ this)
{
	AddIconToken("$Molotov_ico$","Molotov.png", Vec2f(16,16), 0);
	...
	{
		ShopItem@ s = addShopItem(this, "Molotov", "$Molotov_ico$", "mat_molotov", "A molotov to set things on fire.", true);
