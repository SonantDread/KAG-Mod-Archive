...
void onRender(CSprite@ this)
{
	...
	if(blob.get_u32("DrillCD") < 1)
		{
			GUI::DrawIcon( "StatusEffects.png", 6, Vec2f(32,32), tl+Vec2f(8 + (slotsSize-3)*32, -40), 0.5f);
		}
		else
		{
		...
		if(blob.get_u32("MineCD") < 1)
		{
			GUI::DrawIcon( "StatusEffects.png", 7, Vec2f(32,32), tl+Vec2f(8 + (slotsSize-4)*32, -40), 0.5f);
		}	
		else
		{
