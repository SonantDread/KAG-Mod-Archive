...
void onInit(CBlob@ this)
{
	...
	this.set_u32("CloakCD", 1000);
	this.set_u32("ArrowCD", 0);
...
void onTick(CBlob@ this)
{
	...
	if(this.get_u32("CloakCD") < 1 && this.isKeyPressed(key_taunts) && this.get_u32("select") == 0)
	{
		this.set_u32("invis",400);
		this.set_u32("CloakCD",1000);
	}
	else if(this.get_u32("ArrowCD") < 1 && this.isKeyPressed(key_taunts) && this.get_u32("select") == 1)
	{
		ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getPosition() + Vec2f(5.0f, 0.0f) + Vec2f(0.0f, -2.0f), 17.59f, 0, false);
		ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getPosition() + Vec2f(5.0f, -2.5f) + Vec2f(0.0f, -2.0f), 17.59f, 0, false);
		ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getPosition() + Vec2f(5.0f, -5.0f) + Vec2f(0.0f, -2.0f), 17.59f, 0, false);
		ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getPosition() + Vec2f(2.5f, -5.0f) + Vec2f(0.0f, -2.0f), 17.59f, 0, false);
		ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getPosition() + Vec2f(0.0f, -5.0f) + Vec2f(0.0f, -2.0f), 17.59f, 0, false);
		ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getPosition() + Vec2f(-2.5f, -5.0f) + Vec2f(0.0f, -2.0f), 17.59f, 0, false);
		ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getPosition() + Vec2f(-5.0f, -5.0f) + Vec2f(0.0f, -2.0f), 17.59f, 0, false);
		ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getPosition() + Vec2f(-5.0f, -2.5f) + Vec2f(0.0f, -2.0f), 17.59f, 0, false);
		ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getPosition() + Vec2f(-5.0f, 0.0f) + Vec2f(0.0f, -2.0f), 17.59f, 0, false);
		ShootArrow(this, this.getPosition() + Vec2f(0.0f, -2.0f), this.getAimPos() + Vec2f(0.0f, -2.0f), 17.59f, 0, false);
		this.set_u32("ArrowCD",1300);
		
	}
	
	if(this.get_u32("CloakCD") >= 1)
	{
		this.set_u32("CloakCD", this.get_u32("CloakCD") - 1);
	}
	if(this.get_u32("ArrowCD") >= 1)
	{
		this.set_u32("ArrowCD", this.get_u32("ArrowCD") - 1);
	}
	if(this.get_u32("invis") >= 1)
	{
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	if (cmd == this.getCommandID("shoot arrow"))
	{
		...
		if(this.get_bool("Bombnext"))
		{
			arrowType = 2;
			this.set_bool("Bombnext", false);
		}
