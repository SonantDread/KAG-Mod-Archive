...
void onTick( CBrain@ this )
{
	...
	if (blob.hasTag("lvl2") && gametime % 200 == 0)
	{
		CBlob@ skel2 = server_CreateBlob("skeleton");
		skel2.server_setTeamNum(blob.getTeamNum());
		skel2.setPosition(blob.getPosition() + Vec2f(0.0f, -4.0f));
		skel2.server_SetTimeToDie(15);
	}
	FloatInWater( blob ); 
} 
