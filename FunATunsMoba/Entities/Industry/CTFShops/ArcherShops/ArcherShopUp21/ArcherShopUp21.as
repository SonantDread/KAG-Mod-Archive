...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem( this, "Knight Shop Path 2", "$archershop$", "archershopup22", "Increases the power even MORE!!!" );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 1100 );
	}

	// CLASS
	this.set_Vec2f("class offset", Vec2f(-9, 0));
	this.set_string("required class", "archerup");
}
...
{
	const bool isKnight = classname == "archerup";
...
void onTick(CBlob@ this)
{
	if( this.getTeamNum() < 3 && this.get_u32("minionCD") > 800)
	{
		...
		SpawnMook(pos, "archerup", this.getTeamNum());
		this.set_u32("minionCD", 0);
	}
	else{
