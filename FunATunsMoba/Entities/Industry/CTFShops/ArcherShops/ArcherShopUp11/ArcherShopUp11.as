...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem( this, "Archer Shop Path 1", "$archershop$", "archershopup12", "Increases the number of Archers spawned!" );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 1300 );
	}	
...
{
	const bool isKnight = classname == "acher";
...
{
	if( this.getTeamNum() < 3 && this.get_u32("minionCD") > 600)
	{
