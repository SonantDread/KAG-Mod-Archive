...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem( this, "Necromancer Shop Path 1", "$necroshopup11$", "necroshopup11", "Necromancers will now spawn Skeletons!" );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 1000 );
	}	
	/*{
		ShopItem@ s = addShopItem( this, "Knight Shop Path 2", "$knightshop$", "knightshopup21", "Increases the power of Knights!" );
...
void onTick(CBlob@ this)
{
	if( this.getTeamNum() < 3 && this.get_u32("minionCD") > 800)
	{
		...
		SpawnMook(pos, "necromancer", this.getTeamNum());
		this.set_u32("minionCD", 0);
	}
	else{
