...
void onInit(CBlob@ this)
{
	...
	this.set_string("required class", "knightupup");
}
...
CBlob@ SpawnMook(Vec2f pos, const string &in classname, u8 team)
{
	...
	if (blob !is null)
	{
		...
		//blob.AddScript( "/DefPotEffect.as" );
		//blob.AddScript( "/AtkPotEffect.as" );
...
void onTick(CBlob@ this)
{
	if( this.getTeamNum() < 3 && this.get_u32("minionCD") > 800)
	{
		...
		SpawnMook(pos, "knightupup", this.getTeamNum());
		this.set_u32("minionCD", 0);
	}
	else{
