...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem( this, "Knight Shop Path 2", "$knightshop$", "knightshopup22", "Increases the power even MORE!!!" );
		AddRequirement( s.requirements, "blob", "mat_wood", "Wood", 1500 );
	}

	// CLASS
	this.set_Vec2f("class offset", Vec2f(-9, 0));
	this.set_string("required class", "knightup");
}
...
void onTick(CBlob@ this)
{
	if( this.getTeamNum() < 3 && this.get_u32("minionCD") > 800)
	{
		...
		SpawnMook(pos, "knightup", this.getTeamNum());
		this.set_u32("minionCD", 0);
	}
	else{
