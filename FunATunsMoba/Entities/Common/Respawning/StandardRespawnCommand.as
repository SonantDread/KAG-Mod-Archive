...
void InitClasses(CBlob@ this)
{
	...
	addPlayerClass(this, "Builder", "$builder_class_icon$", "molly", "Build ALL the towers.");
	addPlayerClass(this, "Builder", "$builder_class_icon$", "payton", "Build ALL the towers.");
	addPlayerClass(this, "Knight", "$knight_class_icon$", "oz", "Hack and Slash.");
	addPlayerClass(this, "Knight", "$knight_class_icon$", "nathan", "Hack and Slash.");
	addPlayerClass(this, "Archer", "$archer_class_icon$", "brennan", "The Ranged Advantage.");
}
