...
{
	//articleAnimated("Entities/Effects/Sprites/SmallExplosion" + (XORRandom(3) + 1) + ".png",
			...
			for (uint i = 0; i < hitInfos.length; i++)
			{
				...
				if (hi.blob !is null) // blob
				{
					...
					if (hi.blob.hasTag("heavy weight") ||
					        ...
					        (hi.blob.hasTag("shielded") && blockAttack(hi.blob, hitvec, 0.0f)) || hi.blob.getName() == "tower")
					{
						return false;
					}
				}
