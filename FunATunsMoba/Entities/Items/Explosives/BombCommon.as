...
{
	CBlob@ skel1 = server_CreateBlob("skeleton");
	skel1.server_setTeamNum(this.getTeamNum());
	skel1.setPosition(this.getPosition() + Vec2f(4.0f, 0.0f));
	...
	CBlob@ skel3 = server_CreateBlob("skeleton");
	skel3.server_setTeamNum(this.getTeamNum());
	skel3.setPosition(this.getPosition() + Vec2f(-4.0f, 0.0f));
