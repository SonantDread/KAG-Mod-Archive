...
void onTick(CBlob@ this)
{
	...
	if(this.getPlayer() !is null)handleDeath(this);
	...
	if(armCanGrapple(this,"main") || armCanGrapple(this,"sub"))this.Untag("no pickup");
	else this.Tag("no pickup");
...
void onCreateInventoryMenu(CBlob@ this, CBlob@ forBlob, CGridMenu @gridmenu)
{
	...
	if(!armCanGrapple(this,"main") && !armCanGrapple(this,"sub"))return;
...
bool canBePickedUp( CBlob@ this, CBlob@ byBlob ){
	...
	return !canResist(this) || this.isKeyPressed(key_down);
