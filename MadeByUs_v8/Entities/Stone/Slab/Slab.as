...
void onInit(CBlob @ this)
{
	...
	this.set_string("shop description", "Stone Slab");
	...
	AddIconToken("$ingotmold_icon$", "IngotMold.png", Vec2f(10, 6), 0);
	{
		ShopItem@ s = addShopItem(this, "Ingot Mold", "$ingotmold_icon$", "ingotmold", "Raw metal can be heated inside to produce a bar.", false);
	...
	AddIconToken("$pickhead_icon$", "PickHead.png", Vec2f(13, 4), 0);
	{
		...
		AddRequirement(s.requirements, "blob", "metalbar", "Metal Bar", 1);
	}
}
