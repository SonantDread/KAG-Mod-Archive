...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	caller.CreateGenericButton( 11, Vec2f_zero, this, this.getCommandID("mutant"), "Use this to change into a mutant.", params );
}

void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("mutant"))
	{
        ...
        if (getNet().isServer() )
        {
            ...
            {
				warn("chealler:");
                string classconfig = "Mutant";//params.read_string();
