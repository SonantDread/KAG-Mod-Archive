...
void onInit(CBlob@ this)
{
	...
	f32 rabid_dog_health = getRules().get_f32("rabid_dog_health");
	this.server_SetHealth(rabid_dog_health);
...
void onTick( CMovement@ this )
{
	...
	if (XORRandom(100)==0 && !down)
		blob.AddForce(Vec2f( vars.jumpForce.x, vars.jumpForce.y*blob.getMass()/2));

	CShape@ shape = blob.getShape();
	//printf("shape.vellen = "+shape.vellen+" vars.maxVelocity = "+vars.maxVelocity);
	// too fast - slow down
