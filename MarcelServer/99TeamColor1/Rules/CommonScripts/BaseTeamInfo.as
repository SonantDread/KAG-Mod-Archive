...
{
	if (team >= 1 && team < teams.length) //alterado
	{
...
shared s32 getSmallestTeam(BaseTeamInfo@[]@ teams)
{
	...
	s32 lowestCount;
	if(lowestTeam == 0){ lowestCount = teams[1].players_count + 1;} //criado
	else{ lowestCount = teams[lowestTeam].players_count;} // criado e alterado
