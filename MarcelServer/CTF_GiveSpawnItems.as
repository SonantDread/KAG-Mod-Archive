...
bool GiveSpawnResources(CRules@ this, CBlob@ blob, CPlayer@ player, CTFPlayerInfo@ info)
{
	...
	if (blob.getName() == "builder")
	{
		if (this.isWarmup())
		{
				...
				ret = SetMaterials(blob, "mat_wood", 450) || ret;
				ret = SetMaterials(blob, "mat_stone", 290) || ret;
					}
		else
		{
			ret = SetMaterials(blob, "mat_wood", 50) || ret;
...
void onPlayerDie(CRules@ this, CPlayer@ victim, CPlayer@ attacker, u8 customData)
{
	...
	if(attacker !is null){
		if(victim.getCoins() < 25) {
		victim.server_setCoins(25);
		} 
	}
