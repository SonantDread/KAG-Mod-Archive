...
void onInit(CBlob@ this)
{
	...
	//TDM classes
	addPlayerClass(this, "Sharkkiller", "$archer_class_icon$", "archer2", "Hack and Slash.");
	addPlayerClass(this, "Sharkshooter", "$archer_class_icon$", "archer", "The Ranged Advantage.");
