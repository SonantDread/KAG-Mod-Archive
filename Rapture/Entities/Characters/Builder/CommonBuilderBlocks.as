...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks)
{
	...
	{
		BuildBlock b(CMap::tile_ground, "ground_block", "$ground_block$", "Dirt Block\nBasic building block");
	...
	{
		BuildBlock b(0, "kitchen", "$building$", "Kitchen");
	...
	{
		BuildBlock b(0, "nursery", "$building$", "Nursery");
		AddRequirement(b.reqs, "blob", "mat_wood", "Wood", 150);
		b.buildOnGround = true;
		b.size.Set(40, 24);
		blocks[0].push_back(b);
	...
	{
		BuildBlock b(0, "raptureworkbench", "$workbench$", "Workbench");
