...
void InitWorkshop(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "SmallSponge", "$sponge$", "smallsponge", descriptions[53], false);
	...
	{
		ShopItem@ s = addShopItem(this, "SuperSponge", "$sponge$", "supersponge", descriptions[53], false);
