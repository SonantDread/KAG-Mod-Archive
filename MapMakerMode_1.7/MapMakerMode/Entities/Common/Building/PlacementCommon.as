...
const f32 MAX_BUILD_LENGTH = 512.0f;
...
bool isBuildableAtPos(CBlob@ this, Vec2f p, TileType buildTile, CBlob @blob, bool &out sameTile)
{
	...
	else if (buildTile == CMap::tile_grass && (backtile.type == CMap::tile_grass || backtile.type == CMap::tile_grass+1 || backtile.type == CMap::tile_grass+2 || backtile.type == CMap::tile_grass+3))
	{
		//cant build wood on stone background
		return false;
	}
...
void SetupBuildDelay(CBlob@ this)
{
	...
	this.set_u32("build delay", 0.5);  // move this to builder init
}
