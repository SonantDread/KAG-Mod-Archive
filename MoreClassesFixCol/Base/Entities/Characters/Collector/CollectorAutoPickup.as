...
void onCollision(CBlob@ this, CBlob@ blob, bool solid)
{
	...
	if (blobName == "mat_firearrows" || blobName == "mat_bombarrows" || blobName == "mat_waterarrows" || blobName == "mat_gold" || blobName == "mat_stone" || blobName == "mat_wood" || blobName == "grain" || blobName == "mat_bombs" || blobName == "mat_waterbombs")
	{
		this.server_PutInInventory(blob);
	}
}
