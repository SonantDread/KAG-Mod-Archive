//Archer Include
/*
/rcon CPlayer@ player=getPlayerByUsername('cirpons');CBlob@ blob=player.getBlob();CBlob@ test = server_CreateBlobNoInit('collector');test.setPosition(blob.getPosition());blob.server_Die();test.Init();test.server_SetPlayer(player);test.server_setTeamNum(player.getTeamNum());
*/
...
const f32 archer_grapple_length = 80.0f;
