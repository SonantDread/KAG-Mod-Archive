		...
		for(int y = 0; y < height; y++)
		{
			...
			if(n > 0.5f)
			{
				...
				else if((/*n > 0.55f &&*/ n_plus < bedrock_thresh - 0.2f) || n > bedrock_thresh)
				{
					...
					else if(material_frac > 0.4f /*&& n > 0.9f*/)			//commented out condition made stone not spawn at the surface
					{
						map.SetTile(offset, CMap::tile_thickstone );
					}
					else if(material_frac > 0.1f /*&& n_plus > 0.8f*/)		//commented out condition made stone not spawn at the surface
					{
