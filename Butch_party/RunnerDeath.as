...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	Vec2f vel;
	for(int i = 0;i < 2500+XORRandom(500);i++){
		vel = getRandomVelocity(this.getVelocity().getAngleDegrees(), XORRandom(this.getVelocity().getLength()*5.0f) + XORRandom(10), 10.0f);
		...
		ParticleBlood(this.getPosition(), vel, SColor(theColor));//SColor(255, 126, 0, 0));
	}
